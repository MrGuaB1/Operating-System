...
void print_regs(struct pushregs *gpr) {
    ...
    802001a8:	b4c50513          	addi	a0,a0,-1204 # 80200cf0 <etext+0x27a>
void print_regs(struct pushregs *gpr) {
    ...
    80200360:	c7c50513          	addi	a0,a0,-900 # 80200fd8 <etext+0x562>
}
...
void print_trapframe(struct trapframe *tf) {
    ...
    80200376:	c7e50513          	addi	a0,a0,-898 # 80200ff0 <etext+0x57a>
void print_trapframe(struct trapframe *tf) {
    ...
    802003c2:	c9250513          	addi	a0,a0,-878 # 80201050 <etext+0x5da>
}
...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003f2:	8b250513          	addi	a0,a0,-1870 # 80200ca0 <etext+0x22a>
    802003f6:	c7dff06f          	j	80200072 <cprintf>
            cprintf("Hypervisor software interrupt\n");
    802003fa:	00001517          	auipc	a0,0x1
    802003fe:	88650513          	addi	a0,a0,-1914 # 80200c80 <etext+0x20a>
    80200402:	c71ff06f          	j	80200072 <cprintf>
            cprintf("User software interrupt\n");
    80200406:	00001517          	auipc	a0,0x1
    8020040a:	83a50513          	addi	a0,a0,-1990 # 80200c40 <etext+0x1ca>
    8020040e:	c65ff06f          	j	80200072 <cprintf>
            cprintf("Supervisor software interrupt\n");
    80200412:	00001517          	auipc	a0,0x1
    80200416:	84e50513          	addi	a0,a0,-1970 # 80200c60 <etext+0x1ea>
    ...
    80200422:	8b250513          	addi	a0,a0,-1870 # 80200cd0 <etext+0x25a>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200446:	bcf63f23          	sd	a5,-1058(a2) # 80204020 <ticks>
            if(ticks == TICK_NUM){
    ...
    80200462:	86250513          	addi	a0,a0,-1950 # 80200cc0 <etext+0x24a>
    ...
    80200482:	00d78763          	beq	a5,a3,80200490 <interrupt_handler+0xc4>
                ticks = 0;
    80200486:	00004797          	auipc	a5,0x4
    8020048a:	b807bd23          	sd	zero,-1126(a5) # 80204020 <ticks>
    8020048e:	b7c9                	j	80200450 <interrupt_handler+0x84>
                    sbi_shutdown();
    80200490:	592000ef          	jal	ra,80200a22 <sbi_shutdown>
    80200494:	bfcd                	j	80200486 <interrupt_handler+0xba>
...
void exception_handler(struct trapframe *tf) {
    ...
    802004fc:	8082                	ret
            cprintf("Expection type: Breakpoint\n");
    802004fe:	00000517          	auipc	a0,0x0
    80200502:	70a50513          	addi	a0,a0,1802 # 80200c08 <etext+0x192>
    80200506:	b6dff0ef          	jal	ra,80200072 <cprintf>
            cprintf("Breakpoint at 0x%08\n",tf->epc);
    8020050a:	10843583          	ld	a1,264(s0)
    8020050e:	00000517          	auipc	a0,0x0
    80200512:	71a50513          	addi	a0,a0,1818 # 80200c28 <etext+0x1b2>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    80200634:	bc878793          	addi	a5,a5,-1080 # 802011f8 <error_string+0x38>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200688:	9e0a0a13          	addi	s4,s4,-1568 # 80201064 <etext+0x5ee>
    ...
    80200694:	b30c0c13          	addi	s8,s8,-1232 # 802011c0 <error_string>
    ...
    80200782:	b2a60613          	addi	a2,a2,-1238 # 802012a8 <error_string+0xe8>
    ...
    80200916:	98660613          	addi	a2,a2,-1658 # 80201298 <error_string+0xd8>
    ...
    80200928:	96c60613          	addi	a2,a2,-1684 # 80201290 <error_string+0xd0>
            if (width > 0 && padc != '-') {
    8020092c:	00001417          	auipc	s0,0x1
    80200930:	96540413          	addi	s0,s0,-1691 # 80201291 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
    ...
    802009bc:	8d940413          	addi	s0,s0,-1831 # 80201291 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
