...
ffffffffc020004c:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004e:	260040ef          	jal	ra,ffffffffc02042ae <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc0200052:	00004597          	auipc	a1,0x4
ffffffffc0200056:	28658593          	addi	a1,a1,646 # ffffffffc02042d8 <etext>
ffffffffc020005a:	00004517          	auipc	a0,0x4
ffffffffc020005e:	29e50513          	addi	a0,a0,670 # ffffffffc02042f8 <etext+0x20>
...
ffffffffc02000b0:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000b2:	515030ef          	jal	ra,ffffffffc0203dc6 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e4:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e6:	4e1030ef          	jal	ra,ffffffffc0203dc6 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020010c:	22850513          	addi	a0,a0,552 # ffffffffc0204330 <etext+0x58>
void print_kerninfo(void) {
...
ffffffffc0200122:	23250513          	addi	a0,a0,562 # ffffffffc0204350 <etext+0x78>
ffffffffc0200126:	f99ff0ef          	jal	ra,ffffffffc02000be <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020012a:	00004597          	auipc	a1,0x4
ffffffffc020012e:	1ae58593          	addi	a1,a1,430 # ffffffffc02042d8 <etext>
ffffffffc0200132:	00004517          	auipc	a0,0x4
ffffffffc0200136:	23e50513          	addi	a0,a0,574 # ffffffffc0204370 <etext+0x98>
...
ffffffffc020014a:	24a50513          	addi	a0,a0,586 # ffffffffc0204390 <etext+0xb8>
...
ffffffffc020015e:	25650513          	addi	a0,a0,598 # ffffffffc02043b0 <etext+0xd8>
...
ffffffffc020018c:	24850513          	addi	a0,a0,584 # ffffffffc02043d0 <etext+0xf8>
}
...
ffffffffc020019c:	16860613          	addi	a2,a2,360 # ffffffffc0204300 <etext+0x28>
ffffffffc02001a0:	04e00593          	li	a1,78
ffffffffc02001a4:	00004517          	auipc	a0,0x4
ffffffffc02001a8:	17450513          	addi	a0,a0,372 # ffffffffc0204318 <etext+0x40>
void print_stackframe(void) {
...
ffffffffc020029e:	6b5030ef          	jal	ra,ffffffffc0204152 <readline>
...
ffffffffc02002b0:	7e1030ef          	jal	ra,ffffffffc0204290 <strchr>
...
ffffffffc02002d4:	793030ef          	jal	ra,ffffffffc0204266 <strcmp>
...
ffffffffc02002e8:	77f030ef          	jal	ra,ffffffffc0204266 <strcmp>
...
ffffffffc020034e:	743030ef          	jal	ra,ffffffffc0204290 <strchr>
...
ffffffffc02004c0:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004c2:	5ff030ef          	jal	ra,ffffffffc02042c0 <memcpy>
    return 0;
}
...
ffffffffc02004e6:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004e8:	5d9030ef          	jal	ra,ffffffffc02042c0 <memcpy>
    return 0;
}
...
ffffffffc0200bae:	52668693          	addi	a3,a3,1318 # ffffffffc02060d0 <nbase>
...
ffffffffc0201804:	2ab020ef          	jal	ra,ffffffffc02042ae <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02018aa:	205020ef          	jal	ra,ffffffffc02042ae <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201f7e:	2d6020ef          	jal	ra,ffffffffc0204254 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f82:	100b8593          	addi	a1,s7,256
ffffffffc0201f86:	10000513          	li	a0,256
ffffffffc0201f8a:	2dc020ef          	jal	ra,ffffffffc0204266 <strcmp>
...
ffffffffc0201fc6:	10068023          	sb	zero,256(a3) # fffffffffffff100 <end+0x3fdedb68>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fca:	246020ef          	jal	ra,ffffffffc0204210 <strlen>
...
ffffffffc0202826:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202828:	3ae010ef          	jal	ra,ffffffffc0203bd6 <swapfs_init>
...
ffffffffc0202aba:	61ad0d13          	addi	s10,s10,1562 # ffffffffc02060d0 <nbase>
...
ffffffffc0202f70:	545000ef          	jal	ra,ffffffffc0203cb4 <swapfs_write>
...
ffffffffc020300e:	401000ef          	jal	ra,ffffffffc0203c0e <swapfs_read>
...
ffffffffc0203310:	79468693          	addi	a3,a3,1940 # ffffffffc0205aa0 <default_pmm_manager+0xa98>
ffffffffc0203314:	00002617          	auipc	a2,0x2
ffffffffc0203318:	95c60613          	addi	a2,a2,-1700 # ffffffffc0204c70 <commands+0x870>
ffffffffc020331c:	03600593          	li	a1,54
ffffffffc0203320:	00002517          	auipc	a0,0x2
ffffffffc0203324:	72050513          	addi	a0,a0,1824 # ffffffffc0205a40 <default_pmm_manager+0xa38>
{
...
ffffffffc0203374:	77850513          	addi	a0,a0,1912 # ffffffffc0205ae8 <default_pmm_manager+0xae0>
...
ffffffffc02033a8:	72468693          	addi	a3,a3,1828 # ffffffffc0205ac8 <default_pmm_manager+0xac0>
ffffffffc02033ac:	00002617          	auipc	a2,0x2
ffffffffc02033b0:	8c460613          	addi	a2,a2,-1852 # ffffffffc0204c70 <commands+0x870>
ffffffffc02033b4:	04800593          	li	a1,72
ffffffffc02033b8:	00002517          	auipc	a0,0x2
ffffffffc02033bc:	68850513          	addi	a0,a0,1672 # ffffffffc0205a40 <default_pmm_manager+0xa38>
ffffffffc02033c0:	fb5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(in_tick==0);
ffffffffc02033c4:	00002697          	auipc	a3,0x2
ffffffffc02033c8:	71468693          	addi	a3,a3,1812 # ffffffffc0205ad8 <default_pmm_manager+0xad0>
ffffffffc02033cc:	00002617          	auipc	a2,0x2
ffffffffc02033d0:	8a460613          	addi	a2,a2,-1884 # ffffffffc0204c70 <commands+0x870>
ffffffffc02033d4:	04900593          	li	a1,73
ffffffffc02033d8:	00002517          	auipc	a0,0x2
ffffffffc02033dc:	66850513          	addi	a0,a0,1640 # ffffffffc0205a40 <default_pmm_manager+0xa38>
...
ffffffffc02033ea:	73268693          	addi	a3,a3,1842 # ffffffffc0205b18 <default_pmm_manager+0xb10>
ffffffffc02033ee:	00002617          	auipc	a2,0x2
ffffffffc02033f2:	88260613          	addi	a2,a2,-1918 # ffffffffc0204c70 <commands+0x870>
ffffffffc02033f6:	07d00593          	li	a1,125
ffffffffc02033fa:	00002517          	auipc	a0,0x2
ffffffffc02033fe:	73e50513          	addi	a0,a0,1854 # ffffffffc0205b38 <default_pmm_manager+0xb30>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0203532:	69a68693          	addi	a3,a3,1690 # ffffffffc0205bc8 <default_pmm_manager+0xbc0>
ffffffffc0203536:	00001617          	auipc	a2,0x1
ffffffffc020353a:	73a60613          	addi	a2,a2,1850 # ffffffffc0204c70 <commands+0x870>
ffffffffc020353e:	08400593          	li	a1,132
ffffffffc0203542:	00002517          	auipc	a0,0x2
ffffffffc0203546:	5f650513          	addi	a0,a0,1526 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc020354a:	e2bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020354e:	00002697          	auipc	a3,0x2
ffffffffc0203552:	6ba68693          	addi	a3,a3,1722 # ffffffffc0205c08 <default_pmm_manager+0xc00>
ffffffffc0203556:	00001617          	auipc	a2,0x1
ffffffffc020355a:	71a60613          	addi	a2,a2,1818 # ffffffffc0204c70 <commands+0x870>
ffffffffc020355e:	07c00593          	li	a1,124
ffffffffc0203562:	00002517          	auipc	a0,0x2
ffffffffc0203566:	5d650513          	addi	a0,a0,1494 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc020356a:	e0bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc020356e:	00002697          	auipc	a3,0x2
ffffffffc0203572:	67a68693          	addi	a3,a3,1658 # ffffffffc0205be8 <default_pmm_manager+0xbe0>
ffffffffc0203576:	00001617          	auipc	a2,0x1
ffffffffc020357a:	6fa60613          	addi	a2,a2,1786 # ffffffffc0204c70 <commands+0x870>
ffffffffc020357e:	07b00593          	li	a1,123
ffffffffc0203582:	00002517          	auipc	a0,0x2
ffffffffc0203586:	5b650513          	addi	a0,a0,1462 # ffffffffc0205b38 <default_pmm_manager+0xb30>
...
ffffffffc0203618:	18c68693          	addi	a3,a3,396 # ffffffffc02057a0 <default_pmm_manager+0x798>
ffffffffc020361c:	00001617          	auipc	a2,0x1
ffffffffc0203620:	65460613          	addi	a2,a2,1620 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203624:	0ce00593          	li	a1,206
ffffffffc0203628:	00002517          	auipc	a0,0x2
ffffffffc020362c:	51050513          	addi	a0,a0,1296 # ffffffffc0205b38 <default_pmm_manager+0xb30>
...
ffffffffc0203666:	13e68693          	addi	a3,a3,318 # ffffffffc02057a0 <default_pmm_manager+0x798>
ffffffffc020366a:	00001617          	auipc	a2,0x1
ffffffffc020366e:	60660613          	addi	a2,a2,1542 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203672:	0d400593          	li	a1,212
ffffffffc0203676:	00002517          	auipc	a0,0x2
ffffffffc020367a:	4c250513          	addi	a0,a0,1218 # ffffffffc0205b38 <default_pmm_manager+0xb30>
...
ffffffffc020373a:	5f250513          	addi	a0,a0,1522 # ffffffffc0205d28 <default_pmm_manager+0xd20>
ffffffffc020373e:	981fc0ef          	jal	ra,ffffffffc02000be <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203742:	00002697          	auipc	a3,0x2
ffffffffc0203746:	60e68693          	addi	a3,a3,1550 # ffffffffc0205d50 <default_pmm_manager+0xd48>
ffffffffc020374a:	00001617          	auipc	a2,0x1
ffffffffc020374e:	52660613          	addi	a2,a2,1318 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203752:	0f600593          	li	a1,246
ffffffffc0203756:	00002517          	auipc	a0,0x2
ffffffffc020375a:	3e250513          	addi	a0,a0,994 # ffffffffc0205b38 <default_pmm_manager+0xb30>
...
ffffffffc020377a:	61a50513          	addi	a0,a0,1562 # ffffffffc0205d90 <default_pmm_manager+0xd88>
...
ffffffffc0203832:	8a270713          	addi	a4,a4,-1886 # ffffffffc02060d0 <nbase>
...
ffffffffc0203878:	58450513          	addi	a0,a0,1412 # ffffffffc0205df8 <default_pmm_manager+0xdf0>
...
ffffffffc02038a0:	57c50513          	addi	a0,a0,1404 # ffffffffc0205e18 <default_pmm_manager+0xe10>
}
...
ffffffffc02038ae:	39668693          	addi	a3,a3,918 # ffffffffc0205c40 <default_pmm_manager+0xc38>
ffffffffc02038b2:	00001617          	auipc	a2,0x1
ffffffffc02038b6:	3be60613          	addi	a2,a2,958 # ffffffffc0204c70 <commands+0x870>
ffffffffc02038ba:	0dd00593          	li	a1,221
ffffffffc02038be:	00002517          	auipc	a0,0x2
ffffffffc02038c2:	27a50513          	addi	a0,a0,634 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc02038c6:	aaffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02038ca:	00002697          	auipc	a3,0x2
ffffffffc02038ce:	3fe68693          	addi	a3,a3,1022 # ffffffffc0205cc8 <default_pmm_manager+0xcc0>
ffffffffc02038d2:	00001617          	auipc	a2,0x1
ffffffffc02038d6:	39e60613          	addi	a2,a2,926 # ffffffffc0204c70 <commands+0x870>
ffffffffc02038da:	0ed00593          	li	a1,237
ffffffffc02038de:	00002517          	auipc	a0,0x2
ffffffffc02038e2:	25a50513          	addi	a0,a0,602 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc02038e6:	a8ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02038ea:	00002697          	auipc	a3,0x2
ffffffffc02038ee:	40e68693          	addi	a3,a3,1038 # ffffffffc0205cf8 <default_pmm_manager+0xcf0>
ffffffffc02038f2:	00001617          	auipc	a2,0x1
ffffffffc02038f6:	37e60613          	addi	a2,a2,894 # ffffffffc0204c70 <commands+0x870>
ffffffffc02038fa:	0ee00593          	li	a1,238
ffffffffc02038fe:	00002517          	auipc	a0,0x2
ffffffffc0203902:	23a50513          	addi	a0,a0,570 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203906:	a6ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc020390a:	00002697          	auipc	a3,0x2
ffffffffc020390e:	e9668693          	addi	a3,a3,-362 # ffffffffc02057a0 <default_pmm_manager+0x798>
ffffffffc0203912:	00001617          	auipc	a2,0x1
ffffffffc0203916:	35e60613          	addi	a2,a2,862 # ffffffffc0204c70 <commands+0x870>
ffffffffc020391a:	11100593          	li	a1,273
ffffffffc020391e:	00002517          	auipc	a0,0x2
ffffffffc0203922:	21a50513          	addi	a0,a0,538 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203926:	a4ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc020392a:	00002697          	auipc	a3,0x2
ffffffffc020392e:	2fe68693          	addi	a3,a3,766 # ffffffffc0205c28 <default_pmm_manager+0xc20>
ffffffffc0203932:	00001617          	auipc	a2,0x1
ffffffffc0203936:	33e60613          	addi	a2,a2,830 # ffffffffc0204c70 <commands+0x870>
ffffffffc020393a:	0db00593          	li	a1,219
ffffffffc020393e:	00002517          	auipc	a0,0x2
ffffffffc0203942:	1fa50513          	addi	a0,a0,506 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203946:	a2ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc020394a:	00002697          	auipc	a3,0x2
ffffffffc020394e:	35e68693          	addi	a3,a3,862 # ffffffffc0205ca8 <default_pmm_manager+0xca0>
ffffffffc0203952:	00001617          	auipc	a2,0x1
ffffffffc0203956:	31e60613          	addi	a2,a2,798 # ffffffffc0204c70 <commands+0x870>
ffffffffc020395a:	0e900593          	li	a1,233
ffffffffc020395e:	00002517          	auipc	a0,0x2
ffffffffc0203962:	1da50513          	addi	a0,a0,474 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203966:	a0ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc020396a:	00002697          	auipc	a3,0x2
ffffffffc020396e:	32e68693          	addi	a3,a3,814 # ffffffffc0205c98 <default_pmm_manager+0xc90>
ffffffffc0203972:	00001617          	auipc	a2,0x1
ffffffffc0203976:	2fe60613          	addi	a2,a2,766 # ffffffffc0204c70 <commands+0x870>
ffffffffc020397a:	0e700593          	li	a1,231
ffffffffc020397e:	00002517          	auipc	a0,0x2
ffffffffc0203982:	1ba50513          	addi	a0,a0,442 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203986:	9effc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc020398a:	00002697          	auipc	a3,0x2
ffffffffc020398e:	2fe68693          	addi	a3,a3,766 # ffffffffc0205c88 <default_pmm_manager+0xc80>
ffffffffc0203992:	00001617          	auipc	a2,0x1
ffffffffc0203996:	2de60613          	addi	a2,a2,734 # ffffffffc0204c70 <commands+0x870>
ffffffffc020399a:	0e500593          	li	a1,229
ffffffffc020399e:	00002517          	auipc	a0,0x2
ffffffffc02039a2:	19a50513          	addi	a0,a0,410 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc02039a6:	9cffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc02039aa:	00002697          	auipc	a3,0x2
ffffffffc02039ae:	2ce68693          	addi	a3,a3,718 # ffffffffc0205c78 <default_pmm_manager+0xc70>
ffffffffc02039b2:	00001617          	auipc	a2,0x1
ffffffffc02039b6:	2be60613          	addi	a2,a2,702 # ffffffffc0204c70 <commands+0x870>
ffffffffc02039ba:	0e300593          	li	a1,227
ffffffffc02039be:	00002517          	auipc	a0,0x2
ffffffffc02039c2:	17a50513          	addi	a0,a0,378 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc02039c6:	9affc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc02039ca:	00002697          	auipc	a3,0x2
ffffffffc02039ce:	2ee68693          	addi	a3,a3,750 # ffffffffc0205cb8 <default_pmm_manager+0xcb0>
ffffffffc02039d2:	00001617          	auipc	a2,0x1
ffffffffc02039d6:	29e60613          	addi	a2,a2,670 # ffffffffc0204c70 <commands+0x870>
ffffffffc02039da:	0eb00593          	li	a1,235
ffffffffc02039de:	00002517          	auipc	a0,0x2
ffffffffc02039e2:	15a50513          	addi	a0,a0,346 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc02039e6:	98ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc02039ea:	00002697          	auipc	a3,0x2
ffffffffc02039ee:	d7e68693          	addi	a3,a3,-642 # ffffffffc0205768 <default_pmm_manager+0x760>
ffffffffc02039f2:	00001617          	auipc	a2,0x1
ffffffffc02039f6:	27e60613          	addi	a2,a2,638 # ffffffffc0204c70 <commands+0x870>
ffffffffc02039fa:	0c700593          	li	a1,199
ffffffffc02039fe:	00002517          	auipc	a0,0x2
ffffffffc0203a02:	13a50513          	addi	a0,a0,314 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203a06:	96ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a0a:	00002697          	auipc	a3,0x2
ffffffffc0203a0e:	35e68693          	addi	a3,a3,862 # ffffffffc0205d68 <default_pmm_manager+0xd60>
ffffffffc0203a12:	00001617          	auipc	a2,0x1
ffffffffc0203a16:	25e60613          	addi	a2,a2,606 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203a1a:	0fb00593          	li	a1,251
ffffffffc0203a1e:	00002517          	auipc	a0,0x2
ffffffffc0203a22:	11a50513          	addi	a0,a0,282 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203a26:	94ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a2a:	00002697          	auipc	a3,0x2
ffffffffc0203a2e:	33e68693          	addi	a3,a3,830 # ffffffffc0205d68 <default_pmm_manager+0xd60>
ffffffffc0203a32:	00001617          	auipc	a2,0x1
ffffffffc0203a36:	23e60613          	addi	a2,a2,574 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203a3a:	12e00593          	li	a1,302
ffffffffc0203a3e:	00002517          	auipc	a0,0x2
ffffffffc0203a42:	0fa50513          	addi	a0,a0,250 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203a46:	92ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203a4a:	00002697          	auipc	a3,0x2
ffffffffc0203a4e:	36668693          	addi	a3,a3,870 # ffffffffc0205db0 <default_pmm_manager+0xda8>
ffffffffc0203a52:	00001617          	auipc	a2,0x1
ffffffffc0203a56:	21e60613          	addi	a2,a2,542 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203a5a:	10a00593          	li	a1,266
ffffffffc0203a5e:	00002517          	auipc	a0,0x2
ffffffffc0203a62:	0da50513          	addi	a0,a0,218 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203a66:	90ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a6a:	00002697          	auipc	a3,0x2
ffffffffc0203a6e:	2fe68693          	addi	a3,a3,766 # ffffffffc0205d68 <default_pmm_manager+0xd60>
ffffffffc0203a72:	00001617          	auipc	a2,0x1
ffffffffc0203a76:	1fe60613          	addi	a2,a2,510 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203a7a:	0bd00593          	li	a1,189
ffffffffc0203a7e:	00002517          	auipc	a0,0x2
ffffffffc0203a82:	0ba50513          	addi	a0,a0,186 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203a86:	8effc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203a8a:	00002697          	auipc	a3,0x2
ffffffffc0203a8e:	33e68693          	addi	a3,a3,830 # ffffffffc0205dc8 <default_pmm_manager+0xdc0>
ffffffffc0203a92:	00001617          	auipc	a2,0x1
ffffffffc0203a96:	1de60613          	addi	a2,a2,478 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203a9a:	11600593          	li	a1,278
ffffffffc0203a9e:	00002517          	auipc	a0,0x2
ffffffffc0203aa2:	09a50513          	addi	a0,a0,154 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203aa6:	8cffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203aaa:	00001617          	auipc	a2,0x1
ffffffffc0203aae:	62660613          	addi	a2,a2,1574 # ffffffffc02050d0 <default_pmm_manager+0xc8>
ffffffffc0203ab2:	06500593          	li	a1,101
ffffffffc0203ab6:	00001517          	auipc	a0,0x1
ffffffffc0203aba:	63a50513          	addi	a0,a0,1594 # ffffffffc02050f0 <default_pmm_manager+0xe8>
ffffffffc0203abe:	8b7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203ac2:	00002697          	auipc	a3,0x2
ffffffffc0203ac6:	32668693          	addi	a3,a3,806 # ffffffffc0205de8 <default_pmm_manager+0xde0>
ffffffffc0203aca:	00001617          	auipc	a2,0x1
ffffffffc0203ace:	1a660613          	addi	a2,a2,422 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203ad2:	12000593          	li	a1,288
ffffffffc0203ad6:	00002517          	auipc	a0,0x2
ffffffffc0203ada:	06250513          	addi	a0,a0,98 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203ade:	897fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203ae2:	00002697          	auipc	a3,0x2
ffffffffc0203ae6:	cae68693          	addi	a3,a3,-850 # ffffffffc0205790 <default_pmm_manager+0x788>
ffffffffc0203aea:	00001617          	auipc	a2,0x1
ffffffffc0203aee:	18660613          	addi	a2,a2,390 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203af2:	10d00593          	li	a1,269
ffffffffc0203af6:	00002517          	auipc	a0,0x2
ffffffffc0203afa:	04250513          	addi	a0,a0,66 # ffffffffc0205b38 <default_pmm_manager+0xb30>
...
ffffffffc0203b2a:	c549                	beqz	a0,ffffffffc0203bb4 <do_pgfault+0xb2>
ffffffffc0203b2c:	651c                	ld	a5,8(a0)
ffffffffc0203b2e:	08f46363          	bltu	s0,a5,ffffffffc0203bb4 <do_pgfault+0xb2>
...
ffffffffc0203b38:	efa9                	bnez	a5,ffffffffc0203b92 <do_pgfault+0x90>
        perm |= (PTE_R | PTE_W);
    }
...
ffffffffc0203b4a:	c5b1                	beqz	a1,ffffffffc0203b96 <do_pgfault+0x94>
...
ffffffffc0203b58:	c7bd                	beqz	a5,ffffffffc0203bc6 <do_pgfault+0xc4>
...
ffffffffc0203b5c:	0030                	addi	a2,sp,8
...
ffffffffc0203b66:	65a2                	ld	a1,8(sp)
ffffffffc0203b68:	6c88                	ld	a0,24(s1)
ffffffffc0203b6a:	86ca                	mv	a3,s2
ffffffffc0203b6c:	8622                	mv	a2,s0
ffffffffc0203b6e:	ed7fd0ef          	jal	ra,ffffffffc0201a44 <page_insert>
            //(3) make the page swappable.
            swap_map_swappable(mm,addr,page,1);
ffffffffc0203b72:	6622                	ld	a2,8(sp)
ffffffffc0203b74:	4685                	li	a3,1
ffffffffc0203b76:	85a2                	mv	a1,s0
ffffffffc0203b78:	8526                	mv	a0,s1
ffffffffc0203b7a:	b42ff0ef          	jal	ra,ffffffffc0202ebc <swap_map_swappable>
            page->pra_vaddr = addr;
ffffffffc0203b7e:	6722                	ld	a4,8(sp)
...
ffffffffc0203b80:	4781                	li	a5,0
            page->pra_vaddr = addr;
ffffffffc0203b82:	e320                	sd	s0,64(a4)
failed:
    return ret;
}
...
ffffffffc0203b8c:	853e                	mv	a0,a5
ffffffffc0203b8e:	6145                	addi	sp,sp,48
ffffffffc0203b90:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203b92:	4959                	li	s2,22
ffffffffc0203b94:	b75d                	j	ffffffffc0203b3a <do_pgfault+0x38>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203b96:	6c88                	ld	a0,24(s1)
ffffffffc0203b98:	864a                	mv	a2,s2
ffffffffc0203b9a:	85a2                	mv	a1,s0
ffffffffc0203b9c:	a5dfe0ef          	jal	ra,ffffffffc02025f8 <pgdir_alloc_page>
   ret = 0;
ffffffffc0203ba0:	4781                	li	a5,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203ba2:	f16d                	bnez	a0,ffffffffc0203b84 <do_pgfault+0x82>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203ba4:	00002517          	auipc	a0,0x2
ffffffffc0203ba8:	fd450513          	addi	a0,a0,-44 # ffffffffc0205b78 <default_pmm_manager+0xb70>
ffffffffc0203bac:	d12fc0ef          	jal	ra,ffffffffc02000be <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203bb0:	57f1                	li	a5,-4
            goto failed;
ffffffffc0203bb2:	bfc9                	j	ffffffffc0203b84 <do_pgfault+0x82>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203bb4:	85a2                	mv	a1,s0
ffffffffc0203bb6:	00002517          	auipc	a0,0x2
ffffffffc0203bba:	f9250513          	addi	a0,a0,-110 # ffffffffc0205b48 <default_pmm_manager+0xb40>
ffffffffc0203bbe:	d00fc0ef          	jal	ra,ffffffffc02000be <cprintf>
    int ret = -E_INVAL;
ffffffffc0203bc2:	57f5                	li	a5,-3
        goto failed;
ffffffffc0203bc4:	b7c1                	j	ffffffffc0203b84 <do_pgfault+0x82>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203bc6:	00002517          	auipc	a0,0x2
ffffffffc0203bca:	fda50513          	addi	a0,a0,-38 # ffffffffc0205ba0 <default_pmm_manager+0xb98>
ffffffffc0203bce:	cf0fc0ef          	jal	ra,ffffffffc02000be <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203bd2:	57f1                	li	a5,-4
            goto failed;
ffffffffc0203bd4:	bf45                	j	ffffffffc0203b84 <do_pgfault+0x82>

ffffffffc0203bd6 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
ffffffffc0203bda:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203bdc:	8c3fc0ef          	jal	ra,ffffffffc020049e <ide_device_valid>
ffffffffc0203be0:	cd01                	beqz	a0,ffffffffc0203bf8 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203be2:	4505                	li	a0,1
ffffffffc0203be4:	8c1fc0ef          	jal	ra,ffffffffc02004a4 <ide_device_size>
}
ffffffffc0203be8:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203bea:	810d                	srli	a0,a0,0x3
ffffffffc0203bec:	0000e797          	auipc	a5,0xe
ffffffffc0203bf0:	94a7b623          	sd	a0,-1716(a5) # ffffffffc0211538 <max_swap_offset>
}
ffffffffc0203bf4:	0141                	addi	sp,sp,16
ffffffffc0203bf6:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203bf8:	00002617          	auipc	a2,0x2
ffffffffc0203bfc:	23860613          	addi	a2,a2,568 # ffffffffc0205e30 <default_pmm_manager+0xe28>
ffffffffc0203c00:	45b5                	li	a1,13
ffffffffc0203c02:	00002517          	auipc	a0,0x2
ffffffffc0203c06:	24e50513          	addi	a0,a0,590 # ffffffffc0205e50 <default_pmm_manager+0xe48>
ffffffffc0203c0a:	f6afc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203c0e <swapfs_read>:

int
swapfs_read(swap_entry_t entry, struct Page *page) {
ffffffffc0203c0e:	1141                	addi	sp,sp,-16
ffffffffc0203c10:	e406                	sd	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203c12:	00855793          	srli	a5,a0,0x8
ffffffffc0203c16:	c7b5                	beqz	a5,ffffffffc0203c82 <swapfs_read+0x74>
ffffffffc0203c18:	0000e717          	auipc	a4,0xe
ffffffffc0203c1c:	92070713          	addi	a4,a4,-1760 # ffffffffc0211538 <max_swap_offset>
ffffffffc0203c20:	6318                	ld	a4,0(a4)
ffffffffc0203c22:	06e7f063          	bleu	a4,a5,ffffffffc0203c82 <swapfs_read+0x74>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203c26:	0000e717          	auipc	a4,0xe
ffffffffc0203c2a:	88270713          	addi	a4,a4,-1918 # ffffffffc02114a8 <pages>
ffffffffc0203c2e:	6310                	ld	a2,0(a4)
ffffffffc0203c30:	00001717          	auipc	a4,0x1
ffffffffc0203c34:	02870713          	addi	a4,a4,40 # ffffffffc0204c58 <commands+0x858>
ffffffffc0203c38:	00002697          	auipc	a3,0x2
ffffffffc0203c3c:	49868693          	addi	a3,a3,1176 # ffffffffc02060d0 <nbase>
ffffffffc0203c40:	40c58633          	sub	a2,a1,a2
ffffffffc0203c44:	630c                	ld	a1,0(a4)
ffffffffc0203c46:	860d                	srai	a2,a2,0x3
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203c48:	0000e717          	auipc	a4,0xe
ffffffffc0203c4c:	81070713          	addi	a4,a4,-2032 # ffffffffc0211458 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203c50:	02b60633          	mul	a2,a2,a1
ffffffffc0203c54:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203c58:	629c                	ld	a5,0(a3)
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203c5a:	6318                	ld	a4,0(a4)
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203c5c:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203c5e:	57fd                	li	a5,-1
ffffffffc0203c60:	83b1                	srli	a5,a5,0xc
ffffffffc0203c62:	8ff1                	and	a5,a5,a2
    return page2ppn(page) << PGSHIFT;
ffffffffc0203c64:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203c66:	02e7fa63          	bleu	a4,a5,ffffffffc0203c9a <swapfs_read+0x8c>
ffffffffc0203c6a:	0000e797          	auipc	a5,0xe
ffffffffc0203c6e:	82e78793          	addi	a5,a5,-2002 # ffffffffc0211498 <va_pa_offset>
ffffffffc0203c72:	639c                	ld	a5,0(a5)
}
ffffffffc0203c74:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203c76:	46a1                	li	a3,8
ffffffffc0203c78:	963e                	add	a2,a2,a5
ffffffffc0203c7a:	4505                	li	a0,1
}
ffffffffc0203c7c:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203c7e:	82dfc06f          	j	ffffffffc02004aa <ide_read_secs>
ffffffffc0203c82:	86aa                	mv	a3,a0
ffffffffc0203c84:	00002617          	auipc	a2,0x2
ffffffffc0203c88:	1e460613          	addi	a2,a2,484 # ffffffffc0205e68 <default_pmm_manager+0xe60>
ffffffffc0203c8c:	45d1                	li	a1,20
ffffffffc0203c8e:	00002517          	auipc	a0,0x2
ffffffffc0203c92:	1c250513          	addi	a0,a0,450 # ffffffffc0205e50 <default_pmm_manager+0xe48>
ffffffffc0203c96:	edefc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203c9a:	86b2                	mv	a3,a2
ffffffffc0203c9c:	06a00593          	li	a1,106
ffffffffc0203ca0:	00001617          	auipc	a2,0x1
ffffffffc0203ca4:	3b860613          	addi	a2,a2,952 # ffffffffc0205058 <default_pmm_manager+0x50>
ffffffffc0203ca8:	00001517          	auipc	a0,0x1
ffffffffc0203cac:	44850513          	addi	a0,a0,1096 # ffffffffc02050f0 <default_pmm_manager+0xe8>
ffffffffc0203cb0:	ec4fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203cb4 <swapfs_write>:
...
ffffffffc0203cbc:	c7b5                	beqz	a5,ffffffffc0203d28 <swapfs_write+0x74>
...
ffffffffc0203cc8:	06e7f063          	bleu	a4,a5,ffffffffc0203d28 <swapfs_write+0x74>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0203cda:	f8270713          	addi	a4,a4,-126 # ffffffffc0204c58 <commands+0x858>
ffffffffc0203cde:	00002697          	auipc	a3,0x2
ffffffffc0203ce2:	3f268693          	addi	a3,a3,1010 # ffffffffc02060d0 <nbase>
...
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203d0c:	02e7fa63          	bleu	a4,a5,ffffffffc0203d40 <swapfs_write+0x8c>
...
ffffffffc0203d22:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203d24:	faafc06f          	j	ffffffffc02004ce <ide_write_secs>
ffffffffc0203d28:	86aa                	mv	a3,a0
ffffffffc0203d2a:	00002617          	auipc	a2,0x2
ffffffffc0203d2e:	13e60613          	addi	a2,a2,318 # ffffffffc0205e68 <default_pmm_manager+0xe60>
ffffffffc0203d32:	45e5                	li	a1,25
ffffffffc0203d34:	00002517          	auipc	a0,0x2
ffffffffc0203d38:	11c50513          	addi	a0,a0,284 # ffffffffc0205e50 <default_pmm_manager+0xe48>
...
ffffffffc0203d4a:	31260613          	addi	a2,a2,786 # ffffffffc0205058 <default_pmm_manager+0x50>
ffffffffc0203d4e:	00001517          	auipc	a0,0x1
ffffffffc0203d52:	3a250513          	addi	a0,a0,930 # ffffffffc02050f0 <default_pmm_manager+0xe8>
ffffffffc0203d56:	e1efc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203d5a <printnum>:
 * */
static void
...
ffffffffc0203d5a:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203d5e:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203d60:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203d64:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203d66:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203d6a:	f022                	sd	s0,32(sp)
ffffffffc0203d6c:	ec26                	sd	s1,24(sp)
ffffffffc0203d6e:	e84a                	sd	s2,16(sp)
ffffffffc0203d70:	f406                	sd	ra,40(sp)
ffffffffc0203d72:	e44e                	sd	s3,8(sp)
ffffffffc0203d74:	84aa                	mv	s1,a0
ffffffffc0203d76:	892e                	mv	s2,a1
ffffffffc0203d78:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203d7c:	2a01                	sext.w	s4,s4

    // first recursively print all preceding (more significant) digits
    if (num >= base) {
ffffffffc0203d7e:	03067e63          	bleu	a6,a2,ffffffffc0203dba <printnum+0x60>
ffffffffc0203d82:	89be                	mv	s3,a5
        printnum(putch, putdat, result, base, width - 1, padc);
    } else {
        // print any needed pad characters before first digit
        while (-- width > 0)
ffffffffc0203d84:	00805763          	blez	s0,ffffffffc0203d92 <printnum+0x38>
ffffffffc0203d88:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203d8a:	85ca                	mv	a1,s2
ffffffffc0203d8c:	854e                	mv	a0,s3
ffffffffc0203d8e:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203d90:	fc65                	bnez	s0,ffffffffc0203d88 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203d92:	1a02                	slli	s4,s4,0x20
ffffffffc0203d94:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203d98:	00002797          	auipc	a5,0x2
ffffffffc0203d9c:	28078793          	addi	a5,a5,640 # ffffffffc0206018 <error_string+0x38>
ffffffffc0203da0:	9a3e                	add	s4,s4,a5
}
ffffffffc0203da2:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203da4:	000a4503          	lbu	a0,0(s4)
}
...
ffffffffc0203db0:	8326                	mv	t1,s1
}
ffffffffc0203db2:	6942                	ld	s2,16(sp)
ffffffffc0203db4:	64e2                	ld	s1,24(sp)
ffffffffc0203db6:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203db8:	8302                	jr	t1
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203dba:	03065633          	divu	a2,a2,a6
ffffffffc0203dbe:	8722                	mv	a4,s0
ffffffffc0203dc0:	f9bff0ef          	jal	ra,ffffffffc0203d5a <printnum>
ffffffffc0203dc4:	b7f9                	j	ffffffffc0203d92 <printnum+0x38>

ffffffffc0203dc6 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203dc6:	7119                	addi	sp,sp,-128
ffffffffc0203dc8:	f4a6                	sd	s1,104(sp)
ffffffffc0203dca:	f0ca                	sd	s2,96(sp)
...
ffffffffc0203dd4:	f862                	sd	s8,48(sp)
ffffffffc0203dd6:	f06a                	sd	s10,32(sp)
ffffffffc0203dd8:	fc86                	sd	ra,120(sp)
ffffffffc0203dda:	f8a2                	sd	s0,112(sp)
ffffffffc0203ddc:	ecce                	sd	s3,88(sp)
ffffffffc0203dde:	f466                	sd	s9,40(sp)
ffffffffc0203de0:	ec6e                	sd	s11,24(sp)
ffffffffc0203de2:	892a                	mv	s2,a0
ffffffffc0203de4:	84ae                	mv	s1,a1
ffffffffc0203de6:	8d32                	mv	s10,a2
ffffffffc0203de8:	8ab6                	mv	s5,a3
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203dea:	5b7d                	li	s6,-1
        lflag = altflag = 0;

    reswitch:
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203dec:	00002a17          	auipc	s4,0x2
ffffffffc0203df0:	09ca0a13          	addi	s4,s4,156 # ffffffffc0205e88 <default_pmm_manager+0xe80>
            ...
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203df4:	05e00b93          	li	s7,94
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203df8:	00002c17          	auipc	s8,0x2
ffffffffc0203dfc:	1e8c0c13          	addi	s8,s8,488 # ffffffffc0205fe0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203e00:	000d4503          	lbu	a0,0(s10)
ffffffffc0203e04:	02500793          	li	a5,37
ffffffffc0203e08:	001d0413          	addi	s0,s10,1
ffffffffc0203e0c:	00f50e63          	beq	a0,a5,ffffffffc0203e28 <vprintfmt+0x62>
            if (ch == '\0') {
ffffffffc0203e10:	c521                	beqz	a0,ffffffffc0203e58 <vprintfmt+0x92>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203e12:	02500993          	li	s3,37
ffffffffc0203e16:	a011                	j	ffffffffc0203e1a <vprintfmt+0x54>
            if (ch == '\0') {
ffffffffc0203e18:	c121                	beqz	a0,ffffffffc0203e58 <vprintfmt+0x92>
            putch(ch, putdat);
ffffffffc0203e1a:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203e1c:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203e1e:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203e20:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203e24:	ff351ae3          	bne	a0,s3,ffffffffc0203e18 <vprintfmt+0x52>
ffffffffc0203e28:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203e2c:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203e30:	4981                	li	s3,0
ffffffffc0203e32:	4801                	li	a6,0
        width = precision = -1;
ffffffffc0203e34:	5cfd                	li	s9,-1
ffffffffc0203e36:	5dfd                	li	s11,-1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203e38:	05500593          	li	a1,85
                if (ch < '0' || ch > '9') {
ffffffffc0203e3c:	4525                	li	a0,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203e3e:	fdd6069b          	addiw	a3,a2,-35
ffffffffc0203e42:	0ff6f693          	andi	a3,a3,255
ffffffffc0203e46:	00140d13          	addi	s10,s0,1
ffffffffc0203e4a:	20d5e563          	bltu	a1,a3,ffffffffc0204054 <vprintfmt+0x28e>
ffffffffc0203e4e:	068a                	slli	a3,a3,0x2
ffffffffc0203e50:	96d2                	add	a3,a3,s4
ffffffffc0203e52:	4294                	lw	a3,0(a3)
ffffffffc0203e54:	96d2                	add	a3,a3,s4
ffffffffc0203e56:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203e58:	70e6                	ld	ra,120(sp)
ffffffffc0203e5a:	7446                	ld	s0,112(sp)
ffffffffc0203e5c:	74a6                	ld	s1,104(sp)
ffffffffc0203e5e:	7906                	ld	s2,96(sp)
ffffffffc0203e60:	69e6                	ld	s3,88(sp)
ffffffffc0203e62:	6a46                	ld	s4,80(sp)
ffffffffc0203e64:	6aa6                	ld	s5,72(sp)
ffffffffc0203e66:	6b06                	ld	s6,64(sp)
ffffffffc0203e68:	7be2                	ld	s7,56(sp)
ffffffffc0203e6a:	7c42                	ld	s8,48(sp)
ffffffffc0203e6c:	7ca2                	ld	s9,40(sp)
ffffffffc0203e6e:	7d02                	ld	s10,32(sp)
ffffffffc0203e70:	6de2                	ld	s11,24(sp)
ffffffffc0203e72:	6109                	addi	sp,sp,128
ffffffffc0203e74:	8082                	ret
    if (lflag >= 2) {
ffffffffc0203e76:	4705                	li	a4,1
ffffffffc0203e78:	008a8593          	addi	a1,s5,8
ffffffffc0203e7c:	01074463          	blt	a4,a6,ffffffffc0203e84 <vprintfmt+0xbe>
    else if (lflag) {
ffffffffc0203e80:	26080363          	beqz	a6,ffffffffc02040e6 <vprintfmt+0x320>
        return va_arg(*ap, unsigned long);
ffffffffc0203e84:	000ab603          	ld	a2,0(s5)
ffffffffc0203e88:	46c1                	li	a3,16
ffffffffc0203e8a:	8aae                	mv	s5,a1
ffffffffc0203e8c:	a06d                	j	ffffffffc0203f36 <vprintfmt+0x170>
            goto reswitch;
ffffffffc0203e8e:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0203e92:	4985                	li	s3,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203e94:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203e96:	b765                	j	ffffffffc0203e3e <vprintfmt+0x78>
            putch(va_arg(ap, int), putdat);
ffffffffc0203e98:	000aa503          	lw	a0,0(s5)
ffffffffc0203e9c:	85a6                	mv	a1,s1
ffffffffc0203e9e:	0aa1                	addi	s5,s5,8
ffffffffc0203ea0:	9902                	jalr	s2
            break;
ffffffffc0203ea2:	bfb9                	j	ffffffffc0203e00 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203ea4:	4705                	li	a4,1
ffffffffc0203ea6:	008a8993          	addi	s3,s5,8
ffffffffc0203eaa:	01074463          	blt	a4,a6,ffffffffc0203eb2 <vprintfmt+0xec>
    else if (lflag) {
ffffffffc0203eae:	22080463          	beqz	a6,ffffffffc02040d6 <vprintfmt+0x310>
        return va_arg(*ap, long);
ffffffffc0203eb2:	000ab403          	ld	s0,0(s5)
            if ((long long)num < 0) {
ffffffffc0203eb6:	24044463          	bltz	s0,ffffffffc02040fe <vprintfmt+0x338>
            num = getint(&ap, lflag);
ffffffffc0203eba:	8622                	mv	a2,s0
ffffffffc0203ebc:	8ace                	mv	s5,s3
ffffffffc0203ebe:	46a9                	li	a3,10
ffffffffc0203ec0:	a89d                	j	ffffffffc0203f36 <vprintfmt+0x170>
            err = va_arg(ap, int);
ffffffffc0203ec2:	000aa783          	lw	a5,0(s5)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203ec6:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0203ec8:	0aa1                	addi	s5,s5,8
            if (err < 0) {
ffffffffc0203eca:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0203ece:	8fb5                	xor	a5,a5,a3
ffffffffc0203ed0:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203ed4:	1ad74363          	blt	a4,a3,ffffffffc020407a <vprintfmt+0x2b4>
ffffffffc0203ed8:	00369793          	slli	a5,a3,0x3
ffffffffc0203edc:	97e2                	add	a5,a5,s8
ffffffffc0203ede:	639c                	ld	a5,0(a5)
ffffffffc0203ee0:	18078d63          	beqz	a5,ffffffffc020407a <vprintfmt+0x2b4>
                printfmt(putch, putdat, "%s", p);
ffffffffc0203ee4:	86be                	mv	a3,a5
ffffffffc0203ee6:	00002617          	auipc	a2,0x2
ffffffffc0203eea:	1e260613          	addi	a2,a2,482 # ffffffffc02060c8 <error_string+0xe8>
ffffffffc0203eee:	85a6                	mv	a1,s1
ffffffffc0203ef0:	854a                	mv	a0,s2
ffffffffc0203ef2:	240000ef          	jal	ra,ffffffffc0204132 <printfmt>
ffffffffc0203ef6:	b729                	j	ffffffffc0203e00 <vprintfmt+0x3a>
            lflag ++;
ffffffffc0203ef8:	00144603          	lbu	a2,1(s0)
ffffffffc0203efc:	2805                	addiw	a6,a6,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203efe:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203f00:	bf3d                	j	ffffffffc0203e3e <vprintfmt+0x78>
    if (lflag >= 2) {
ffffffffc0203f02:	4705                	li	a4,1
ffffffffc0203f04:	008a8593          	addi	a1,s5,8
ffffffffc0203f08:	01074463          	blt	a4,a6,ffffffffc0203f10 <vprintfmt+0x14a>
    else if (lflag) {
ffffffffc0203f0c:	1e080263          	beqz	a6,ffffffffc02040f0 <vprintfmt+0x32a>
        return va_arg(*ap, unsigned long);
ffffffffc0203f10:	000ab603          	ld	a2,0(s5)
ffffffffc0203f14:	46a1                	li	a3,8
ffffffffc0203f16:	8aae                	mv	s5,a1
ffffffffc0203f18:	a839                	j	ffffffffc0203f36 <vprintfmt+0x170>
            putch('0', putdat);
ffffffffc0203f1a:	03000513          	li	a0,48
ffffffffc0203f1e:	85a6                	mv	a1,s1
ffffffffc0203f20:	e03e                	sd	a5,0(sp)
ffffffffc0203f22:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0203f24:	85a6                	mv	a1,s1
ffffffffc0203f26:	07800513          	li	a0,120
ffffffffc0203f2a:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203f2c:	0aa1                	addi	s5,s5,8
ffffffffc0203f2e:	ff8ab603          	ld	a2,-8(s5)
            goto number;
ffffffffc0203f32:	6782                	ld	a5,0(sp)
ffffffffc0203f34:	46c1                	li	a3,16
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0203f36:	876e                	mv	a4,s11
ffffffffc0203f38:	85a6                	mv	a1,s1
ffffffffc0203f3a:	854a                	mv	a0,s2
ffffffffc0203f3c:	e1fff0ef          	jal	ra,ffffffffc0203d5a <printnum>
            break;
ffffffffc0203f40:	b5c1                	j	ffffffffc0203e00 <vprintfmt+0x3a>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203f42:	000ab603          	ld	a2,0(s5)
ffffffffc0203f46:	0aa1                	addi	s5,s5,8
ffffffffc0203f48:	1c060663          	beqz	a2,ffffffffc0204114 <vprintfmt+0x34e>
            if (width > 0 && padc != '-') {
ffffffffc0203f4c:	00160413          	addi	s0,a2,1
ffffffffc0203f50:	17b05c63          	blez	s11,ffffffffc02040c8 <vprintfmt+0x302>
ffffffffc0203f54:	02d00593          	li	a1,45
ffffffffc0203f58:	14b79263          	bne	a5,a1,ffffffffc020409c <vprintfmt+0x2d6>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203f5c:	00064783          	lbu	a5,0(a2)
ffffffffc0203f60:	0007851b          	sext.w	a0,a5
ffffffffc0203f64:	c905                	beqz	a0,ffffffffc0203f94 <vprintfmt+0x1ce>
ffffffffc0203f66:	000cc563          	bltz	s9,ffffffffc0203f70 <vprintfmt+0x1aa>
ffffffffc0203f6a:	3cfd                	addiw	s9,s9,-1
ffffffffc0203f6c:	036c8263          	beq	s9,s6,ffffffffc0203f90 <vprintfmt+0x1ca>
                    putch('?', putdat);
ffffffffc0203f70:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203f72:	18098463          	beqz	s3,ffffffffc02040fa <vprintfmt+0x334>
ffffffffc0203f76:	3781                	addiw	a5,a5,-32
ffffffffc0203f78:	18fbf163          	bleu	a5,s7,ffffffffc02040fa <vprintfmt+0x334>
                    putch('?', putdat);
ffffffffc0203f7c:	03f00513          	li	a0,63
ffffffffc0203f80:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203f82:	0405                	addi	s0,s0,1
ffffffffc0203f84:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203f88:	3dfd                	addiw	s11,s11,-1
ffffffffc0203f8a:	0007851b          	sext.w	a0,a5
ffffffffc0203f8e:	fd61                	bnez	a0,ffffffffc0203f66 <vprintfmt+0x1a0>
            for (; width > 0; width --) {
ffffffffc0203f90:	e7b058e3          	blez	s11,ffffffffc0203e00 <vprintfmt+0x3a>
ffffffffc0203f94:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0203f96:	85a6                	mv	a1,s1
ffffffffc0203f98:	02000513          	li	a0,32
ffffffffc0203f9c:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0203f9e:	e60d81e3          	beqz	s11,ffffffffc0203e00 <vprintfmt+0x3a>
ffffffffc0203fa2:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0203fa4:	85a6                	mv	a1,s1
ffffffffc0203fa6:	02000513          	li	a0,32
ffffffffc0203faa:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0203fac:	fe0d94e3          	bnez	s11,ffffffffc0203f94 <vprintfmt+0x1ce>
ffffffffc0203fb0:	bd81                	j	ffffffffc0203e00 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203fb2:	4705                	li	a4,1
ffffffffc0203fb4:	008a8593          	addi	a1,s5,8
ffffffffc0203fb8:	01074463          	blt	a4,a6,ffffffffc0203fc0 <vprintfmt+0x1fa>
    else if (lflag) {
ffffffffc0203fbc:	12080063          	beqz	a6,ffffffffc02040dc <vprintfmt+0x316>
        return va_arg(*ap, unsigned long);
ffffffffc0203fc0:	000ab603          	ld	a2,0(s5)
ffffffffc0203fc4:	46a9                	li	a3,10
ffffffffc0203fc6:	8aae                	mv	s5,a1
ffffffffc0203fc8:	b7bd                	j	ffffffffc0203f36 <vprintfmt+0x170>
ffffffffc0203fca:	00144603          	lbu	a2,1(s0)
            padc = '-';
ffffffffc0203fce:	02d00793          	li	a5,45
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fd2:	846a                	mv	s0,s10
ffffffffc0203fd4:	b5ad                	j	ffffffffc0203e3e <vprintfmt+0x78>
            putch(ch, putdat);
ffffffffc0203fd6:	85a6                	mv	a1,s1
ffffffffc0203fd8:	02500513          	li	a0,37
ffffffffc0203fdc:	9902                	jalr	s2
            break;
ffffffffc0203fde:	b50d                	j	ffffffffc0203e00 <vprintfmt+0x3a>
            precision = va_arg(ap, int);
ffffffffc0203fe0:	000aac83          	lw	s9,0(s5)
            goto process_precision;
ffffffffc0203fe4:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0203fe8:	0aa1                	addi	s5,s5,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fea:	846a                	mv	s0,s10
            if (width < 0)
ffffffffc0203fec:	e40dd9e3          	bgez	s11,ffffffffc0203e3e <vprintfmt+0x78>
                width = precision, precision = -1;
ffffffffc0203ff0:	8de6                	mv	s11,s9
ffffffffc0203ff2:	5cfd                	li	s9,-1
ffffffffc0203ff4:	b5a9                	j	ffffffffc0203e3e <vprintfmt+0x78>
            goto reswitch;
ffffffffc0203ff6:	00144603          	lbu	a2,1(s0)
            padc = '0';
ffffffffc0203ffa:	03000793          	li	a5,48
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ffe:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204000:	bd3d                	j	ffffffffc0203e3e <vprintfmt+0x78>
                precision = precision * 10 + ch - '0';
ffffffffc0204002:	fd060c9b          	addiw	s9,a2,-48
                ch = *fmt;
ffffffffc0204006:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020400a:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc020400c:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204010:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204014:	fcd56ce3          	bltu	a0,a3,ffffffffc0203fec <vprintfmt+0x226>
            for (precision = 0; ; ++ fmt) {
ffffffffc0204018:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc020401a:	002c969b          	slliw	a3,s9,0x2
                ch = *fmt;
ffffffffc020401e:	00044603          	lbu	a2,0(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204022:	0196873b          	addw	a4,a3,s9
ffffffffc0204026:	0017171b          	slliw	a4,a4,0x1
ffffffffc020402a:	0117073b          	addw	a4,a4,a7
                if (ch < '0' || ch > '9') {
ffffffffc020402e:	fd06069b          	addiw	a3,a2,-48
                precision = precision * 10 + ch - '0';
ffffffffc0204032:	fd070c9b          	addiw	s9,a4,-48
                ch = *fmt;
ffffffffc0204036:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc020403a:	fcd57fe3          	bleu	a3,a0,ffffffffc0204018 <vprintfmt+0x252>
ffffffffc020403e:	b77d                	j	ffffffffc0203fec <vprintfmt+0x226>
            if (width < 0)
...
ffffffffc0204052:	b3f5                	j	ffffffffc0203e3e <vprintfmt+0x78>
            putch('%', putdat);
ffffffffc0204054:	85a6                	mv	a1,s1
ffffffffc0204056:	02500513          	li	a0,37
ffffffffc020405a:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc020405c:	fff44703          	lbu	a4,-1(s0)
ffffffffc0204060:	02500793          	li	a5,37
ffffffffc0204064:	8d22                	mv	s10,s0
ffffffffc0204066:	d8f70de3          	beq	a4,a5,ffffffffc0203e00 <vprintfmt+0x3a>
ffffffffc020406a:	02500713          	li	a4,37
ffffffffc020406e:	1d7d                	addi	s10,s10,-1
ffffffffc0204070:	fffd4783          	lbu	a5,-1(s10)
ffffffffc0204074:	fee79de3          	bne	a5,a4,ffffffffc020406e <vprintfmt+0x2a8>
ffffffffc0204078:	b361                	j	ffffffffc0203e00 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc020407a:	00002617          	auipc	a2,0x2
ffffffffc020407e:	03e60613          	addi	a2,a2,62 # ffffffffc02060b8 <error_string+0xd8>
ffffffffc0204082:	85a6                	mv	a1,s1
ffffffffc0204084:	854a                	mv	a0,s2
ffffffffc0204086:	0ac000ef          	jal	ra,ffffffffc0204132 <printfmt>
ffffffffc020408a:	bb9d                	j	ffffffffc0203e00 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc020408c:	00002617          	auipc	a2,0x2
ffffffffc0204090:	02460613          	addi	a2,a2,36 # ffffffffc02060b0 <error_string+0xd0>
            if (width > 0 && padc != '-') {
ffffffffc0204094:	00002417          	auipc	s0,0x2
ffffffffc0204098:	01d40413          	addi	s0,s0,29 # ffffffffc02060b1 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020409c:	8532                	mv	a0,a2
ffffffffc020409e:	85e6                	mv	a1,s9
ffffffffc02040a0:	e032                	sd	a2,0(sp)
ffffffffc02040a2:	e43e                	sd	a5,8(sp)
ffffffffc02040a4:	18a000ef          	jal	ra,ffffffffc020422e <strnlen>
ffffffffc02040a8:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02040ac:	6602                	ld	a2,0(sp)
ffffffffc02040ae:	01b05d63          	blez	s11,ffffffffc02040c8 <vprintfmt+0x302>
ffffffffc02040b2:	67a2                	ld	a5,8(sp)
ffffffffc02040b4:	2781                	sext.w	a5,a5
ffffffffc02040b6:	e43e                	sd	a5,8(sp)
                    putch(padc, putdat);
ffffffffc02040b8:	6522                	ld	a0,8(sp)
ffffffffc02040ba:	85a6                	mv	a1,s1
ffffffffc02040bc:	e032                	sd	a2,0(sp)
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02040be:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc02040c0:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02040c2:	6602                	ld	a2,0(sp)
ffffffffc02040c4:	fe0d9ae3          	bnez	s11,ffffffffc02040b8 <vprintfmt+0x2f2>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040c8:	00064783          	lbu	a5,0(a2)
ffffffffc02040cc:	0007851b          	sext.w	a0,a5
ffffffffc02040d0:	e8051be3          	bnez	a0,ffffffffc0203f66 <vprintfmt+0x1a0>
ffffffffc02040d4:	b335                	j	ffffffffc0203e00 <vprintfmt+0x3a>
        return va_arg(*ap, int);
ffffffffc02040d6:	000aa403          	lw	s0,0(s5)
ffffffffc02040da:	bbf1                	j	ffffffffc0203eb6 <vprintfmt+0xf0>
        return va_arg(*ap, unsigned int);
ffffffffc02040dc:	000ae603          	lwu	a2,0(s5)
ffffffffc02040e0:	46a9                	li	a3,10
ffffffffc02040e2:	8aae                	mv	s5,a1
ffffffffc02040e4:	bd89                	j	ffffffffc0203f36 <vprintfmt+0x170>
ffffffffc02040e6:	000ae603          	lwu	a2,0(s5)
ffffffffc02040ea:	46c1                	li	a3,16
ffffffffc02040ec:	8aae                	mv	s5,a1
ffffffffc02040ee:	b5a1                	j	ffffffffc0203f36 <vprintfmt+0x170>
ffffffffc02040f0:	000ae603          	lwu	a2,0(s5)
ffffffffc02040f4:	46a1                	li	a3,8
ffffffffc02040f6:	8aae                	mv	s5,a1
ffffffffc02040f8:	bd3d                	j	ffffffffc0203f36 <vprintfmt+0x170>
                    putch(ch, putdat);
ffffffffc02040fa:	9902                	jalr	s2
ffffffffc02040fc:	b559                	j	ffffffffc0203f82 <vprintfmt+0x1bc>
                putch('-', putdat);
ffffffffc02040fe:	85a6                	mv	a1,s1
ffffffffc0204100:	02d00513          	li	a0,45
ffffffffc0204104:	e03e                	sd	a5,0(sp)
ffffffffc0204106:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204108:	8ace                	mv	s5,s3
ffffffffc020410a:	40800633          	neg	a2,s0
ffffffffc020410e:	46a9                	li	a3,10
ffffffffc0204110:	6782                	ld	a5,0(sp)
ffffffffc0204112:	b515                	j	ffffffffc0203f36 <vprintfmt+0x170>
            if (width > 0 && padc != '-') {
ffffffffc0204114:	01b05663          	blez	s11,ffffffffc0204120 <vprintfmt+0x35a>
ffffffffc0204118:	02d00693          	li	a3,45
ffffffffc020411c:	f6d798e3          	bne	a5,a3,ffffffffc020408c <vprintfmt+0x2c6>
ffffffffc0204120:	00002417          	auipc	s0,0x2
ffffffffc0204124:	f9140413          	addi	s0,s0,-111 # ffffffffc02060b1 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204128:	02800513          	li	a0,40
ffffffffc020412c:	02800793          	li	a5,40
ffffffffc0204130:	bd1d                	j	ffffffffc0203f66 <vprintfmt+0x1a0>

ffffffffc0204132 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204132:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204134:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204138:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020413a:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020413c:	ec06                	sd	ra,24(sp)
ffffffffc020413e:	f83a                	sd	a4,48(sp)
ffffffffc0204140:	fc3e                	sd	a5,56(sp)
ffffffffc0204142:	e0c2                	sd	a6,64(sp)
ffffffffc0204144:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204146:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204148:	c7fff0ef          	jal	ra,ffffffffc0203dc6 <vprintfmt>
}
ffffffffc020414c:	60e2                	ld	ra,24(sp)
ffffffffc020414e:	6161                	addi	sp,sp,80
ffffffffc0204150:	8082                	ret

ffffffffc0204152 <readline>:
...
ffffffffc0204152:	715d                	addi	sp,sp,-80
ffffffffc0204154:	e486                	sd	ra,72(sp)
ffffffffc0204156:	e0a2                	sd	s0,64(sp)
ffffffffc0204158:	fc26                	sd	s1,56(sp)
ffffffffc020415a:	f84a                	sd	s2,48(sp)
ffffffffc020415c:	f44e                	sd	s3,40(sp)
ffffffffc020415e:	f052                	sd	s4,32(sp)
ffffffffc0204160:	ec56                	sd	s5,24(sp)
ffffffffc0204162:	e85a                	sd	s6,16(sp)
ffffffffc0204164:	e45e                	sd	s7,8(sp)
    if (prompt != NULL) {
ffffffffc0204166:	c901                	beqz	a0,ffffffffc0204176 <readline+0x24>
        cprintf("%s", prompt);
ffffffffc0204168:	85aa                	mv	a1,a0
ffffffffc020416a:	00002517          	auipc	a0,0x2
ffffffffc020416e:	f5e50513          	addi	a0,a0,-162 # ffffffffc02060c8 <error_string+0xe8>
ffffffffc0204172:	f4dfb0ef          	jal	ra,ffffffffc02000be <cprintf>
readline(const char *prompt) {
ffffffffc0204176:	4481                	li	s1,0
    while (1) {
        c = getchar();
        if (c < 0) {
            return NULL;
...
ffffffffc0204178:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc020417a:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc020417c:	4aa9                	li	s5,10
ffffffffc020417e:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc0204180:	0000db97          	auipc	s7,0xd
ffffffffc0204184:	ec0b8b93          	addi	s7,s7,-320 # ffffffffc0211040 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204188:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc020418c:	f6bfb0ef          	jal	ra,ffffffffc02000f6 <getchar>
ffffffffc0204190:	842a                	mv	s0,a0
        if (c < 0) {
ffffffffc0204192:	00054b63          	bltz	a0,ffffffffc02041a8 <readline+0x56>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204196:	00a95b63          	ble	a0,s2,ffffffffc02041ac <readline+0x5a>
ffffffffc020419a:	029a5463          	ble	s1,s4,ffffffffc02041c2 <readline+0x70>
        c = getchar();
ffffffffc020419e:	f59fb0ef          	jal	ra,ffffffffc02000f6 <getchar>
ffffffffc02041a2:	842a                	mv	s0,a0
        if (c < 0) {
ffffffffc02041a4:	fe0559e3          	bgez	a0,ffffffffc0204196 <readline+0x44>
            return NULL;
ffffffffc02041a8:	4501                	li	a0,0
ffffffffc02041aa:	a099                	j	ffffffffc02041f0 <readline+0x9e>
        else if (c == '\b' && i > 0) {
ffffffffc02041ac:	03341463          	bne	s0,s3,ffffffffc02041d4 <readline+0x82>
ffffffffc02041b0:	e8b9                	bnez	s1,ffffffffc0204206 <readline+0xb4>
        c = getchar();
ffffffffc02041b2:	f45fb0ef          	jal	ra,ffffffffc02000f6 <getchar>
ffffffffc02041b6:	842a                	mv	s0,a0
        if (c < 0) {
ffffffffc02041b8:	fe0548e3          	bltz	a0,ffffffffc02041a8 <readline+0x56>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02041bc:	fea958e3          	ble	a0,s2,ffffffffc02041ac <readline+0x5a>
ffffffffc02041c0:	4481                	li	s1,0
            cputchar(c);
ffffffffc02041c2:	8522                	mv	a0,s0
ffffffffc02041c4:	f2ffb0ef          	jal	ra,ffffffffc02000f2 <cputchar>
            buf[i ++] = c;
ffffffffc02041c8:	009b87b3          	add	a5,s7,s1
ffffffffc02041cc:	00878023          	sb	s0,0(a5)
ffffffffc02041d0:	2485                	addiw	s1,s1,1
ffffffffc02041d2:	bf6d                	j	ffffffffc020418c <readline+0x3a>
        else if (c == '\n' || c == '\r') {
ffffffffc02041d4:	01540463          	beq	s0,s5,ffffffffc02041dc <readline+0x8a>
ffffffffc02041d8:	fb641ae3          	bne	s0,s6,ffffffffc020418c <readline+0x3a>
            cputchar(c);
ffffffffc02041dc:	8522                	mv	a0,s0
ffffffffc02041de:	f15fb0ef          	jal	ra,ffffffffc02000f2 <cputchar>
            buf[i] = '\0';
ffffffffc02041e2:	0000d517          	auipc	a0,0xd
ffffffffc02041e6:	e5e50513          	addi	a0,a0,-418 # ffffffffc0211040 <buf>
ffffffffc02041ea:	94aa                	add	s1,s1,a0
ffffffffc02041ec:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc02041f0:	60a6                	ld	ra,72(sp)
ffffffffc02041f2:	6406                	ld	s0,64(sp)
ffffffffc02041f4:	74e2                	ld	s1,56(sp)
ffffffffc02041f6:	7942                	ld	s2,48(sp)
ffffffffc02041f8:	79a2                	ld	s3,40(sp)
ffffffffc02041fa:	7a02                	ld	s4,32(sp)
ffffffffc02041fc:	6ae2                	ld	s5,24(sp)
ffffffffc02041fe:	6b42                	ld	s6,16(sp)
ffffffffc0204200:	6ba2                	ld	s7,8(sp)
ffffffffc0204202:	6161                	addi	sp,sp,80
ffffffffc0204204:	8082                	ret
            cputchar(c);
ffffffffc0204206:	4521                	li	a0,8
ffffffffc0204208:	eebfb0ef          	jal	ra,ffffffffc02000f2 <cputchar>
            i --;
ffffffffc020420c:	34fd                	addiw	s1,s1,-1
ffffffffc020420e:	bfbd                	j	ffffffffc020418c <readline+0x3a>

ffffffffc0204210 <strlen>:
...
ffffffffc0204214:	cb91                	beqz	a5,ffffffffc0204228 <strlen+0x18>
    size_t cnt = 0;
ffffffffc0204216:	4781                	li	a5,0
        cnt ++;
ffffffffc0204218:	0785                	addi	a5,a5,1
    while (*s ++ != '\0') {
ffffffffc020421a:	00f50733          	add	a4,a0,a5
ffffffffc020421e:	00074703          	lbu	a4,0(a4)
ffffffffc0204222:	fb7d                	bnez	a4,ffffffffc0204218 <strlen+0x8>
    }
    return cnt;
}
ffffffffc0204224:	853e                	mv	a0,a5
ffffffffc0204226:	8082                	ret
    size_t cnt = 0;
ffffffffc0204228:	4781                	li	a5,0
}
ffffffffc020422a:	853e                	mv	a0,a5
ffffffffc020422c:	8082                	ret

ffffffffc020422e <strnlen>:
 * pointed by @s.
 * */
size_t
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
    while (cnt < len && *s ++ != '\0') {
ffffffffc020422e:	c185                	beqz	a1,ffffffffc020424e <strnlen+0x20>
ffffffffc0204230:	00054783          	lbu	a5,0(a0)
ffffffffc0204234:	cf89                	beqz	a5,ffffffffc020424e <strnlen+0x20>
    size_t cnt = 0;
ffffffffc0204236:	4781                	li	a5,0
ffffffffc0204238:	a021                	j	ffffffffc0204240 <strnlen+0x12>
    while (cnt < len && *s ++ != '\0') {
ffffffffc020423a:	00074703          	lbu	a4,0(a4)
ffffffffc020423e:	c711                	beqz	a4,ffffffffc020424a <strnlen+0x1c>
        cnt ++;
ffffffffc0204240:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204242:	00f50733          	add	a4,a0,a5
ffffffffc0204246:	fef59ae3          	bne	a1,a5,ffffffffc020423a <strnlen+0xc>
    }
    return cnt;
}
ffffffffc020424a:	853e                	mv	a0,a5
ffffffffc020424c:	8082                	ret
    size_t cnt = 0;
ffffffffc020424e:	4781                	li	a5,0
}
ffffffffc0204250:	853e                	mv	a0,a5
ffffffffc0204252:	8082                	ret

ffffffffc0204254 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204254:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204256:	0585                	addi	a1,a1,1
ffffffffc0204258:	fff5c703          	lbu	a4,-1(a1)
ffffffffc020425c:	0785                	addi	a5,a5,1
ffffffffc020425e:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204262:	fb75                	bnez	a4,ffffffffc0204256 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc020426a:	0005c703          	lbu	a4,0(a1)
ffffffffc020426e:	cb91                	beqz	a5,ffffffffc0204282 <strcmp+0x1c>
ffffffffc0204270:	00e79c63          	bne	a5,a4,ffffffffc0204288 <strcmp+0x22>
        s1 ++, s2 ++;
ffffffffc0204274:	0505                	addi	a0,a0,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204276:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
ffffffffc020427a:	0585                	addi	a1,a1,1
ffffffffc020427c:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204280:	fbe5                	bnez	a5,ffffffffc0204270 <strcmp+0xa>
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204282:	4501                	li	a0,0
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204284:	9d19                	subw	a0,a0,a4
ffffffffc0204286:	8082                	ret
ffffffffc0204288:	0007851b          	sext.w	a0,a5
ffffffffc020428c:	9d19                	subw	a0,a0,a4
ffffffffc020428e:	8082                	ret

ffffffffc0204290 <strchr>:
...
ffffffffc0204294:	cb91                	beqz	a5,ffffffffc02042a8 <strchr+0x18>
        if (*s == c) {
ffffffffc0204296:	00b79563          	bne	a5,a1,ffffffffc02042a0 <strchr+0x10>
ffffffffc020429a:	a809                	j	ffffffffc02042ac <strchr+0x1c>
ffffffffc020429c:	00b78763          	beq	a5,a1,ffffffffc02042aa <strchr+0x1a>
            return (char *)s;
        }
        s ++;
ffffffffc02042a0:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02042a2:	00054783          	lbu	a5,0(a0)
ffffffffc02042a6:	fbfd                	bnez	a5,ffffffffc020429c <strchr+0xc>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02042ae:	ca01                	beqz	a2,ffffffffc02042be <memset+0x10>
ffffffffc02042b0:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02042b2:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02042b4:	0785                	addi	a5,a5,1
ffffffffc02042b6:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02042ba:	fec79de3          	bne	a5,a2,ffffffffc02042b4 <memset+0x6>
    }
    return s;
...
ffffffffc02042c0 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02042c0:	ca19                	beqz	a2,ffffffffc02042d6 <memcpy+0x16>
ffffffffc02042c2:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02042c4:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02042c6:	0585                	addi	a1,a1,1
ffffffffc02042c8:	fff5c703          	lbu	a4,-1(a1)
ffffffffc02042cc:	0785                	addi	a5,a5,1
ffffffffc02042ce:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02042d2:	fec59ae3          	bne	a1,a2,ffffffffc02042c6 <memcpy+0x6>
    }
    return dst;
