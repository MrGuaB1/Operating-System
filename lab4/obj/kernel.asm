...
ffffffffc020004c:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004e:	615040ef          	jal	ra,ffffffffc0204e62 <memset>
...
ffffffffc020005a:	e6a58593          	addi	a1,a1,-406 # ffffffffc0204ec0 <etext+0x4>
ffffffffc020005e:	00005517          	auipc	a0,0x5
ffffffffc0200062:	e8250513          	addi	a0,a0,-382 # ffffffffc0204ee0 <etext+0x24>
...
ffffffffc020007e:	5f0040ef          	jal	ra,ffffffffc020466e <proc_init>
...
ffffffffc0200092:	7d0040ef          	jal	ra,ffffffffc0204862 <cpu_idle>
...
ffffffffc02000b2:	e3a50513          	addi	a0,a0,-454 # ffffffffc0204ee8 <etext+0x2c>
...
ffffffffc0200180:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200182:	0b7040ef          	jal	ra,ffffffffc0204a38 <vprintfmt>
    return cnt;
}
...
ffffffffc02001b4:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001b6:	083040ef          	jal	ra,ffffffffc0204a38 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001dc:	d4850513          	addi	a0,a0,-696 # ffffffffc0204f20 <etext+0x64>
void print_kerninfo(void) {
...
ffffffffc02001f2:	d5250513          	addi	a0,a0,-686 # ffffffffc0204f40 <etext+0x84>
ffffffffc02001f6:	f99ff0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001fa:	00005597          	auipc	a1,0x5
ffffffffc02001fe:	cc258593          	addi	a1,a1,-830 # ffffffffc0204ebc <etext>
ffffffffc0200202:	00005517          	auipc	a0,0x5
ffffffffc0200206:	d5e50513          	addi	a0,a0,-674 # ffffffffc0204f60 <etext+0xa4>
...
ffffffffc020021a:	d6a50513          	addi	a0,a0,-662 # ffffffffc0204f80 <etext+0xc4>
...
ffffffffc020022e:	d7650513          	addi	a0,a0,-650 # ffffffffc0204fa0 <etext+0xe4>
...
ffffffffc020025c:	d6850513          	addi	a0,a0,-664 # ffffffffc0204fc0 <etext+0x104>
}
...
ffffffffc020026c:	c8860613          	addi	a2,a2,-888 # ffffffffc0204ef0 <etext+0x34>
ffffffffc0200270:	04d00593          	li	a1,77
ffffffffc0200274:	00005517          	auipc	a0,0x5
ffffffffc0200278:	c9450513          	addi	a0,a0,-876 # ffffffffc0204f08 <etext+0x4c>
void print_stackframe(void) {
...
ffffffffc0200288:	e4c60613          	addi	a2,a2,-436 # ffffffffc02050d0 <commands+0xe0>
ffffffffc020028c:	00005597          	auipc	a1,0x5
ffffffffc0200290:	e6458593          	addi	a1,a1,-412 # ffffffffc02050f0 <commands+0x100>
ffffffffc0200294:	00005517          	auipc	a0,0x5
ffffffffc0200298:	e6450513          	addi	a0,a0,-412 # ffffffffc02050f8 <commands+0x108>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002a6:	e6660613          	addi	a2,a2,-410 # ffffffffc0205108 <commands+0x118>
ffffffffc02002aa:	00005597          	auipc	a1,0x5
ffffffffc02002ae:	e8658593          	addi	a1,a1,-378 # ffffffffc0205130 <commands+0x140>
ffffffffc02002b2:	00005517          	auipc	a0,0x5
ffffffffc02002b6:	e4650513          	addi	a0,a0,-442 # ffffffffc02050f8 <commands+0x108>
ffffffffc02002ba:	ed5ff0ef          	jal	ra,ffffffffc020018e <cprintf>
ffffffffc02002be:	00005617          	auipc	a2,0x5
ffffffffc02002c2:	e8260613          	addi	a2,a2,-382 # ffffffffc0205140 <commands+0x150>
ffffffffc02002c6:	00005597          	auipc	a1,0x5
ffffffffc02002ca:	e9a58593          	addi	a1,a1,-358 # ffffffffc0205160 <commands+0x170>
ffffffffc02002ce:	00005517          	auipc	a0,0x5
ffffffffc02002d2:	e2a50513          	addi	a0,a0,-470 # ffffffffc02050f8 <commands+0x108>
...
ffffffffc020030c:	d3050513          	addi	a0,a0,-720 # ffffffffc0205038 <commands+0x48>
kmonitor(struct trapframe *tf) {
...
ffffffffc020032e:	d3650513          	addi	a0,a0,-714 # ffffffffc0205060 <commands+0x70>
...
ffffffffc0200350:	ca4c8c93          	addi	s9,s9,-860 # ffffffffc0204ff0 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200354:	00005997          	auipc	s3,0x5
ffffffffc0200358:	d3498993          	addi	s3,s3,-716 # ffffffffc0205088 <commands+0x98>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020035c:	00005917          	auipc	s2,0x5
ffffffffc0200360:	d3490913          	addi	s2,s2,-716 # ffffffffc0205090 <commands+0xa0>
        if (argc == MAXARGS - 1) {
ffffffffc0200364:	4a3d                	li	s4,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200366:	00005b17          	auipc	s6,0x5
ffffffffc020036a:	d32b0b13          	addi	s6,s6,-718 # ffffffffc0205098 <commands+0xa8>
    if (argc == 0) {
ffffffffc020036e:	00005a97          	auipc	s5,0x5
ffffffffc0200372:	d82a8a93          	addi	s5,s5,-638 # ffffffffc02050f0 <commands+0x100>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc020038c:	2b9040ef          	jal	ra,ffffffffc0204e44 <strchr>
...
ffffffffc02003a6:	c4ed0d13          	addi	s10,s10,-946 # ffffffffc0204ff0 <commands>
    if (argc == 0) {
...
ffffffffc02003b0:	26b040ef          	jal	ra,ffffffffc0204e1a <strcmp>
...
ffffffffc02003c4:	257040ef          	jal	ra,ffffffffc0204e1a <strcmp>
...
ffffffffc020042a:	21b040ef          	jal	ra,ffffffffc0204e44 <strchr>
...
ffffffffc0200446:	c7650513          	addi	a0,a0,-906 # ffffffffc02050b8 <commands+0xc8>
...
ffffffffc0200486:	cee50513          	addi	a0,a0,-786 # ffffffffc0205170 <commands+0x180>
    va_start(ap, fmt);
...
ffffffffc020049c:	c6050513          	addi	a0,a0,-928 # ffffffffc02060f8 <default_pmm_manager+0x500>
...
ffffffffc02004da:	cba50513          	addi	a0,a0,-838 # ffffffffc0205190 <commands+0x1a0>
    ticks = 0;
...
ffffffffc020059e:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02005a0:	0d5040ef          	jal	ra,ffffffffc0204e74 <memcpy>
    return 0;
}
...
ffffffffc02005c4:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005c6:	0af040ef          	jal	ra,ffffffffc0204e74 <memcpy>
    return 0;
}
...
ffffffffc0200614:	e7850513          	addi	a0,a0,-392 # ffffffffc0205488 <commands+0x498>
...
ffffffffc020063e:	e6e60613          	addi	a2,a2,-402 # ffffffffc02054a8 <commands+0x4b8>
ffffffffc0200642:	06200593          	li	a1,98
ffffffffc0200646:	00005517          	auipc	a0,0x5
ffffffffc020064a:	e7a50513          	addi	a0,a0,-390 # ffffffffc02054c0 <commands+0x4d0>
...
ffffffffc0200678:	e6450513          	addi	a0,a0,-412 # ffffffffc02054d8 <commands+0x4e8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200688:	e6c50513          	addi	a0,a0,-404 # ffffffffc02054f0 <commands+0x500>
...
ffffffffc0200696:	e7650513          	addi	a0,a0,-394 # ffffffffc0205508 <commands+0x518>
...
ffffffffc02006a4:	e8050513          	addi	a0,a0,-384 # ffffffffc0205520 <commands+0x530>
...
ffffffffc02006b2:	e8a50513          	addi	a0,a0,-374 # ffffffffc0205538 <commands+0x548>
...
ffffffffc02006c0:	e9450513          	addi	a0,a0,-364 # ffffffffc0205550 <commands+0x560>
...
ffffffffc02006ce:	e9e50513          	addi	a0,a0,-354 # ffffffffc0205568 <commands+0x578>
...
ffffffffc02006dc:	ea850513          	addi	a0,a0,-344 # ffffffffc0205580 <commands+0x590>
...
ffffffffc02006ea:	eb250513          	addi	a0,a0,-334 # ffffffffc0205598 <commands+0x5a8>
...
ffffffffc02006f8:	ebc50513          	addi	a0,a0,-324 # ffffffffc02055b0 <commands+0x5c0>
...
ffffffffc0200706:	ec650513          	addi	a0,a0,-314 # ffffffffc02055c8 <commands+0x5d8>
...
ffffffffc0200714:	ed050513          	addi	a0,a0,-304 # ffffffffc02055e0 <commands+0x5f0>
...
ffffffffc0200722:	eda50513          	addi	a0,a0,-294 # ffffffffc02055f8 <commands+0x608>
...
ffffffffc0200730:	ee450513          	addi	a0,a0,-284 # ffffffffc0205610 <commands+0x620>
...
ffffffffc020073e:	eee50513          	addi	a0,a0,-274 # ffffffffc0205628 <commands+0x638>
...
ffffffffc020074c:	ef850513          	addi	a0,a0,-264 # ffffffffc0205640 <commands+0x650>
...
ffffffffc020075a:	f0250513          	addi	a0,a0,-254 # ffffffffc0205658 <commands+0x668>
...
ffffffffc0200768:	f0c50513          	addi	a0,a0,-244 # ffffffffc0205670 <commands+0x680>
...
ffffffffc0200776:	f1650513          	addi	a0,a0,-234 # ffffffffc0205688 <commands+0x698>
...
ffffffffc0200784:	f2050513          	addi	a0,a0,-224 # ffffffffc02056a0 <commands+0x6b0>
...
ffffffffc0200792:	f2a50513          	addi	a0,a0,-214 # ffffffffc02056b8 <commands+0x6c8>
...
ffffffffc02007a0:	f3450513          	addi	a0,a0,-204 # ffffffffc02056d0 <commands+0x6e0>
...
ffffffffc02007ae:	f3e50513          	addi	a0,a0,-194 # ffffffffc02056e8 <commands+0x6f8>
...
ffffffffc02007bc:	f4850513          	addi	a0,a0,-184 # ffffffffc0205700 <commands+0x710>
...
ffffffffc02007ca:	f5250513          	addi	a0,a0,-174 # ffffffffc0205718 <commands+0x728>
...
ffffffffc02007d8:	f5c50513          	addi	a0,a0,-164 # ffffffffc0205730 <commands+0x740>
...
ffffffffc02007e6:	f6650513          	addi	a0,a0,-154 # ffffffffc0205748 <commands+0x758>
...
ffffffffc02007f4:	f7050513          	addi	a0,a0,-144 # ffffffffc0205760 <commands+0x770>
...
ffffffffc0200802:	f7a50513          	addi	a0,a0,-134 # ffffffffc0205778 <commands+0x788>
...
ffffffffc0200810:	f8450513          	addi	a0,a0,-124 # ffffffffc0205790 <commands+0x7a0>
...
ffffffffc020081e:	f8e50513          	addi	a0,a0,-114 # ffffffffc02057a8 <commands+0x7b8>
...
ffffffffc0200830:	f9450513          	addi	a0,a0,-108 # ffffffffc02057c0 <commands+0x7d0>
}
...
ffffffffc0200846:	f9650513          	addi	a0,a0,-106 # ffffffffc02057d8 <commands+0x7e8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc020085e:	f9650513          	addi	a0,a0,-106 # ffffffffc02057f0 <commands+0x800>
...
ffffffffc020086e:	f9e50513          	addi	a0,a0,-98 # ffffffffc0205808 <commands+0x818>
...
ffffffffc020087e:	fa650513          	addi	a0,a0,-90 # ffffffffc0205820 <commands+0x830>
...
ffffffffc0200892:	faa50513          	addi	a0,a0,-86 # ffffffffc0205838 <commands+0x848>
}
...
ffffffffc02008b0:	90070713          	addi	a4,a4,-1792 # ffffffffc02051ac <commands+0x1bc>
...
ffffffffc02008c2:	b7a50513          	addi	a0,a0,-1158 # ffffffffc0205438 <commands+0x448>
ffffffffc02008c6:	8c9ff06f          	j	ffffffffc020018e <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02008ca:	00005517          	auipc	a0,0x5
ffffffffc02008ce:	b4e50513          	addi	a0,a0,-1202 # ffffffffc0205418 <commands+0x428>
ffffffffc02008d2:	8bdff06f          	j	ffffffffc020018e <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02008d6:	00005517          	auipc	a0,0x5
ffffffffc02008da:	b0250513          	addi	a0,a0,-1278 # ffffffffc02053d8 <commands+0x3e8>
ffffffffc02008de:	8b1ff06f          	j	ffffffffc020018e <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02008e2:	00005517          	auipc	a0,0x5
ffffffffc02008e6:	b1650513          	addi	a0,a0,-1258 # ffffffffc02053f8 <commands+0x408>
...
ffffffffc02008f2:	b7a50513          	addi	a0,a0,-1158 # ffffffffc0205468 <commands+0x478>
...
ffffffffc0200934:	b2850513          	addi	a0,a0,-1240 # ffffffffc0205458 <commands+0x468>
}
...
ffffffffc020094c:	89470713          	addi	a4,a4,-1900 # ffffffffc02051dc <commands+0x1ec>
...
ffffffffc0200968:	a5c50513          	addi	a0,a0,-1444 # ffffffffc02053c0 <commands+0x3d0>
...
ffffffffc020098a:	89a50513          	addi	a0,a0,-1894 # ffffffffc0205220 <commands+0x230>
}
...
ffffffffc02009e4:	8e060613          	addi	a2,a2,-1824 # ffffffffc02052c0 <commands+0x2d0>
ffffffffc02009e8:	0b300593          	li	a1,179
ffffffffc02009ec:	00005517          	auipc	a0,0x5
ffffffffc02009f0:	ad450513          	addi	a0,a0,-1324 # ffffffffc02054c0 <commands+0x4d0>
ffffffffc02009f4:	a5dff0ef          	jal	ra,ffffffffc0200450 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc02009f8:	00005517          	auipc	a0,0x5
ffffffffc02009fc:	8e850513          	addi	a0,a0,-1816 # ffffffffc02052e0 <commands+0x2f0>
ffffffffc0200a00:	b779                	j	ffffffffc020098e <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc0200a02:	00005517          	auipc	a0,0x5
ffffffffc0200a06:	8f650513          	addi	a0,a0,-1802 # ffffffffc02052f8 <commands+0x308>
...
ffffffffc0200a8e:	83660613          	addi	a2,a2,-1994 # ffffffffc02052c0 <commands+0x2d0>
ffffffffc0200a92:	0d300593          	li	a1,211
ffffffffc0200a96:	00005517          	auipc	a0,0x5
ffffffffc0200a9a:	a2a50513          	addi	a0,a0,-1494 # ffffffffc02054c0 <commands+0x4d0>
...
ffffffffc0200abe:	80660613          	addi	a2,a2,-2042 # ffffffffc02052c0 <commands+0x2d0>
ffffffffc0200ac2:	0da00593          	li	a1,218
ffffffffc0200ac6:	00005517          	auipc	a0,0x5
ffffffffc0200aca:	9fa50513          	addi	a0,a0,-1542 # ffffffffc02054c0 <commands+0x4d0>
...
ffffffffc0200c68:	33c70713          	addi	a4,a4,828 # ffffffffc0206fa0 <nbase>
...
ffffffffc0200ef0:	96468693          	addi	a3,a3,-1692 # ffffffffc0205850 <commands+0x860>
ffffffffc0200ef4:	00005617          	auipc	a2,0x5
ffffffffc0200ef8:	96c60613          	addi	a2,a2,-1684 # ffffffffc0205860 <commands+0x870>
ffffffffc0200efc:	0f000593          	li	a1,240
ffffffffc0200f00:	00005517          	auipc	a0,0x5
ffffffffc0200f04:	97850513          	addi	a0,a0,-1672 # ffffffffc0205878 <commands+0x888>
ffffffffc0200f08:	d48ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200f0c:	00005697          	auipc	a3,0x5
ffffffffc0200f10:	a0468693          	addi	a3,a3,-1532 # ffffffffc0205910 <commands+0x920>
ffffffffc0200f14:	00005617          	auipc	a2,0x5
ffffffffc0200f18:	94c60613          	addi	a2,a2,-1716 # ffffffffc0205860 <commands+0x870>
ffffffffc0200f1c:	0bd00593          	li	a1,189
ffffffffc0200f20:	00005517          	auipc	a0,0x5
ffffffffc0200f24:	95850513          	addi	a0,a0,-1704 # ffffffffc0205878 <commands+0x888>
ffffffffc0200f28:	d28ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200f2c:	00005697          	auipc	a3,0x5
ffffffffc0200f30:	a0c68693          	addi	a3,a3,-1524 # ffffffffc0205938 <commands+0x948>
ffffffffc0200f34:	00005617          	auipc	a2,0x5
ffffffffc0200f38:	92c60613          	addi	a2,a2,-1748 # ffffffffc0205860 <commands+0x870>
ffffffffc0200f3c:	0be00593          	li	a1,190
ffffffffc0200f40:	00005517          	auipc	a0,0x5
ffffffffc0200f44:	93850513          	addi	a0,a0,-1736 # ffffffffc0205878 <commands+0x888>
ffffffffc0200f48:	d08ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200f4c:	00005697          	auipc	a3,0x5
ffffffffc0200f50:	a2c68693          	addi	a3,a3,-1492 # ffffffffc0205978 <commands+0x988>
ffffffffc0200f54:	00005617          	auipc	a2,0x5
ffffffffc0200f58:	90c60613          	addi	a2,a2,-1780 # ffffffffc0205860 <commands+0x870>
ffffffffc0200f5c:	0c000593          	li	a1,192
ffffffffc0200f60:	00005517          	auipc	a0,0x5
ffffffffc0200f64:	91850513          	addi	a0,a0,-1768 # ffffffffc0205878 <commands+0x888>
ffffffffc0200f68:	ce8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200f6c:	00005697          	auipc	a3,0x5
ffffffffc0200f70:	a9468693          	addi	a3,a3,-1388 # ffffffffc0205a00 <commands+0xa10>
ffffffffc0200f74:	00005617          	auipc	a2,0x5
ffffffffc0200f78:	8ec60613          	addi	a2,a2,-1812 # ffffffffc0205860 <commands+0x870>
ffffffffc0200f7c:	0d900593          	li	a1,217
ffffffffc0200f80:	00005517          	auipc	a0,0x5
ffffffffc0200f84:	8f850513          	addi	a0,a0,-1800 # ffffffffc0205878 <commands+0x888>
ffffffffc0200f88:	cc8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f8c:	00005697          	auipc	a3,0x5
ffffffffc0200f90:	92468693          	addi	a3,a3,-1756 # ffffffffc02058b0 <commands+0x8c0>
ffffffffc0200f94:	00005617          	auipc	a2,0x5
ffffffffc0200f98:	8cc60613          	addi	a2,a2,-1844 # ffffffffc0205860 <commands+0x870>
ffffffffc0200f9c:	0d200593          	li	a1,210
ffffffffc0200fa0:	00005517          	auipc	a0,0x5
ffffffffc0200fa4:	8d850513          	addi	a0,a0,-1832 # ffffffffc0205878 <commands+0x888>
ffffffffc0200fa8:	ca8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free == 3);
ffffffffc0200fac:	00005697          	auipc	a3,0x5
ffffffffc0200fb0:	a4468693          	addi	a3,a3,-1468 # ffffffffc02059f0 <commands+0xa00>
ffffffffc0200fb4:	00005617          	auipc	a2,0x5
ffffffffc0200fb8:	8ac60613          	addi	a2,a2,-1876 # ffffffffc0205860 <commands+0x870>
ffffffffc0200fbc:	0d000593          	li	a1,208
ffffffffc0200fc0:	00005517          	auipc	a0,0x5
ffffffffc0200fc4:	8b850513          	addi	a0,a0,-1864 # ffffffffc0205878 <commands+0x888>
ffffffffc0200fc8:	c88ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200fcc:	00005697          	auipc	a3,0x5
ffffffffc0200fd0:	a0c68693          	addi	a3,a3,-1524 # ffffffffc02059d8 <commands+0x9e8>
ffffffffc0200fd4:	00005617          	auipc	a2,0x5
ffffffffc0200fd8:	88c60613          	addi	a2,a2,-1908 # ffffffffc0205860 <commands+0x870>
ffffffffc0200fdc:	0cb00593          	li	a1,203
ffffffffc0200fe0:	00005517          	auipc	a0,0x5
ffffffffc0200fe4:	89850513          	addi	a0,a0,-1896 # ffffffffc0205878 <commands+0x888>
ffffffffc0200fe8:	c68ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200fec:	00005697          	auipc	a3,0x5
ffffffffc0200ff0:	9cc68693          	addi	a3,a3,-1588 # ffffffffc02059b8 <commands+0x9c8>
ffffffffc0200ff4:	00005617          	auipc	a2,0x5
ffffffffc0200ff8:	86c60613          	addi	a2,a2,-1940 # ffffffffc0205860 <commands+0x870>
ffffffffc0200ffc:	0c200593          	li	a1,194
ffffffffc0201000:	00005517          	auipc	a0,0x5
ffffffffc0201004:	87850513          	addi	a0,a0,-1928 # ffffffffc0205878 <commands+0x888>
ffffffffc0201008:	c48ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(p0 != NULL);
ffffffffc020100c:	00005697          	auipc	a3,0x5
ffffffffc0201010:	a3c68693          	addi	a3,a3,-1476 # ffffffffc0205a48 <commands+0xa58>
ffffffffc0201014:	00005617          	auipc	a2,0x5
ffffffffc0201018:	84c60613          	addi	a2,a2,-1972 # ffffffffc0205860 <commands+0x870>
ffffffffc020101c:	0f800593          	li	a1,248
ffffffffc0201020:	00005517          	auipc	a0,0x5
ffffffffc0201024:	85850513          	addi	a0,a0,-1960 # ffffffffc0205878 <commands+0x888>
ffffffffc0201028:	c28ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free == 0);
ffffffffc020102c:	00005697          	auipc	a3,0x5
ffffffffc0201030:	a0c68693          	addi	a3,a3,-1524 # ffffffffc0205a38 <commands+0xa48>
ffffffffc0201034:	00005617          	auipc	a2,0x5
ffffffffc0201038:	82c60613          	addi	a2,a2,-2004 # ffffffffc0205860 <commands+0x870>
ffffffffc020103c:	0df00593          	li	a1,223
ffffffffc0201040:	00005517          	auipc	a0,0x5
ffffffffc0201044:	83850513          	addi	a0,a0,-1992 # ffffffffc0205878 <commands+0x888>
ffffffffc0201048:	c08ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc020104c:	00005697          	auipc	a3,0x5
ffffffffc0201050:	98c68693          	addi	a3,a3,-1652 # ffffffffc02059d8 <commands+0x9e8>
ffffffffc0201054:	00005617          	auipc	a2,0x5
ffffffffc0201058:	80c60613          	addi	a2,a2,-2036 # ffffffffc0205860 <commands+0x870>
ffffffffc020105c:	0dd00593          	li	a1,221
ffffffffc0201060:	00005517          	auipc	a0,0x5
ffffffffc0201064:	81850513          	addi	a0,a0,-2024 # ffffffffc0205878 <commands+0x888>
ffffffffc0201068:	be8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc020106c:	00005697          	auipc	a3,0x5
ffffffffc0201070:	9ac68693          	addi	a3,a3,-1620 # ffffffffc0205a18 <commands+0xa28>
ffffffffc0201074:	00004617          	auipc	a2,0x4
ffffffffc0201078:	7ec60613          	addi	a2,a2,2028 # ffffffffc0205860 <commands+0x870>
ffffffffc020107c:	0dc00593          	li	a1,220
ffffffffc0201080:	00004517          	auipc	a0,0x4
ffffffffc0201084:	7f850513          	addi	a0,a0,2040 # ffffffffc0205878 <commands+0x888>
ffffffffc0201088:	bc8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc020108c:	00005697          	auipc	a3,0x5
ffffffffc0201090:	82468693          	addi	a3,a3,-2012 # ffffffffc02058b0 <commands+0x8c0>
ffffffffc0201094:	00004617          	auipc	a2,0x4
ffffffffc0201098:	7cc60613          	addi	a2,a2,1996 # ffffffffc0205860 <commands+0x870>
ffffffffc020109c:	0b900593          	li	a1,185
ffffffffc02010a0:	00004517          	auipc	a0,0x4
ffffffffc02010a4:	7d850513          	addi	a0,a0,2008 # ffffffffc0205878 <commands+0x888>
ffffffffc02010a8:	ba8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010ac:	00005697          	auipc	a3,0x5
ffffffffc02010b0:	92c68693          	addi	a3,a3,-1748 # ffffffffc02059d8 <commands+0x9e8>
ffffffffc02010b4:	00004617          	auipc	a2,0x4
ffffffffc02010b8:	7ac60613          	addi	a2,a2,1964 # ffffffffc0205860 <commands+0x870>
ffffffffc02010bc:	0d600593          	li	a1,214
ffffffffc02010c0:	00004517          	auipc	a0,0x4
ffffffffc02010c4:	7b850513          	addi	a0,a0,1976 # ffffffffc0205878 <commands+0x888>
ffffffffc02010c8:	b88ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02010cc:	00005697          	auipc	a3,0x5
ffffffffc02010d0:	82468693          	addi	a3,a3,-2012 # ffffffffc02058f0 <commands+0x900>
ffffffffc02010d4:	00004617          	auipc	a2,0x4
ffffffffc02010d8:	78c60613          	addi	a2,a2,1932 # ffffffffc0205860 <commands+0x870>
ffffffffc02010dc:	0d400593          	li	a1,212
ffffffffc02010e0:	00004517          	auipc	a0,0x4
ffffffffc02010e4:	79850513          	addi	a0,a0,1944 # ffffffffc0205878 <commands+0x888>
ffffffffc02010e8:	b68ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02010ec:	00004697          	auipc	a3,0x4
ffffffffc02010f0:	7e468693          	addi	a3,a3,2020 # ffffffffc02058d0 <commands+0x8e0>
ffffffffc02010f4:	00004617          	auipc	a2,0x4
ffffffffc02010f8:	76c60613          	addi	a2,a2,1900 # ffffffffc0205860 <commands+0x870>
ffffffffc02010fc:	0d300593          	li	a1,211
ffffffffc0201100:	00004517          	auipc	a0,0x4
ffffffffc0201104:	77850513          	addi	a0,a0,1912 # ffffffffc0205878 <commands+0x888>
ffffffffc0201108:	b48ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc020110c:	00004697          	auipc	a3,0x4
ffffffffc0201110:	7e468693          	addi	a3,a3,2020 # ffffffffc02058f0 <commands+0x900>
ffffffffc0201114:	00004617          	auipc	a2,0x4
ffffffffc0201118:	74c60613          	addi	a2,a2,1868 # ffffffffc0205860 <commands+0x870>
ffffffffc020111c:	0bb00593          	li	a1,187
ffffffffc0201120:	00004517          	auipc	a0,0x4
ffffffffc0201124:	75850513          	addi	a0,a0,1880 # ffffffffc0205878 <commands+0x888>
ffffffffc0201128:	b28ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(count == 0);
ffffffffc020112c:	00005697          	auipc	a3,0x5
ffffffffc0201130:	a6c68693          	addi	a3,a3,-1428 # ffffffffc0205b98 <commands+0xba8>
ffffffffc0201134:	00004617          	auipc	a2,0x4
ffffffffc0201138:	72c60613          	addi	a2,a2,1836 # ffffffffc0205860 <commands+0x870>
ffffffffc020113c:	12500593          	li	a1,293
ffffffffc0201140:	00004517          	auipc	a0,0x4
ffffffffc0201144:	73850513          	addi	a0,a0,1848 # ffffffffc0205878 <commands+0x888>
ffffffffc0201148:	b08ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free == 0);
ffffffffc020114c:	00005697          	auipc	a3,0x5
ffffffffc0201150:	8ec68693          	addi	a3,a3,-1812 # ffffffffc0205a38 <commands+0xa48>
ffffffffc0201154:	00004617          	auipc	a2,0x4
ffffffffc0201158:	70c60613          	addi	a2,a2,1804 # ffffffffc0205860 <commands+0x870>
ffffffffc020115c:	11a00593          	li	a1,282
ffffffffc0201160:	00004517          	auipc	a0,0x4
ffffffffc0201164:	71850513          	addi	a0,a0,1816 # ffffffffc0205878 <commands+0x888>
ffffffffc0201168:	ae8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc020116c:	00005697          	auipc	a3,0x5
ffffffffc0201170:	86c68693          	addi	a3,a3,-1940 # ffffffffc02059d8 <commands+0x9e8>
ffffffffc0201174:	00004617          	auipc	a2,0x4
ffffffffc0201178:	6ec60613          	addi	a2,a2,1772 # ffffffffc0205860 <commands+0x870>
ffffffffc020117c:	11800593          	li	a1,280
ffffffffc0201180:	00004517          	auipc	a0,0x4
ffffffffc0201184:	6f850513          	addi	a0,a0,1784 # ffffffffc0205878 <commands+0x888>
ffffffffc0201188:	ac8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc020118c:	00005697          	auipc	a3,0x5
ffffffffc0201190:	80c68693          	addi	a3,a3,-2036 # ffffffffc0205998 <commands+0x9a8>
ffffffffc0201194:	00004617          	auipc	a2,0x4
ffffffffc0201198:	6cc60613          	addi	a2,a2,1740 # ffffffffc0205860 <commands+0x870>
ffffffffc020119c:	0c100593          	li	a1,193
ffffffffc02011a0:	00004517          	auipc	a0,0x4
ffffffffc02011a4:	6d850513          	addi	a0,a0,1752 # ffffffffc0205878 <commands+0x888>
ffffffffc02011a8:	aa8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc02011ac:	00005697          	auipc	a3,0x5
ffffffffc02011b0:	9ac68693          	addi	a3,a3,-1620 # ffffffffc0205b58 <commands+0xb68>
ffffffffc02011b4:	00004617          	auipc	a2,0x4
ffffffffc02011b8:	6ac60613          	addi	a2,a2,1708 # ffffffffc0205860 <commands+0x870>
ffffffffc02011bc:	11200593          	li	a1,274
ffffffffc02011c0:	00004517          	auipc	a0,0x4
ffffffffc02011c4:	6b850513          	addi	a0,a0,1720 # ffffffffc0205878 <commands+0x888>
ffffffffc02011c8:	a88ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02011cc:	00005697          	auipc	a3,0x5
ffffffffc02011d0:	96c68693          	addi	a3,a3,-1684 # ffffffffc0205b38 <commands+0xb48>
ffffffffc02011d4:	00004617          	auipc	a2,0x4
ffffffffc02011d8:	68c60613          	addi	a2,a2,1676 # ffffffffc0205860 <commands+0x870>
ffffffffc02011dc:	11000593          	li	a1,272
ffffffffc02011e0:	00004517          	auipc	a0,0x4
ffffffffc02011e4:	69850513          	addi	a0,a0,1688 # ffffffffc0205878 <commands+0x888>
ffffffffc02011e8:	a68ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02011ec:	00005697          	auipc	a3,0x5
ffffffffc02011f0:	92468693          	addi	a3,a3,-1756 # ffffffffc0205b10 <commands+0xb20>
ffffffffc02011f4:	00004617          	auipc	a2,0x4
ffffffffc02011f8:	66c60613          	addi	a2,a2,1644 # ffffffffc0205860 <commands+0x870>
ffffffffc02011fc:	10e00593          	li	a1,270
ffffffffc0201200:	00004517          	auipc	a0,0x4
ffffffffc0201204:	67850513          	addi	a0,a0,1656 # ffffffffc0205878 <commands+0x888>
ffffffffc0201208:	a48ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc020120c:	00005697          	auipc	a3,0x5
ffffffffc0201210:	8dc68693          	addi	a3,a3,-1828 # ffffffffc0205ae8 <commands+0xaf8>
ffffffffc0201214:	00004617          	auipc	a2,0x4
ffffffffc0201218:	64c60613          	addi	a2,a2,1612 # ffffffffc0205860 <commands+0x870>
ffffffffc020121c:	10d00593          	li	a1,269
ffffffffc0201220:	00004517          	auipc	a0,0x4
ffffffffc0201224:	65850513          	addi	a0,a0,1624 # ffffffffc0205878 <commands+0x888>
ffffffffc0201228:	a28ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(p0 + 2 == p1);
ffffffffc020122c:	00005697          	auipc	a3,0x5
ffffffffc0201230:	8ac68693          	addi	a3,a3,-1876 # ffffffffc0205ad8 <commands+0xae8>
ffffffffc0201234:	00004617          	auipc	a2,0x4
ffffffffc0201238:	62c60613          	addi	a2,a2,1580 # ffffffffc0205860 <commands+0x870>
ffffffffc020123c:	10800593          	li	a1,264
ffffffffc0201240:	00004517          	auipc	a0,0x4
ffffffffc0201244:	63850513          	addi	a0,a0,1592 # ffffffffc0205878 <commands+0x888>
ffffffffc0201248:	a08ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc020124c:	00004697          	auipc	a3,0x4
ffffffffc0201250:	78c68693          	addi	a3,a3,1932 # ffffffffc02059d8 <commands+0x9e8>
ffffffffc0201254:	00004617          	auipc	a2,0x4
ffffffffc0201258:	60c60613          	addi	a2,a2,1548 # ffffffffc0205860 <commands+0x870>
ffffffffc020125c:	10700593          	li	a1,263
ffffffffc0201260:	00004517          	auipc	a0,0x4
ffffffffc0201264:	61850513          	addi	a0,a0,1560 # ffffffffc0205878 <commands+0x888>
ffffffffc0201268:	9e8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc020126c:	00005697          	auipc	a3,0x5
ffffffffc0201270:	84c68693          	addi	a3,a3,-1972 # ffffffffc0205ab8 <commands+0xac8>
ffffffffc0201274:	00004617          	auipc	a2,0x4
ffffffffc0201278:	5ec60613          	addi	a2,a2,1516 # ffffffffc0205860 <commands+0x870>
ffffffffc020127c:	10600593          	li	a1,262
ffffffffc0201280:	00004517          	auipc	a0,0x4
ffffffffc0201284:	5f850513          	addi	a0,a0,1528 # ffffffffc0205878 <commands+0x888>
ffffffffc0201288:	9c8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc020128c:	00004697          	auipc	a3,0x4
ffffffffc0201290:	7fc68693          	addi	a3,a3,2044 # ffffffffc0205a88 <commands+0xa98>
ffffffffc0201294:	00004617          	auipc	a2,0x4
ffffffffc0201298:	5cc60613          	addi	a2,a2,1484 # ffffffffc0205860 <commands+0x870>
ffffffffc020129c:	10500593          	li	a1,261
ffffffffc02012a0:	00004517          	auipc	a0,0x4
ffffffffc02012a4:	5d850513          	addi	a0,a0,1496 # ffffffffc0205878 <commands+0x888>
ffffffffc02012a8:	9a8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc02012ac:	00004697          	auipc	a3,0x4
ffffffffc02012b0:	7c468693          	addi	a3,a3,1988 # ffffffffc0205a70 <commands+0xa80>
ffffffffc02012b4:	00004617          	auipc	a2,0x4
ffffffffc02012b8:	5ac60613          	addi	a2,a2,1452 # ffffffffc0205860 <commands+0x870>
ffffffffc02012bc:	10400593          	li	a1,260
ffffffffc02012c0:	00004517          	auipc	a0,0x4
ffffffffc02012c4:	5b850513          	addi	a0,a0,1464 # ffffffffc0205878 <commands+0x888>
ffffffffc02012c8:	988ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02012cc:	00004697          	auipc	a3,0x4
ffffffffc02012d0:	70c68693          	addi	a3,a3,1804 # ffffffffc02059d8 <commands+0x9e8>
ffffffffc02012d4:	00004617          	auipc	a2,0x4
ffffffffc02012d8:	58c60613          	addi	a2,a2,1420 # ffffffffc0205860 <commands+0x870>
ffffffffc02012dc:	0fe00593          	li	a1,254
ffffffffc02012e0:	00004517          	auipc	a0,0x4
ffffffffc02012e4:	59850513          	addi	a0,a0,1432 # ffffffffc0205878 <commands+0x888>
ffffffffc02012e8:	968ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(!PageProperty(p0));
ffffffffc02012ec:	00004697          	auipc	a3,0x4
ffffffffc02012f0:	76c68693          	addi	a3,a3,1900 # ffffffffc0205a58 <commands+0xa68>
ffffffffc02012f4:	00004617          	auipc	a2,0x4
ffffffffc02012f8:	56c60613          	addi	a2,a2,1388 # ffffffffc0205860 <commands+0x870>
ffffffffc02012fc:	0f900593          	li	a1,249
ffffffffc0201300:	00004517          	auipc	a0,0x4
ffffffffc0201304:	57850513          	addi	a0,a0,1400 # ffffffffc0205878 <commands+0x888>
ffffffffc0201308:	948ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc020130c:	00005697          	auipc	a3,0x5
ffffffffc0201310:	86c68693          	addi	a3,a3,-1940 # ffffffffc0205b78 <commands+0xb88>
ffffffffc0201314:	00004617          	auipc	a2,0x4
ffffffffc0201318:	54c60613          	addi	a2,a2,1356 # ffffffffc0205860 <commands+0x870>
ffffffffc020131c:	11700593          	li	a1,279
ffffffffc0201320:	00004517          	auipc	a0,0x4
ffffffffc0201324:	55850513          	addi	a0,a0,1368 # ffffffffc0205878 <commands+0x888>
ffffffffc0201328:	928ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(total == 0);
ffffffffc020132c:	00005697          	auipc	a3,0x5
ffffffffc0201330:	87c68693          	addi	a3,a3,-1924 # ffffffffc0205ba8 <commands+0xbb8>
ffffffffc0201334:	00004617          	auipc	a2,0x4
ffffffffc0201338:	52c60613          	addi	a2,a2,1324 # ffffffffc0205860 <commands+0x870>
ffffffffc020133c:	12600593          	li	a1,294
ffffffffc0201340:	00004517          	auipc	a0,0x4
ffffffffc0201344:	53850513          	addi	a0,a0,1336 # ffffffffc0205878 <commands+0x888>
ffffffffc0201348:	908ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(total == nr_free_pages());
ffffffffc020134c:	00004697          	auipc	a3,0x4
ffffffffc0201350:	54468693          	addi	a3,a3,1348 # ffffffffc0205890 <commands+0x8a0>
ffffffffc0201354:	00004617          	auipc	a2,0x4
ffffffffc0201358:	50c60613          	addi	a2,a2,1292 # ffffffffc0205860 <commands+0x870>
ffffffffc020135c:	0f300593          	li	a1,243
ffffffffc0201360:	00004517          	auipc	a0,0x4
ffffffffc0201364:	51850513          	addi	a0,a0,1304 # ffffffffc0205878 <commands+0x888>
ffffffffc0201368:	8e8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc020136c:	00004697          	auipc	a3,0x4
ffffffffc0201370:	56468693          	addi	a3,a3,1380 # ffffffffc02058d0 <commands+0x8e0>
ffffffffc0201374:	00004617          	auipc	a2,0x4
ffffffffc0201378:	4ec60613          	addi	a2,a2,1260 # ffffffffc0205860 <commands+0x870>
ffffffffc020137c:	0ba00593          	li	a1,186
ffffffffc0201380:	00004517          	auipc	a0,0x4
ffffffffc0201384:	4f850513          	addi	a0,a0,1272 # ffffffffc0205878 <commands+0x888>
...
ffffffffc02014f0:	6cc68693          	addi	a3,a3,1740 # ffffffffc0205bb8 <commands+0xbc8>
ffffffffc02014f4:	00004617          	auipc	a2,0x4
ffffffffc02014f8:	36c60613          	addi	a2,a2,876 # ffffffffc0205860 <commands+0x870>
ffffffffc02014fc:	08300593          	li	a1,131
ffffffffc0201500:	00004517          	auipc	a0,0x4
ffffffffc0201504:	37850513          	addi	a0,a0,888 # ffffffffc0205878 <commands+0x888>
ffffffffc0201508:	f49fe0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(n > 0);
ffffffffc020150c:	00004697          	auipc	a3,0x4
ffffffffc0201510:	6d468693          	addi	a3,a3,1748 # ffffffffc0205be0 <commands+0xbf0>
ffffffffc0201514:	00004617          	auipc	a2,0x4
ffffffffc0201518:	34c60613          	addi	a2,a2,844 # ffffffffc0205860 <commands+0x870>
ffffffffc020151c:	08000593          	li	a1,128
ffffffffc0201520:	00004517          	auipc	a0,0x4
ffffffffc0201524:	35850513          	addi	a0,a0,856 # ffffffffc0205878 <commands+0x888>
...
ffffffffc02015c8:	61c68693          	addi	a3,a3,1564 # ffffffffc0205be0 <commands+0xbf0>
ffffffffc02015cc:	00004617          	auipc	a2,0x4
ffffffffc02015d0:	29460613          	addi	a2,a2,660 # ffffffffc0205860 <commands+0x870>
ffffffffc02015d4:	06200593          	li	a1,98
ffffffffc02015d8:	00004517          	auipc	a0,0x4
ffffffffc02015dc:	2a050513          	addi	a0,a0,672 # ffffffffc0205878 <commands+0x888>
default_alloc_pages(size_t n) {
...
ffffffffc02016b0:	53c68693          	addi	a3,a3,1340 # ffffffffc0205be8 <commands+0xbf8>
ffffffffc02016b4:	00004617          	auipc	a2,0x4
ffffffffc02016b8:	1ac60613          	addi	a2,a2,428 # ffffffffc0205860 <commands+0x870>
ffffffffc02016bc:	04900593          	li	a1,73
ffffffffc02016c0:	00004517          	auipc	a0,0x4
ffffffffc02016c4:	1b850513          	addi	a0,a0,440 # ffffffffc0205878 <commands+0x888>
ffffffffc02016c8:	d89fe0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(n > 0);
ffffffffc02016cc:	00004697          	auipc	a3,0x4
ffffffffc02016d0:	51468693          	addi	a3,a3,1300 # ffffffffc0205be0 <commands+0xbf0>
ffffffffc02016d4:	00004617          	auipc	a2,0x4
ffffffffc02016d8:	18c60613          	addi	a2,a2,396 # ffffffffc0205860 <commands+0x870>
ffffffffc02016dc:	04600593          	li	a1,70
ffffffffc02016e0:	00004517          	auipc	a0,0x4
ffffffffc02016e4:	19850513          	addi	a0,a0,408 # ffffffffc0205878 <commands+0x888>
...
ffffffffc0201820:	78478793          	addi	a5,a5,1924 # ffffffffc0206fa0 <nbase>
...
ffffffffc0201862:	3ea60613          	addi	a2,a2,1002 # ffffffffc0205c48 <default_pmm_manager+0x50>
ffffffffc0201866:	06900593          	li	a1,105
ffffffffc020186a:	00004517          	auipc	a0,0x4
ffffffffc020186e:	40650513          	addi	a0,a0,1030 # ffffffffc0205c70 <default_pmm_manager+0x78>
...
ffffffffc020195e:	38e68693          	addi	a3,a3,910 # ffffffffc0205ce8 <default_pmm_manager+0xf0>
ffffffffc0201962:	00004617          	auipc	a2,0x4
ffffffffc0201966:	efe60613          	addi	a2,a2,-258 # ffffffffc0205860 <commands+0x870>
ffffffffc020196a:	06300593          	li	a1,99
ffffffffc020196e:	00004517          	auipc	a0,0x4
ffffffffc0201972:	39a50513          	addi	a0,a0,922 # ffffffffc0205d08 <default_pmm_manager+0x110>
...
ffffffffc0201980:	3a450513          	addi	a0,a0,932 # ffffffffc0205d20 <default_pmm_manager+0x128>
kmalloc_init(void) {
...
ffffffffc0201990:	33c50513          	addi	a0,a0,828 # ffffffffc0205cc8 <default_pmm_manager+0xd0>
}
...
ffffffffc0201ad8:	4cc78793          	addi	a5,a5,1228 # ffffffffc0206fa0 <nbase>
...
ffffffffc0201b4e:	13660613          	addi	a2,a2,310 # ffffffffc0205c80 <default_pmm_manager+0x88>
ffffffffc0201b52:	06e00593          	li	a1,110
ffffffffc0201b56:	00004517          	auipc	a0,0x4
ffffffffc0201b5a:	11a50513          	addi	a0,a0,282 # ffffffffc0205c70 <default_pmm_manager+0x78>
ffffffffc0201b5e:	8f3fe0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0201b62:	00004617          	auipc	a2,0x4
ffffffffc0201b66:	14660613          	addi	a2,a2,326 # ffffffffc0205ca8 <default_pmm_manager+0xb0>
ffffffffc0201b6a:	06200593          	li	a1,98
ffffffffc0201b6e:	00004517          	auipc	a0,0x4
ffffffffc0201b72:	10250513          	addi	a0,a0,258 # ffffffffc0205c70 <default_pmm_manager+0x78>
...
ffffffffc0201b80:	12c60613          	addi	a2,a2,300 # ffffffffc0205ca8 <default_pmm_manager+0xb0>
ffffffffc0201b84:	06200593          	li	a1,98
ffffffffc0201b88:	00004517          	auipc	a0,0x4
ffffffffc0201b8c:	0e850513          	addi	a0,a0,232 # ffffffffc0205c70 <default_pmm_manager+0x78>
pa2page(uintptr_t pa) {
...
ffffffffc0201d2a:	138030ef          	jal	ra,ffffffffc0204e62 <memset>
    return page - pages + nbase;
...
ffffffffc0201dbc:	0a6030ef          	jal	ra,ffffffffc0204e62 <memset>
    return page - pages + nbase;
...
ffffffffc0201e16:	e3660613          	addi	a2,a2,-458 # ffffffffc0205c48 <default_pmm_manager+0x50>
ffffffffc0201e1a:	0e400593          	li	a1,228
ffffffffc0201e1e:	00004517          	auipc	a0,0x4
ffffffffc0201e22:	f1a50513          	addi	a0,a0,-230 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0201e26:	e2afe0ef          	jal	ra,ffffffffc0200450 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201e2a:	00004617          	auipc	a2,0x4
ffffffffc0201e2e:	e1e60613          	addi	a2,a2,-482 # ffffffffc0205c48 <default_pmm_manager+0x50>
ffffffffc0201e32:	0ef00593          	li	a1,239
ffffffffc0201e36:	00004517          	auipc	a0,0x4
ffffffffc0201e3a:	f0250513          	addi	a0,a0,-254 # ffffffffc0205d38 <default_pmm_manager+0x140>
...
ffffffffc0201e48:	e0460613          	addi	a2,a2,-508 # ffffffffc0205c48 <default_pmm_manager+0x50>
ffffffffc0201e4c:	0ec00593          	li	a1,236
ffffffffc0201e50:	00004517          	auipc	a0,0x4
ffffffffc0201e54:	ee850513          	addi	a0,a0,-280 # ffffffffc0205d38 <default_pmm_manager+0x140>
...
ffffffffc0201e62:	dea60613          	addi	a2,a2,-534 # ffffffffc0205c48 <default_pmm_manager+0x50>
ffffffffc0201e66:	0e100593          	li	a1,225
ffffffffc0201e6a:	00004517          	auipc	a0,0x4
ffffffffc0201e6e:	ece50513          	addi	a0,a0,-306 # ffffffffc0205d38 <default_pmm_manager+0x140>
...
ffffffffc020200e:	bee78793          	addi	a5,a5,-1042 # ffffffffc0205bf8 <default_pmm_manager>
...
ffffffffc020201a:	d4a50513          	addi	a0,a0,-694 # ffffffffc0205d60 <default_pmm_manager+0x168>
void pmm_init(void) {
...
ffffffffc0202064:	d1850513          	addi	a0,a0,-744 # ffffffffc0205d78 <default_pmm_manager+0x180>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0202088:	d0c50513          	addi	a0,a0,-756 # ffffffffc0205d90 <default_pmm_manager+0x198>
...
ffffffffc0202132:	c8a50513          	addi	a0,a0,-886 # ffffffffc0205db8 <default_pmm_manager+0x1c0>
...
ffffffffc020214c:	c8850513          	addi	a0,a0,-888 # ffffffffc0205dd0 <default_pmm_manager+0x1d8>
...
ffffffffc02023a2:	d4250513          	addi	a0,a0,-702 # ffffffffc02060e0 <default_pmm_manager+0x4e8>
...
ffffffffc020244e:	dce58593          	addi	a1,a1,-562 # ffffffffc0206218 <default_pmm_manager+0x620>
ffffffffc0202452:	10000513          	li	a0,256
ffffffffc0202456:	1b3020ef          	jal	ra,ffffffffc0204e08 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020245a:	100b0593          	addi	a1,s6,256
ffffffffc020245e:	10000513          	li	a0,256
ffffffffc0202462:	1b9020ef          	jal	ra,ffffffffc0204e1a <strcmp>
...
ffffffffc0202496:	10068023          	sb	zero,256(a3) # fffffffffffff100 <end+0x3fde9b08>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020249a:	12b020ef          	jal	ra,ffffffffc0204dc4 <strlen>
...
ffffffffc0202522:	d7250513          	addi	a0,a0,-654 # ffffffffc0206290 <default_pmm_manager+0x698>
...
ffffffffc020254c:	bb868693          	addi	a3,a3,-1096 # ffffffffc0206100 <default_pmm_manager+0x508>
ffffffffc0202550:	00003617          	auipc	a2,0x3
ffffffffc0202554:	31060613          	addi	a2,a2,784 # ffffffffc0205860 <commands+0x870>
ffffffffc0202558:	19d00593          	li	a1,413
ffffffffc020255c:	00003517          	auipc	a0,0x3
ffffffffc0202560:	7dc50513          	addi	a0,a0,2012 # ffffffffc0205d38 <default_pmm_manager+0x140>
...
ffffffffc020256e:	6de60613          	addi	a2,a2,1758 # ffffffffc0205c48 <default_pmm_manager+0x50>
ffffffffc0202572:	19d00593          	li	a1,413
ffffffffc0202576:	00003517          	auipc	a0,0x3
ffffffffc020257a:	7c250513          	addi	a0,a0,1986 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc020257e:	ed3fd0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(PTE_ADDR(*ptep) == i);
ffffffffc0202582:	00004697          	auipc	a3,0x4
ffffffffc0202586:	bbe68693          	addi	a3,a3,-1090 # ffffffffc0206140 <default_pmm_manager+0x548>
ffffffffc020258a:	00003617          	auipc	a2,0x3
ffffffffc020258e:	2d660613          	addi	a2,a2,726 # ffffffffc0205860 <commands+0x870>
ffffffffc0202592:	19e00593          	li	a1,414
ffffffffc0202596:	00003517          	auipc	a0,0x3
ffffffffc020259a:	7a250513          	addi	a0,a0,1954 # ffffffffc0205d38 <default_pmm_manager+0x140>
...
ffffffffc02025aa:	6a260613          	addi	a2,a2,1698 # ffffffffc0205c48 <default_pmm_manager+0x50>
ffffffffc02025ae:	06900593          	li	a1,105
ffffffffc02025b2:	00003517          	auipc	a0,0x3
ffffffffc02025b6:	6be50513          	addi	a0,a0,1726 # ffffffffc0205c70 <default_pmm_manager+0x78>
ffffffffc02025ba:	e97fd0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc02025be:	00004617          	auipc	a2,0x4
ffffffffc02025c2:	91260613          	addi	a2,a2,-1774 # ffffffffc0205ed0 <default_pmm_manager+0x2d8>
ffffffffc02025c6:	07400593          	li	a1,116
ffffffffc02025ca:	00003517          	auipc	a0,0x3
ffffffffc02025ce:	6a650513          	addi	a0,a0,1702 # ffffffffc0205c70 <default_pmm_manager+0x78>
ffffffffc02025d2:	e7ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc02025d6:	00004697          	auipc	a3,0x4
ffffffffc02025da:	83a68693          	addi	a3,a3,-1990 # ffffffffc0205e10 <default_pmm_manager+0x218>
ffffffffc02025de:	00003617          	auipc	a2,0x3
ffffffffc02025e2:	28260613          	addi	a2,a2,642 # ffffffffc0205860 <commands+0x870>
ffffffffc02025e6:	16100593          	li	a1,353
ffffffffc02025ea:	00003517          	auipc	a0,0x3
ffffffffc02025ee:	74e50513          	addi	a0,a0,1870 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc02025f2:	e5ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02025f6:	00004697          	auipc	a3,0x4
ffffffffc02025fa:	90268693          	addi	a3,a3,-1790 # ffffffffc0205ef8 <default_pmm_manager+0x300>
ffffffffc02025fe:	00003617          	auipc	a2,0x3
ffffffffc0202602:	26260613          	addi	a2,a2,610 # ffffffffc0205860 <commands+0x870>
ffffffffc0202606:	17d00593          	li	a1,381
ffffffffc020260a:	00003517          	auipc	a0,0x3
ffffffffc020260e:	72e50513          	addi	a0,a0,1838 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202612:	e3ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202616:	00004697          	auipc	a3,0x4
ffffffffc020261a:	b5a68693          	addi	a3,a3,-1190 # ffffffffc0206170 <default_pmm_manager+0x578>
ffffffffc020261e:	00003617          	auipc	a2,0x3
ffffffffc0202622:	24260613          	addi	a2,a2,578 # ffffffffc0205860 <commands+0x870>
ffffffffc0202626:	1a500593          	li	a1,421
ffffffffc020262a:	00003517          	auipc	a0,0x3
ffffffffc020262e:	70e50513          	addi	a0,a0,1806 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202632:	e1ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202636:	00004697          	auipc	a3,0x4
ffffffffc020263a:	95268693          	addi	a3,a3,-1710 # ffffffffc0205f88 <default_pmm_manager+0x390>
ffffffffc020263e:	00003617          	auipc	a2,0x3
ffffffffc0202642:	22260613          	addi	a2,a2,546 # ffffffffc0205860 <commands+0x870>
ffffffffc0202646:	17c00593          	li	a1,380
ffffffffc020264a:	00003517          	auipc	a0,0x3
ffffffffc020264e:	6ee50513          	addi	a0,a0,1774 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202652:	dfffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202656:	00004697          	auipc	a3,0x4
ffffffffc020265a:	9fa68693          	addi	a3,a3,-1542 # ffffffffc0206050 <default_pmm_manager+0x458>
ffffffffc020265e:	00003617          	auipc	a2,0x3
ffffffffc0202662:	20260613          	addi	a2,a2,514 # ffffffffc0205860 <commands+0x870>
ffffffffc0202666:	17b00593          	li	a1,379
ffffffffc020266a:	00003517          	auipc	a0,0x3
ffffffffc020266e:	6ce50513          	addi	a0,a0,1742 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202672:	ddffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0202676:	00004697          	auipc	a3,0x4
ffffffffc020267a:	9c268693          	addi	a3,a3,-1598 # ffffffffc0206038 <default_pmm_manager+0x440>
ffffffffc020267e:	00003617          	auipc	a2,0x3
ffffffffc0202682:	1e260613          	addi	a2,a2,482 # ffffffffc0205860 <commands+0x870>
ffffffffc0202686:	17a00593          	li	a1,378
ffffffffc020268a:	00003517          	auipc	a0,0x3
ffffffffc020268e:	6ae50513          	addi	a0,a0,1710 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202692:	dbffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc0202696:	00004697          	auipc	a3,0x4
ffffffffc020269a:	97268693          	addi	a3,a3,-1678 # ffffffffc0206008 <default_pmm_manager+0x410>
ffffffffc020269e:	00003617          	auipc	a2,0x3
ffffffffc02026a2:	1c260613          	addi	a2,a2,450 # ffffffffc0205860 <commands+0x870>
ffffffffc02026a6:	17900593          	li	a1,377
ffffffffc02026aa:	00003517          	auipc	a0,0x3
ffffffffc02026ae:	68e50513          	addi	a0,a0,1678 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc02026b2:	d9ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02026b6:	00004697          	auipc	a3,0x4
ffffffffc02026ba:	93a68693          	addi	a3,a3,-1734 # ffffffffc0205ff0 <default_pmm_manager+0x3f8>
ffffffffc02026be:	00003617          	auipc	a2,0x3
ffffffffc02026c2:	1a260613          	addi	a2,a2,418 # ffffffffc0205860 <commands+0x870>
ffffffffc02026c6:	17700593          	li	a1,375
ffffffffc02026ca:	00003517          	auipc	a0,0x3
ffffffffc02026ce:	66e50513          	addi	a0,a0,1646 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc02026d2:	d7ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02026d6:	00004697          	auipc	a3,0x4
ffffffffc02026da:	90268693          	addi	a3,a3,-1790 # ffffffffc0205fd8 <default_pmm_manager+0x3e0>
ffffffffc02026de:	00003617          	auipc	a2,0x3
ffffffffc02026e2:	18260613          	addi	a2,a2,386 # ffffffffc0205860 <commands+0x870>
ffffffffc02026e6:	17600593          	li	a1,374
ffffffffc02026ea:	00003517          	auipc	a0,0x3
ffffffffc02026ee:	64e50513          	addi	a0,a0,1614 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc02026f2:	d5ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02026f6:	00004697          	auipc	a3,0x4
ffffffffc02026fa:	8d268693          	addi	a3,a3,-1838 # ffffffffc0205fc8 <default_pmm_manager+0x3d0>
ffffffffc02026fe:	00003617          	auipc	a2,0x3
ffffffffc0202702:	16260613          	addi	a2,a2,354 # ffffffffc0205860 <commands+0x870>
ffffffffc0202706:	17500593          	li	a1,373
ffffffffc020270a:	00003517          	auipc	a0,0x3
ffffffffc020270e:	62e50513          	addi	a0,a0,1582 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202712:	d3ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(*ptep & PTE_U);
ffffffffc0202716:	00004697          	auipc	a3,0x4
ffffffffc020271a:	8a268693          	addi	a3,a3,-1886 # ffffffffc0205fb8 <default_pmm_manager+0x3c0>
ffffffffc020271e:	00003617          	auipc	a2,0x3
ffffffffc0202722:	14260613          	addi	a2,a2,322 # ffffffffc0205860 <commands+0x870>
ffffffffc0202726:	17400593          	li	a1,372
ffffffffc020272a:	00003517          	auipc	a0,0x3
ffffffffc020272e:	60e50513          	addi	a0,a0,1550 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202732:	d1ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202736:	00004697          	auipc	a3,0x4
ffffffffc020273a:	85268693          	addi	a3,a3,-1966 # ffffffffc0205f88 <default_pmm_manager+0x390>
ffffffffc020273e:	00003617          	auipc	a2,0x3
ffffffffc0202742:	12260613          	addi	a2,a2,290 # ffffffffc0205860 <commands+0x870>
ffffffffc0202746:	17300593          	li	a1,371
ffffffffc020274a:	00003517          	auipc	a0,0x3
ffffffffc020274e:	5ee50513          	addi	a0,a0,1518 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202752:	cfffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0202756:	00003697          	auipc	a3,0x3
ffffffffc020275a:	7fa68693          	addi	a3,a3,2042 # ffffffffc0205f50 <default_pmm_manager+0x358>
ffffffffc020275e:	00003617          	auipc	a2,0x3
ffffffffc0202762:	10260613          	addi	a2,a2,258 # ffffffffc0205860 <commands+0x870>
ffffffffc0202766:	17200593          	li	a1,370
ffffffffc020276a:	00003517          	auipc	a0,0x3
ffffffffc020276e:	5ce50513          	addi	a0,a0,1486 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202772:	cdffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202776:	00003697          	auipc	a3,0x3
ffffffffc020277a:	7b268693          	addi	a3,a3,1970 # ffffffffc0205f28 <default_pmm_manager+0x330>
ffffffffc020277e:	00003617          	auipc	a2,0x3
ffffffffc0202782:	0e260613          	addi	a2,a2,226 # ffffffffc0205860 <commands+0x870>
ffffffffc0202786:	16f00593          	li	a1,367
ffffffffc020278a:	00003517          	auipc	a0,0x3
ffffffffc020278e:	5ae50513          	addi	a0,a0,1454 # ffffffffc0205d38 <default_pmm_manager+0x140>
...
ffffffffc020279c:	4b060613          	addi	a2,a2,1200 # ffffffffc0205c48 <default_pmm_manager+0x50>
ffffffffc02027a0:	16e00593          	li	a1,366
ffffffffc02027a4:	00003517          	auipc	a0,0x3
ffffffffc02027a8:	59450513          	addi	a0,a0,1428 # ffffffffc0205d38 <default_pmm_manager+0x140>
...
ffffffffc02027b6:	49660613          	addi	a2,a2,1174 # ffffffffc0205c48 <default_pmm_manager+0x50>
ffffffffc02027ba:	06900593          	li	a1,105
ffffffffc02027be:	00003517          	auipc	a0,0x3
ffffffffc02027c2:	4b250513          	addi	a0,a0,1202 # ffffffffc0205c70 <default_pmm_manager+0x78>
ffffffffc02027c6:	c8bfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02027ca:	00004697          	auipc	a3,0x4
ffffffffc02027ce:	8ce68693          	addi	a3,a3,-1842 # ffffffffc0206098 <default_pmm_manager+0x4a0>
ffffffffc02027d2:	00003617          	auipc	a2,0x3
ffffffffc02027d6:	08e60613          	addi	a2,a2,142 # ffffffffc0205860 <commands+0x870>
ffffffffc02027da:	18800593          	li	a1,392
ffffffffc02027de:	00003517          	auipc	a0,0x3
ffffffffc02027e2:	55a50513          	addi	a0,a0,1370 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc02027e6:	c6bfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02027ea:	00004697          	auipc	a3,0x4
ffffffffc02027ee:	86668693          	addi	a3,a3,-1946 # ffffffffc0206050 <default_pmm_manager+0x458>
ffffffffc02027f2:	00003617          	auipc	a2,0x3
ffffffffc02027f6:	06e60613          	addi	a2,a2,110 # ffffffffc0205860 <commands+0x870>
ffffffffc02027fa:	18600593          	li	a1,390
ffffffffc02027fe:	00003517          	auipc	a0,0x3
ffffffffc0202802:	53a50513          	addi	a0,a0,1338 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202806:	c4bfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc020280a:	00004697          	auipc	a3,0x4
ffffffffc020280e:	87668693          	addi	a3,a3,-1930 # ffffffffc0206080 <default_pmm_manager+0x488>
ffffffffc0202812:	00003617          	auipc	a2,0x3
ffffffffc0202816:	04e60613          	addi	a2,a2,78 # ffffffffc0205860 <commands+0x870>
ffffffffc020281a:	18500593          	li	a1,389
ffffffffc020281e:	00003517          	auipc	a0,0x3
ffffffffc0202822:	51a50513          	addi	a0,a0,1306 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202826:	c2bfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p) == 2);
ffffffffc020282a:	00004697          	auipc	a3,0x4
ffffffffc020282e:	9d668693          	addi	a3,a3,-1578 # ffffffffc0206200 <default_pmm_manager+0x608>
ffffffffc0202832:	00003617          	auipc	a2,0x3
ffffffffc0202836:	02e60613          	addi	a2,a2,46 # ffffffffc0205860 <commands+0x870>
ffffffffc020283a:	1a800593          	li	a1,424
ffffffffc020283e:	00003517          	auipc	a0,0x3
ffffffffc0202842:	4fa50513          	addi	a0,a0,1274 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202846:	c0bfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc020284a:	00004697          	auipc	a3,0x4
ffffffffc020284e:	97668693          	addi	a3,a3,-1674 # ffffffffc02061c0 <default_pmm_manager+0x5c8>
ffffffffc0202852:	00003617          	auipc	a2,0x3
ffffffffc0202856:	00e60613          	addi	a2,a2,14 # ffffffffc0205860 <commands+0x870>
ffffffffc020285a:	1a700593          	li	a1,423
ffffffffc020285e:	00003517          	auipc	a0,0x3
ffffffffc0202862:	4da50513          	addi	a0,a0,1242 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202866:	bebfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p) == 1);
ffffffffc020286a:	00004697          	auipc	a3,0x4
ffffffffc020286e:	93e68693          	addi	a3,a3,-1730 # ffffffffc02061a8 <default_pmm_manager+0x5b0>
ffffffffc0202872:	00003617          	auipc	a2,0x3
ffffffffc0202876:	fee60613          	addi	a2,a2,-18 # ffffffffc0205860 <commands+0x870>
ffffffffc020287a:	1a600593          	li	a1,422
ffffffffc020287e:	00003517          	auipc	a0,0x3
ffffffffc0202882:	4ba50513          	addi	a0,a0,1210 # ffffffffc0205d38 <default_pmm_manager+0x140>
...
ffffffffc0202890:	3bc60613          	addi	a2,a2,956 # ffffffffc0205c48 <default_pmm_manager+0x50>
ffffffffc0202894:	16d00593          	li	a1,365
ffffffffc0202898:	00003517          	auipc	a0,0x3
ffffffffc020289c:	4a050513          	addi	a0,a0,1184 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc02028a0:	bb1fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc02028a4:	00003617          	auipc	a2,0x3
ffffffffc02028a8:	3dc60613          	addi	a2,a2,988 # ffffffffc0205c80 <default_pmm_manager+0x88>
ffffffffc02028ac:	07f00593          	li	a1,127
ffffffffc02028b0:	00003517          	auipc	a0,0x3
ffffffffc02028b4:	48850513          	addi	a0,a0,1160 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc02028b8:	b99fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02028bc:	00004697          	auipc	a3,0x4
ffffffffc02028c0:	97468693          	addi	a3,a3,-1676 # ffffffffc0206230 <default_pmm_manager+0x638>
ffffffffc02028c4:	00003617          	auipc	a2,0x3
ffffffffc02028c8:	f9c60613          	addi	a2,a2,-100 # ffffffffc0205860 <commands+0x870>
ffffffffc02028cc:	1ac00593          	li	a1,428
ffffffffc02028d0:	00003517          	auipc	a0,0x3
ffffffffc02028d4:	46850513          	addi	a0,a0,1128 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc02028d8:	b79fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02028dc:	00003697          	auipc	a3,0x3
ffffffffc02028e0:	7e468693          	addi	a3,a3,2020 # ffffffffc02060c0 <default_pmm_manager+0x4c8>
ffffffffc02028e4:	00003617          	auipc	a2,0x3
ffffffffc02028e8:	f7c60613          	addi	a2,a2,-132 # ffffffffc0205860 <commands+0x870>
ffffffffc02028ec:	1b800593          	li	a1,440
ffffffffc02028f0:	00003517          	auipc	a0,0x3
ffffffffc02028f4:	44850513          	addi	a0,a0,1096 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc02028f8:	b59fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02028fc:	00003697          	auipc	a3,0x3
ffffffffc0202900:	61468693          	addi	a3,a3,1556 # ffffffffc0205f10 <default_pmm_manager+0x318>
ffffffffc0202904:	00003617          	auipc	a2,0x3
ffffffffc0202908:	f5c60613          	addi	a2,a2,-164 # ffffffffc0205860 <commands+0x870>
ffffffffc020290c:	16b00593          	li	a1,363
ffffffffc0202910:	00003517          	auipc	a0,0x3
ffffffffc0202914:	42850513          	addi	a0,a0,1064 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202918:	b39fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020291c:	00003697          	auipc	a3,0x3
ffffffffc0202920:	5dc68693          	addi	a3,a3,1500 # ffffffffc0205ef8 <default_pmm_manager+0x300>
ffffffffc0202924:	00003617          	auipc	a2,0x3
ffffffffc0202928:	f3c60613          	addi	a2,a2,-196 # ffffffffc0205860 <commands+0x870>
ffffffffc020292c:	16a00593          	li	a1,362
ffffffffc0202930:	00003517          	auipc	a0,0x3
ffffffffc0202934:	40850513          	addi	a0,a0,1032 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202938:	b19fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc020293c:	00003697          	auipc	a3,0x3
ffffffffc0202940:	50c68693          	addi	a3,a3,1292 # ffffffffc0205e48 <default_pmm_manager+0x250>
ffffffffc0202944:	00003617          	auipc	a2,0x3
ffffffffc0202948:	f1c60613          	addi	a2,a2,-228 # ffffffffc0205860 <commands+0x870>
ffffffffc020294c:	16200593          	li	a1,354
ffffffffc0202950:	00003517          	auipc	a0,0x3
ffffffffc0202954:	3e850513          	addi	a0,a0,1000 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202958:	af9fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((ptep = get_pte(boot_pgdir, 0x0, 0)) != NULL);
ffffffffc020295c:	00003697          	auipc	a3,0x3
ffffffffc0202960:	54468693          	addi	a3,a3,1348 # ffffffffc0205ea0 <default_pmm_manager+0x2a8>
ffffffffc0202964:	00003617          	auipc	a2,0x3
ffffffffc0202968:	efc60613          	addi	a2,a2,-260 # ffffffffc0205860 <commands+0x870>
ffffffffc020296c:	16900593          	li	a1,361
ffffffffc0202970:	00003517          	auipc	a0,0x3
ffffffffc0202974:	3c850513          	addi	a0,a0,968 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202978:	ad9fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc020297c:	00003697          	auipc	a3,0x3
ffffffffc0202980:	4f468693          	addi	a3,a3,1268 # ffffffffc0205e70 <default_pmm_manager+0x278>
ffffffffc0202984:	00003617          	auipc	a2,0x3
ffffffffc0202988:	edc60613          	addi	a2,a2,-292 # ffffffffc0205860 <commands+0x870>
ffffffffc020298c:	16600593          	li	a1,358
ffffffffc0202990:	00003517          	auipc	a0,0x3
ffffffffc0202994:	3a850513          	addi	a0,a0,936 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202998:	ab9fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020299c:	00003697          	auipc	a3,0x3
ffffffffc02029a0:	6b468693          	addi	a3,a3,1716 # ffffffffc0206050 <default_pmm_manager+0x458>
ffffffffc02029a4:	00003617          	auipc	a2,0x3
ffffffffc02029a8:	ebc60613          	addi	a2,a2,-324 # ffffffffc0205860 <commands+0x870>
ffffffffc02029ac:	18200593          	li	a1,386
ffffffffc02029b0:	00003517          	auipc	a0,0x3
ffffffffc02029b4:	38850513          	addi	a0,a0,904 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc02029b8:	a99fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02029bc:	00003697          	auipc	a3,0x3
ffffffffc02029c0:	55468693          	addi	a3,a3,1364 # ffffffffc0205f10 <default_pmm_manager+0x318>
ffffffffc02029c4:	00003617          	auipc	a2,0x3
ffffffffc02029c8:	e9c60613          	addi	a2,a2,-356 # ffffffffc0205860 <commands+0x870>
ffffffffc02029cc:	18100593          	li	a1,385
ffffffffc02029d0:	00003517          	auipc	a0,0x3
ffffffffc02029d4:	36850513          	addi	a0,a0,872 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc02029d8:	a79fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc02029dc:	00003697          	auipc	a3,0x3
ffffffffc02029e0:	68c68693          	addi	a3,a3,1676 # ffffffffc0206068 <default_pmm_manager+0x470>
ffffffffc02029e4:	00003617          	auipc	a2,0x3
ffffffffc02029e8:	e7c60613          	addi	a2,a2,-388 # ffffffffc0205860 <commands+0x870>
ffffffffc02029ec:	17e00593          	li	a1,382
ffffffffc02029f0:	00003517          	auipc	a0,0x3
ffffffffc02029f4:	34850513          	addi	a0,a0,840 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc02029f8:	a59fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc02029fc:	00004697          	auipc	a3,0x4
ffffffffc0202a00:	86c68693          	addi	a3,a3,-1940 # ffffffffc0206268 <default_pmm_manager+0x670>
ffffffffc0202a04:	00003617          	auipc	a2,0x3
ffffffffc0202a08:	e5c60613          	addi	a2,a2,-420 # ffffffffc0205860 <commands+0x870>
ffffffffc0202a0c:	1af00593          	li	a1,431
ffffffffc0202a10:	00003517          	auipc	a0,0x3
ffffffffc0202a14:	32850513          	addi	a0,a0,808 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202a18:	a39fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202a1c:	00003697          	auipc	a3,0x3
ffffffffc0202a20:	6a468693          	addi	a3,a3,1700 # ffffffffc02060c0 <default_pmm_manager+0x4c8>
ffffffffc0202a24:	00003617          	auipc	a2,0x3
ffffffffc0202a28:	e3c60613          	addi	a2,a2,-452 # ffffffffc0205860 <commands+0x870>
ffffffffc0202a2c:	19000593          	li	a1,400
ffffffffc0202a30:	00003517          	auipc	a0,0x3
ffffffffc0202a34:	30850513          	addi	a0,a0,776 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202a38:	a19fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202a3c:	00003697          	auipc	a3,0x3
ffffffffc0202a40:	71c68693          	addi	a3,a3,1820 # ffffffffc0206158 <default_pmm_manager+0x560>
ffffffffc0202a44:	00003617          	auipc	a2,0x3
ffffffffc0202a48:	e1c60613          	addi	a2,a2,-484 # ffffffffc0205860 <commands+0x870>
ffffffffc0202a4c:	1a100593          	li	a1,417
ffffffffc0202a50:	00003517          	auipc	a0,0x3
ffffffffc0202a54:	2e850513          	addi	a0,a0,744 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202a58:	9f9fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc0202a5c:	00003697          	auipc	a3,0x3
ffffffffc0202a60:	39468693          	addi	a3,a3,916 # ffffffffc0205df0 <default_pmm_manager+0x1f8>
ffffffffc0202a64:	00003617          	auipc	a2,0x3
ffffffffc0202a68:	dfc60613          	addi	a2,a2,-516 # ffffffffc0205860 <commands+0x870>
ffffffffc0202a6c:	16000593          	li	a1,352
ffffffffc0202a70:	00003517          	auipc	a0,0x3
ffffffffc0202a74:	2c850513          	addi	a0,a0,712 # ffffffffc0205d38 <default_pmm_manager+0x140>
ffffffffc0202a78:	9d9fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202a7c:	00003617          	auipc	a2,0x3
ffffffffc0202a80:	20460613          	addi	a2,a2,516 # ffffffffc0205c80 <default_pmm_manager+0x88>
ffffffffc0202a84:	0c300593          	li	a1,195
ffffffffc0202a88:	00003517          	auipc	a0,0x3
ffffffffc0202a8c:	2b050513          	addi	a0,a0,688 # ffffffffc0205d38 <default_pmm_manager+0x140>
...
ffffffffc0202b04:	24868693          	addi	a3,a3,584 # ffffffffc0205d48 <default_pmm_manager+0x150>
ffffffffc0202b08:	00003617          	auipc	a2,0x3
ffffffffc0202b0c:	d5860613          	addi	a2,a2,-680 # ffffffffc0205860 <commands+0x870>
ffffffffc0202b10:	14800593          	li	a1,328
ffffffffc0202b14:	00003517          	auipc	a0,0x3
ffffffffc0202b18:	22450513          	addi	a0,a0,548 # ffffffffc0205d38 <default_pmm_manager+0x140>
...
ffffffffc0202baa:	78a50513          	addi	a0,a0,1930 # ffffffffc0206330 <default_pmm_manager+0x738>
    return listelm->next;
...
ffffffffc0202c08:	74450513          	addi	a0,a0,1860 # ffffffffc0206348 <default_pmm_manager+0x750>
...
ffffffffc0202c62:	75a50513          	addi	a0,a0,1882 # ffffffffc02063b8 <default_pmm_manager+0x7c0>
...
ffffffffc0202c7e:	78e50513          	addi	a0,a0,1934 # ffffffffc0206408 <default_pmm_manager+0x810>
...
ffffffffc0202cfe:	79650513          	addi	a0,a0,1942 # ffffffffc0206490 <default_pmm_manager+0x898>
...
ffffffffc0202dd6:	1ced8d93          	addi	s11,s11,462 # ffffffffc0206fa0 <nbase>
...
ffffffffc0202e3e:	6fe50513          	addi	a0,a0,1790 # ffffffffc0206538 <default_pmm_manager+0x940>
...
ffffffffc0202f2e:	65e50513          	addi	a0,a0,1630 # ffffffffc0206588 <default_pmm_manager+0x990>
...
ffffffffc0202f44:	91068693          	addi	a3,a3,-1776 # ffffffffc0205850 <commands+0x860>
ffffffffc0202f48:	00003617          	auipc	a2,0x3
ffffffffc0202f4c:	91860613          	addi	a2,a2,-1768 # ffffffffc0205860 <commands+0x870>
ffffffffc0202f50:	0bd00593          	li	a1,189
ffffffffc0202f54:	00003517          	auipc	a0,0x3
ffffffffc0202f58:	3cc50513          	addi	a0,a0,972 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc0202f5c:	cf4fd0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202f60:	00003617          	auipc	a2,0x3
ffffffffc0202f64:	d4860613          	addi	a2,a2,-696 # ffffffffc0205ca8 <default_pmm_manager+0xb0>
ffffffffc0202f68:	06200593          	li	a1,98
ffffffffc0202f6c:	00003517          	auipc	a0,0x3
ffffffffc0202f70:	d0450513          	addi	a0,a0,-764 # ffffffffc0205c70 <default_pmm_manager+0x78>
ffffffffc0202f74:	cdcfd0ef          	jal	ra,ffffffffc0200450 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202f78:	00003697          	auipc	a3,0x3
ffffffffc0202f7c:	59868693          	addi	a3,a3,1432 # ffffffffc0206510 <default_pmm_manager+0x918>
ffffffffc0202f80:	00003617          	auipc	a2,0x3
ffffffffc0202f84:	8e060613          	addi	a2,a2,-1824 # ffffffffc0205860 <commands+0x870>
ffffffffc0202f88:	0fd00593          	li	a1,253
ffffffffc0202f8c:	00003517          	auipc	a0,0x3
ffffffffc0202f90:	39450513          	addi	a0,a0,916 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc0202f94:	cbcfd0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202f98:	00003617          	auipc	a2,0x3
ffffffffc0202f9c:	f3860613          	addi	a2,a2,-200 # ffffffffc0205ed0 <default_pmm_manager+0x2d8>
ffffffffc0202fa0:	07400593          	li	a1,116
ffffffffc0202fa4:	00003517          	auipc	a0,0x3
ffffffffc0202fa8:	ccc50513          	addi	a0,a0,-820 # ffffffffc0205c70 <default_pmm_manager+0x78>
ffffffffc0202fac:	ca4fd0ef          	jal	ra,ffffffffc0200450 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202fb0:	00003697          	auipc	a3,0x3
ffffffffc0202fb4:	49868693          	addi	a3,a3,1176 # ffffffffc0206448 <default_pmm_manager+0x850>
ffffffffc0202fb8:	00003617          	auipc	a2,0x3
ffffffffc0202fbc:	8a860613          	addi	a2,a2,-1880 # ffffffffc0205860 <commands+0x870>
ffffffffc0202fc0:	0de00593          	li	a1,222
ffffffffc0202fc4:	00003517          	auipc	a0,0x3
ffffffffc0202fc8:	35c50513          	addi	a0,a0,860 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc0202fcc:	c84fd0ef          	jal	ra,ffffffffc0200450 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202fd0:	00003697          	auipc	a3,0x3
ffffffffc0202fd4:	46068693          	addi	a3,a3,1120 # ffffffffc0206430 <default_pmm_manager+0x838>
ffffffffc0202fd8:	00003617          	auipc	a2,0x3
ffffffffc0202fdc:	88860613          	addi	a2,a2,-1912 # ffffffffc0205860 <commands+0x870>
ffffffffc0202fe0:	0dd00593          	li	a1,221
ffffffffc0202fe4:	00003517          	auipc	a0,0x3
ffffffffc0202fe8:	33c50513          	addi	a0,a0,828 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc0202fec:	c64fd0ef          	jal	ra,ffffffffc0200450 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202ff0:	00003697          	auipc	a3,0x3
ffffffffc0202ff4:	50868693          	addi	a3,a3,1288 # ffffffffc02064f8 <default_pmm_manager+0x900>
ffffffffc0202ff8:	00003617          	auipc	a2,0x3
ffffffffc0202ffc:	86860613          	addi	a2,a2,-1944 # ffffffffc0205860 <commands+0x870>
ffffffffc0203000:	0fc00593          	li	a1,252
ffffffffc0203004:	00003517          	auipc	a0,0x3
ffffffffc0203008:	31c50513          	addi	a0,a0,796 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc020300c:	c44fd0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0203010:	00003617          	auipc	a2,0x3
ffffffffc0203014:	2f060613          	addi	a2,a2,752 # ffffffffc0206300 <default_pmm_manager+0x708>
ffffffffc0203018:	02a00593          	li	a1,42
ffffffffc020301c:	00003517          	auipc	a0,0x3
ffffffffc0203020:	30450513          	addi	a0,a0,772 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc0203024:	c2cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==2);
ffffffffc0203028:	00003697          	auipc	a3,0x3
ffffffffc020302c:	4a068693          	addi	a3,a3,1184 # ffffffffc02064c8 <default_pmm_manager+0x8d0>
ffffffffc0203030:	00003617          	auipc	a2,0x3
ffffffffc0203034:	83060613          	addi	a2,a2,-2000 # ffffffffc0205860 <commands+0x870>
ffffffffc0203038:	09800593          	li	a1,152
ffffffffc020303c:	00003517          	auipc	a0,0x3
ffffffffc0203040:	2e450513          	addi	a0,a0,740 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc0203044:	c0cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==2);
ffffffffc0203048:	00003697          	auipc	a3,0x3
ffffffffc020304c:	48068693          	addi	a3,a3,1152 # ffffffffc02064c8 <default_pmm_manager+0x8d0>
ffffffffc0203050:	00003617          	auipc	a2,0x3
ffffffffc0203054:	81060613          	addi	a2,a2,-2032 # ffffffffc0205860 <commands+0x870>
ffffffffc0203058:	09a00593          	li	a1,154
ffffffffc020305c:	00003517          	auipc	a0,0x3
ffffffffc0203060:	2c450513          	addi	a0,a0,708 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc0203064:	becfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==3);
ffffffffc0203068:	00003697          	auipc	a3,0x3
ffffffffc020306c:	47068693          	addi	a3,a3,1136 # ffffffffc02064d8 <default_pmm_manager+0x8e0>
ffffffffc0203070:	00002617          	auipc	a2,0x2
ffffffffc0203074:	7f060613          	addi	a2,a2,2032 # ffffffffc0205860 <commands+0x870>
ffffffffc0203078:	09c00593          	li	a1,156
ffffffffc020307c:	00003517          	auipc	a0,0x3
ffffffffc0203080:	2a450513          	addi	a0,a0,676 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc0203084:	bccfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==3);
ffffffffc0203088:	00003697          	auipc	a3,0x3
ffffffffc020308c:	45068693          	addi	a3,a3,1104 # ffffffffc02064d8 <default_pmm_manager+0x8e0>
ffffffffc0203090:	00002617          	auipc	a2,0x2
ffffffffc0203094:	7d060613          	addi	a2,a2,2000 # ffffffffc0205860 <commands+0x870>
ffffffffc0203098:	09e00593          	li	a1,158
ffffffffc020309c:	00003517          	auipc	a0,0x3
ffffffffc02030a0:	28450513          	addi	a0,a0,644 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc02030a4:	bacfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==1);
ffffffffc02030a8:	00003697          	auipc	a3,0x3
ffffffffc02030ac:	41068693          	addi	a3,a3,1040 # ffffffffc02064b8 <default_pmm_manager+0x8c0>
ffffffffc02030b0:	00002617          	auipc	a2,0x2
ffffffffc02030b4:	7b060613          	addi	a2,a2,1968 # ffffffffc0205860 <commands+0x870>
ffffffffc02030b8:	09400593          	li	a1,148
ffffffffc02030bc:	00003517          	auipc	a0,0x3
ffffffffc02030c0:	26450513          	addi	a0,a0,612 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc02030c4:	b8cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==1);
ffffffffc02030c8:	00003697          	auipc	a3,0x3
ffffffffc02030cc:	3f068693          	addi	a3,a3,1008 # ffffffffc02064b8 <default_pmm_manager+0x8c0>
ffffffffc02030d0:	00002617          	auipc	a2,0x2
ffffffffc02030d4:	79060613          	addi	a2,a2,1936 # ffffffffc0205860 <commands+0x870>
ffffffffc02030d8:	09600593          	li	a1,150
ffffffffc02030dc:	00003517          	auipc	a0,0x3
ffffffffc02030e0:	24450513          	addi	a0,a0,580 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc02030e4:	b6cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==4);
ffffffffc02030e8:	00003697          	auipc	a3,0x3
ffffffffc02030ec:	40068693          	addi	a3,a3,1024 # ffffffffc02064e8 <default_pmm_manager+0x8f0>
ffffffffc02030f0:	00002617          	auipc	a2,0x2
ffffffffc02030f4:	77060613          	addi	a2,a2,1904 # ffffffffc0205860 <commands+0x870>
ffffffffc02030f8:	0a000593          	li	a1,160
ffffffffc02030fc:	00003517          	auipc	a0,0x3
ffffffffc0203100:	22450513          	addi	a0,a0,548 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc0203104:	b4cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==4);
ffffffffc0203108:	00003697          	auipc	a3,0x3
ffffffffc020310c:	3e068693          	addi	a3,a3,992 # ffffffffc02064e8 <default_pmm_manager+0x8f0>
ffffffffc0203110:	00002617          	auipc	a2,0x2
ffffffffc0203114:	75060613          	addi	a2,a2,1872 # ffffffffc0205860 <commands+0x870>
ffffffffc0203118:	0a200593          	li	a1,162
ffffffffc020311c:	00003517          	auipc	a0,0x3
ffffffffc0203120:	20450513          	addi	a0,a0,516 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc0203124:	b2cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203128:	00003697          	auipc	a3,0x3
ffffffffc020312c:	27068693          	addi	a3,a3,624 # ffffffffc0206398 <default_pmm_manager+0x7a0>
ffffffffc0203130:	00002617          	auipc	a2,0x2
ffffffffc0203134:	73060613          	addi	a2,a2,1840 # ffffffffc0205860 <commands+0x870>
ffffffffc0203138:	0cd00593          	li	a1,205
ffffffffc020313c:	00003517          	auipc	a0,0x3
ffffffffc0203140:	1e450513          	addi	a0,a0,484 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc0203144:	b0cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(vma != NULL);
ffffffffc0203148:	00003697          	auipc	a3,0x3
ffffffffc020314c:	26068693          	addi	a3,a3,608 # ffffffffc02063a8 <default_pmm_manager+0x7b0>
ffffffffc0203150:	00002617          	auipc	a2,0x2
ffffffffc0203154:	71060613          	addi	a2,a2,1808 # ffffffffc0205860 <commands+0x870>
ffffffffc0203158:	0d000593          	li	a1,208
ffffffffc020315c:	00003517          	auipc	a0,0x3
ffffffffc0203160:	1c450513          	addi	a0,a0,452 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc0203164:	aecfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0203168:	00003697          	auipc	a3,0x3
ffffffffc020316c:	28868693          	addi	a3,a3,648 # ffffffffc02063f0 <default_pmm_manager+0x7f8>
ffffffffc0203170:	00002617          	auipc	a2,0x2
ffffffffc0203174:	6f060613          	addi	a2,a2,1776 # ffffffffc0205860 <commands+0x870>
ffffffffc0203178:	0d800593          	li	a1,216
ffffffffc020317c:	00003517          	auipc	a0,0x3
ffffffffc0203180:	1a450513          	addi	a0,a0,420 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc0203184:	accfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert( nr_free == 0);         
ffffffffc0203188:	00003697          	auipc	a3,0x3
ffffffffc020318c:	8b068693          	addi	a3,a3,-1872 # ffffffffc0205a38 <commands+0xa48>
ffffffffc0203190:	00002617          	auipc	a2,0x2
ffffffffc0203194:	6d060613          	addi	a2,a2,1744 # ffffffffc0205860 <commands+0x870>
ffffffffc0203198:	0f400593          	li	a1,244
ffffffffc020319c:	00003517          	auipc	a0,0x3
ffffffffc02031a0:	18450513          	addi	a0,a0,388 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc02031a4:	aacfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    return KADDR(page2pa(page));
ffffffffc02031a8:	00003617          	auipc	a2,0x3
ffffffffc02031ac:	aa060613          	addi	a2,a2,-1376 # ffffffffc0205c48 <default_pmm_manager+0x50>
ffffffffc02031b0:	06900593          	li	a1,105
ffffffffc02031b4:	00003517          	auipc	a0,0x3
ffffffffc02031b8:	abc50513          	addi	a0,a0,-1348 # ffffffffc0205c70 <default_pmm_manager+0x78>
ffffffffc02031bc:	a94fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(count==0);
ffffffffc02031c0:	00003697          	auipc	a3,0x3
ffffffffc02031c4:	3a868693          	addi	a3,a3,936 # ffffffffc0206568 <default_pmm_manager+0x970>
ffffffffc02031c8:	00002617          	auipc	a2,0x2
ffffffffc02031cc:	69860613          	addi	a2,a2,1688 # ffffffffc0205860 <commands+0x870>
ffffffffc02031d0:	11c00593          	li	a1,284
ffffffffc02031d4:	00003517          	auipc	a0,0x3
ffffffffc02031d8:	14c50513          	addi	a0,a0,332 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc02031dc:	a74fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(total==0);
ffffffffc02031e0:	00003697          	auipc	a3,0x3
ffffffffc02031e4:	39868693          	addi	a3,a3,920 # ffffffffc0206578 <default_pmm_manager+0x980>
ffffffffc02031e8:	00002617          	auipc	a2,0x2
ffffffffc02031ec:	67860613          	addi	a2,a2,1656 # ffffffffc0205860 <commands+0x870>
ffffffffc02031f0:	11d00593          	li	a1,285
ffffffffc02031f4:	00003517          	auipc	a0,0x3
ffffffffc02031f8:	12c50513          	addi	a0,a0,300 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc02031fc:	a54fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0203200:	00003697          	auipc	a3,0x3
ffffffffc0203204:	26868693          	addi	a3,a3,616 # ffffffffc0206468 <default_pmm_manager+0x870>
ffffffffc0203208:	00002617          	auipc	a2,0x2
ffffffffc020320c:	65860613          	addi	a2,a2,1624 # ffffffffc0205860 <commands+0x870>
ffffffffc0203210:	0eb00593          	li	a1,235
ffffffffc0203214:	00003517          	auipc	a0,0x3
ffffffffc0203218:	10c50513          	addi	a0,a0,268 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc020321c:	a34fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(mm != NULL);
ffffffffc0203220:	00003697          	auipc	a3,0x3
ffffffffc0203224:	15068693          	addi	a3,a3,336 # ffffffffc0206370 <default_pmm_manager+0x778>
ffffffffc0203228:	00002617          	auipc	a2,0x2
ffffffffc020322c:	63860613          	addi	a2,a2,1592 # ffffffffc0205860 <commands+0x870>
ffffffffc0203230:	0c500593          	li	a1,197
ffffffffc0203234:	00003517          	auipc	a0,0x3
ffffffffc0203238:	0ec50513          	addi	a0,a0,236 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc020323c:	a14fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203240:	00003697          	auipc	a3,0x3
ffffffffc0203244:	14068693          	addi	a3,a3,320 # ffffffffc0206380 <default_pmm_manager+0x788>
ffffffffc0203248:	00002617          	auipc	a2,0x2
ffffffffc020324c:	61860613          	addi	a2,a2,1560 # ffffffffc0205860 <commands+0x870>
ffffffffc0203250:	0c800593          	li	a1,200
ffffffffc0203254:	00003517          	auipc	a0,0x3
ffffffffc0203258:	0cc50513          	addi	a0,a0,204 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc020325c:	9f4fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(ret==0);
ffffffffc0203260:	00003697          	auipc	a3,0x3
ffffffffc0203264:	30068693          	addi	a3,a3,768 # ffffffffc0206560 <default_pmm_manager+0x968>
ffffffffc0203268:	00002617          	auipc	a2,0x2
ffffffffc020326c:	5f860613          	addi	a2,a2,1528 # ffffffffc0205860 <commands+0x870>
ffffffffc0203270:	10300593          	li	a1,259
ffffffffc0203274:	00003517          	auipc	a0,0x3
ffffffffc0203278:	0ac50513          	addi	a0,a0,172 # ffffffffc0206320 <default_pmm_manager+0x728>
ffffffffc020327c:	9d4fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(total == nr_free_pages());
ffffffffc0203280:	00002697          	auipc	a3,0x2
ffffffffc0203284:	61068693          	addi	a3,a3,1552 # ffffffffc0205890 <commands+0x8a0>
ffffffffc0203288:	00002617          	auipc	a2,0x2
ffffffffc020328c:	5d860613          	addi	a2,a2,1496 # ffffffffc0205860 <commands+0x870>
ffffffffc0203290:	0c000593          	li	a1,192
ffffffffc0203294:	00003517          	auipc	a0,0x3
ffffffffc0203298:	08c50513          	addi	a0,a0,140 # ffffffffc0206320 <default_pmm_manager+0x728>
...
ffffffffc02032ec:	320b0b13          	addi	s6,s6,800 # ffffffffc0206608 <default_pmm_manager+0xa10>
                    cprintf("SWAP: failed to save\n");
ffffffffc02032f0:	00003b97          	auipc	s7,0x3
ffffffffc02032f4:	300b8b93          	addi	s7,s7,768 # ffffffffc02065f0 <default_pmm_manager+0x9f8>
...
ffffffffc02033a6:	20650513          	addi	a0,a0,518 # ffffffffc02065a8 <default_pmm_manager+0x9b0>
...
ffffffffc02033b8:	22468693          	addi	a3,a3,548 # ffffffffc02065d8 <default_pmm_manager+0x9e0>
ffffffffc02033bc:	00002617          	auipc	a2,0x2
ffffffffc02033c0:	4a460613          	addi	a2,a2,1188 # ffffffffc0205860 <commands+0x870>
ffffffffc02033c4:	06900593          	li	a1,105
ffffffffc02033c8:	00003517          	auipc	a0,0x3
ffffffffc02033cc:	f5850513          	addi	a0,a0,-168 # ffffffffc0206320 <default_pmm_manager+0x728>
...
ffffffffc0203410:	eb450513          	addi	a0,a0,-332 # ffffffffc02062c0 <default_pmm_manager+0x6c8>
...
ffffffffc0203432:	e8268693          	addi	a3,a3,-382 # ffffffffc02062b0 <default_pmm_manager+0x6b8>
ffffffffc0203436:	00002617          	auipc	a2,0x2
ffffffffc020343a:	42a60613          	addi	a2,a2,1066 # ffffffffc0205860 <commands+0x870>
ffffffffc020343e:	07f00593          	li	a1,127
ffffffffc0203442:	00003517          	auipc	a0,0x3
ffffffffc0203446:	ede50513          	addi	a0,a0,-290 # ffffffffc0206320 <default_pmm_manager+0x728>
...
ffffffffc0203476:	1d650513          	addi	a0,a0,470 # ffffffffc0206648 <default_pmm_manager+0xa50>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc02034ae:	1de50513          	addi	a0,a0,478 # ffffffffc0206688 <default_pmm_manager+0xa90>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02034cc:	1e850513          	addi	a0,a0,488 # ffffffffc02066b0 <default_pmm_manager+0xab8>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc02034e8:	1f450513          	addi	a0,a0,500 # ffffffffc02066d8 <default_pmm_manager+0xae0>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203504:	20050513          	addi	a0,a0,512 # ffffffffc0206700 <default_pmm_manager+0xb08>
...
ffffffffc0203522:	1ba50513          	addi	a0,a0,442 # ffffffffc02066d8 <default_pmm_manager+0xae0>
...
ffffffffc020353a:	15250513          	addi	a0,a0,338 # ffffffffc0206688 <default_pmm_manager+0xa90>
...
ffffffffc0203554:	18850513          	addi	a0,a0,392 # ffffffffc02066d8 <default_pmm_manager+0xae0>
...
ffffffffc020356e:	0de50513          	addi	a0,a0,222 # ffffffffc0206648 <default_pmm_manager+0xa50>
...
ffffffffc0203588:	12c50513          	addi	a0,a0,300 # ffffffffc02066b0 <default_pmm_manager+0xab8>
...
ffffffffc02035a2:	16250513          	addi	a0,a0,354 # ffffffffc0206700 <default_pmm_manager+0xb08>
...
ffffffffc02035c0:	0cc50513          	addi	a0,a0,204 # ffffffffc0206688 <default_pmm_manager+0xa90>
...
ffffffffc02035fc:	ef068693          	addi	a3,a3,-272 # ffffffffc02064e8 <default_pmm_manager+0x8f0>
ffffffffc0203600:	00002617          	auipc	a2,0x2
ffffffffc0203604:	26060613          	addi	a2,a2,608 # ffffffffc0205860 <commands+0x870>
ffffffffc0203608:	05400593          	li	a1,84
ffffffffc020360c:	00003517          	auipc	a0,0x3
ffffffffc0203610:	06450513          	addi	a0,a0,100 # ffffffffc0206670 <default_pmm_manager+0xa78>
ffffffffc0203614:	e3dfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==11);
ffffffffc0203618:	00003697          	auipc	a3,0x3
ffffffffc020361c:	19868693          	addi	a3,a3,408 # ffffffffc02067b0 <default_pmm_manager+0xbb8>
ffffffffc0203620:	00002617          	auipc	a2,0x2
ffffffffc0203624:	24060613          	addi	a2,a2,576 # ffffffffc0205860 <commands+0x870>
ffffffffc0203628:	07600593          	li	a1,118
ffffffffc020362c:	00003517          	auipc	a0,0x3
ffffffffc0203630:	04450513          	addi	a0,a0,68 # ffffffffc0206670 <default_pmm_manager+0xa78>
ffffffffc0203634:	e1dfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203638:	00003697          	auipc	a3,0x3
ffffffffc020363c:	15068693          	addi	a3,a3,336 # ffffffffc0206788 <default_pmm_manager+0xb90>
ffffffffc0203640:	00002617          	auipc	a2,0x2
ffffffffc0203644:	22060613          	addi	a2,a2,544 # ffffffffc0205860 <commands+0x870>
ffffffffc0203648:	07400593          	li	a1,116
ffffffffc020364c:	00003517          	auipc	a0,0x3
ffffffffc0203650:	02450513          	addi	a0,a0,36 # ffffffffc0206670 <default_pmm_manager+0xa78>
ffffffffc0203654:	dfdfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==10);
ffffffffc0203658:	00003697          	auipc	a3,0x3
ffffffffc020365c:	12068693          	addi	a3,a3,288 # ffffffffc0206778 <default_pmm_manager+0xb80>
ffffffffc0203660:	00002617          	auipc	a2,0x2
ffffffffc0203664:	20060613          	addi	a2,a2,512 # ffffffffc0205860 <commands+0x870>
ffffffffc0203668:	07200593          	li	a1,114
ffffffffc020366c:	00003517          	auipc	a0,0x3
ffffffffc0203670:	00450513          	addi	a0,a0,4 # ffffffffc0206670 <default_pmm_manager+0xa78>
ffffffffc0203674:	dddfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==9);
ffffffffc0203678:	00003697          	auipc	a3,0x3
ffffffffc020367c:	0f068693          	addi	a3,a3,240 # ffffffffc0206768 <default_pmm_manager+0xb70>
ffffffffc0203680:	00002617          	auipc	a2,0x2
ffffffffc0203684:	1e060613          	addi	a2,a2,480 # ffffffffc0205860 <commands+0x870>
ffffffffc0203688:	06f00593          	li	a1,111
ffffffffc020368c:	00003517          	auipc	a0,0x3
ffffffffc0203690:	fe450513          	addi	a0,a0,-28 # ffffffffc0206670 <default_pmm_manager+0xa78>
ffffffffc0203694:	dbdfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==8);
ffffffffc0203698:	00003697          	auipc	a3,0x3
ffffffffc020369c:	0c068693          	addi	a3,a3,192 # ffffffffc0206758 <default_pmm_manager+0xb60>
ffffffffc02036a0:	00002617          	auipc	a2,0x2
ffffffffc02036a4:	1c060613          	addi	a2,a2,448 # ffffffffc0205860 <commands+0x870>
ffffffffc02036a8:	06c00593          	li	a1,108
ffffffffc02036ac:	00003517          	auipc	a0,0x3
ffffffffc02036b0:	fc450513          	addi	a0,a0,-60 # ffffffffc0206670 <default_pmm_manager+0xa78>
ffffffffc02036b4:	d9dfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==7);
ffffffffc02036b8:	00003697          	auipc	a3,0x3
ffffffffc02036bc:	09068693          	addi	a3,a3,144 # ffffffffc0206748 <default_pmm_manager+0xb50>
ffffffffc02036c0:	00002617          	auipc	a2,0x2
ffffffffc02036c4:	1a060613          	addi	a2,a2,416 # ffffffffc0205860 <commands+0x870>
ffffffffc02036c8:	06900593          	li	a1,105
ffffffffc02036cc:	00003517          	auipc	a0,0x3
ffffffffc02036d0:	fa450513          	addi	a0,a0,-92 # ffffffffc0206670 <default_pmm_manager+0xa78>
ffffffffc02036d4:	d7dfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==6);
ffffffffc02036d8:	00003697          	auipc	a3,0x3
ffffffffc02036dc:	06068693          	addi	a3,a3,96 # ffffffffc0206738 <default_pmm_manager+0xb40>
ffffffffc02036e0:	00002617          	auipc	a2,0x2
ffffffffc02036e4:	18060613          	addi	a2,a2,384 # ffffffffc0205860 <commands+0x870>
ffffffffc02036e8:	06600593          	li	a1,102
ffffffffc02036ec:	00003517          	auipc	a0,0x3
ffffffffc02036f0:	f8450513          	addi	a0,a0,-124 # ffffffffc0206670 <default_pmm_manager+0xa78>
ffffffffc02036f4:	d5dfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==5);
ffffffffc02036f8:	00003697          	auipc	a3,0x3
ffffffffc02036fc:	03068693          	addi	a3,a3,48 # ffffffffc0206728 <default_pmm_manager+0xb30>
ffffffffc0203700:	00002617          	auipc	a2,0x2
ffffffffc0203704:	16060613          	addi	a2,a2,352 # ffffffffc0205860 <commands+0x870>
ffffffffc0203708:	06300593          	li	a1,99
ffffffffc020370c:	00003517          	auipc	a0,0x3
ffffffffc0203710:	f6450513          	addi	a0,a0,-156 # ffffffffc0206670 <default_pmm_manager+0xa78>
ffffffffc0203714:	d3dfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==5);
ffffffffc0203718:	00003697          	auipc	a3,0x3
ffffffffc020371c:	01068693          	addi	a3,a3,16 # ffffffffc0206728 <default_pmm_manager+0xb30>
ffffffffc0203720:	00002617          	auipc	a2,0x2
ffffffffc0203724:	14060613          	addi	a2,a2,320 # ffffffffc0205860 <commands+0x870>
ffffffffc0203728:	06000593          	li	a1,96
ffffffffc020372c:	00003517          	auipc	a0,0x3
ffffffffc0203730:	f4450513          	addi	a0,a0,-188 # ffffffffc0206670 <default_pmm_manager+0xa78>
ffffffffc0203734:	d1dfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==4);
ffffffffc0203738:	00003697          	auipc	a3,0x3
ffffffffc020373c:	db068693          	addi	a3,a3,-592 # ffffffffc02064e8 <default_pmm_manager+0x8f0>
ffffffffc0203740:	00002617          	auipc	a2,0x2
ffffffffc0203744:	12060613          	addi	a2,a2,288 # ffffffffc0205860 <commands+0x870>
ffffffffc0203748:	05d00593          	li	a1,93
ffffffffc020374c:	00003517          	auipc	a0,0x3
ffffffffc0203750:	f2450513          	addi	a0,a0,-220 # ffffffffc0206670 <default_pmm_manager+0xa78>
ffffffffc0203754:	cfdfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==4);
ffffffffc0203758:	00003697          	auipc	a3,0x3
ffffffffc020375c:	d9068693          	addi	a3,a3,-624 # ffffffffc02064e8 <default_pmm_manager+0x8f0>
ffffffffc0203760:	00002617          	auipc	a2,0x2
ffffffffc0203764:	10060613          	addi	a2,a2,256 # ffffffffc0205860 <commands+0x870>
ffffffffc0203768:	05a00593          	li	a1,90
ffffffffc020376c:	00003517          	auipc	a0,0x3
ffffffffc0203770:	f0450513          	addi	a0,a0,-252 # ffffffffc0206670 <default_pmm_manager+0xa78>
ffffffffc0203774:	cddfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==4);
ffffffffc0203778:	00003697          	auipc	a3,0x3
ffffffffc020377c:	d7068693          	addi	a3,a3,-656 # ffffffffc02064e8 <default_pmm_manager+0x8f0>
ffffffffc0203780:	00002617          	auipc	a2,0x2
ffffffffc0203784:	0e060613          	addi	a2,a2,224 # ffffffffc0205860 <commands+0x870>
ffffffffc0203788:	05700593          	li	a1,87
ffffffffc020378c:	00003517          	auipc	a0,0x3
ffffffffc0203790:	ee450513          	addi	a0,a0,-284 # ffffffffc0206670 <default_pmm_manager+0xa78>
...
ffffffffc02037ce:	02668693          	addi	a3,a3,38 # ffffffffc02067f0 <default_pmm_manager+0xbf8>
ffffffffc02037d2:	00002617          	auipc	a2,0x2
ffffffffc02037d6:	08e60613          	addi	a2,a2,142 # ffffffffc0205860 <commands+0x870>
ffffffffc02037da:	04200593          	li	a1,66
ffffffffc02037de:	00003517          	auipc	a0,0x3
ffffffffc02037e2:	e9250513          	addi	a0,a0,-366 # ffffffffc0206670 <default_pmm_manager+0xa78>
ffffffffc02037e6:	c6bfc0ef          	jal	ra,ffffffffc0200450 <__panic>
         assert(head != NULL);
ffffffffc02037ea:	00003697          	auipc	a3,0x3
ffffffffc02037ee:	ff668693          	addi	a3,a3,-10 # ffffffffc02067e0 <default_pmm_manager+0xbe8>
ffffffffc02037f2:	00002617          	auipc	a2,0x2
ffffffffc02037f6:	06e60613          	addi	a2,a2,110 # ffffffffc0205860 <commands+0x870>
ffffffffc02037fa:	04100593          	li	a1,65
ffffffffc02037fe:	00003517          	auipc	a0,0x3
ffffffffc0203802:	e7250513          	addi	a0,a0,-398 # ffffffffc0206670 <default_pmm_manager+0xa78>
...
ffffffffc0203828:	f9c68693          	addi	a3,a3,-100 # ffffffffc02067c0 <default_pmm_manager+0xbc8>
ffffffffc020382c:	00002617          	auipc	a2,0x2
ffffffffc0203830:	03460613          	addi	a2,a2,52 # ffffffffc0205860 <commands+0x870>
ffffffffc0203834:	03200593          	li	a1,50
ffffffffc0203838:	00003517          	auipc	a0,0x3
ffffffffc020383c:	e3850513          	addi	a0,a0,-456 # ffffffffc0206670 <default_pmm_manager+0xa78>
{
...
ffffffffc020384c:	fd068693          	addi	a3,a3,-48 # ffffffffc0206818 <default_pmm_manager+0xc20>
ffffffffc0203850:	00002617          	auipc	a2,0x2
ffffffffc0203854:	01060613          	addi	a2,a2,16 # ffffffffc0205860 <commands+0x870>
ffffffffc0203858:	07e00593          	li	a1,126
ffffffffc020385c:	00003517          	auipc	a0,0x3
ffffffffc0203860:	fdc50513          	addi	a0,a0,-36 # ffffffffc0206838 <default_pmm_manager+0xc40>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0203880:	c2478793          	addi	a5,a5,-988 # ffffffffc02154a0 <swap_init_ok>
...
ffffffffc0203994:	f5868693          	addi	a3,a3,-168 # ffffffffc02068e8 <default_pmm_manager+0xcf0>
ffffffffc0203998:	00002617          	auipc	a2,0x2
ffffffffc020399c:	ec860613          	addi	a2,a2,-312 # ffffffffc0205860 <commands+0x870>
ffffffffc02039a0:	08500593          	li	a1,133
ffffffffc02039a4:	00003517          	auipc	a0,0x3
ffffffffc02039a8:	e9450513          	addi	a0,a0,-364 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc02039ac:	aa5fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02039b0:	00003697          	auipc	a3,0x3
ffffffffc02039b4:	f7868693          	addi	a3,a3,-136 # ffffffffc0206928 <default_pmm_manager+0xd30>
ffffffffc02039b8:	00002617          	auipc	a2,0x2
ffffffffc02039bc:	ea860613          	addi	a2,a2,-344 # ffffffffc0205860 <commands+0x870>
ffffffffc02039c0:	07d00593          	li	a1,125
ffffffffc02039c4:	00003517          	auipc	a0,0x3
ffffffffc02039c8:	e7450513          	addi	a0,a0,-396 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc02039cc:	a85fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039d0:	00003697          	auipc	a3,0x3
ffffffffc02039d4:	f3868693          	addi	a3,a3,-200 # ffffffffc0206908 <default_pmm_manager+0xd10>
ffffffffc02039d8:	00002617          	auipc	a2,0x2
ffffffffc02039dc:	e8860613          	addi	a2,a2,-376 # ffffffffc0205860 <commands+0x870>
ffffffffc02039e0:	07c00593          	li	a1,124
ffffffffc02039e4:	00003517          	auipc	a0,0x3
ffffffffc02039e8:	e5450513          	addi	a0,a0,-428 # ffffffffc0206838 <default_pmm_manager+0xc40>
...
ffffffffc0203a62:	94a68693          	addi	a3,a3,-1718 # ffffffffc02063a8 <default_pmm_manager+0x7b0>
ffffffffc0203a66:	00002617          	auipc	a2,0x2
ffffffffc0203a6a:	dfa60613          	addi	a2,a2,-518 # ffffffffc0205860 <commands+0x870>
ffffffffc0203a6e:	0c900593          	li	a1,201
ffffffffc0203a72:	00003517          	auipc	a0,0x3
ffffffffc0203a76:	dc650513          	addi	a0,a0,-570 # ffffffffc0206838 <default_pmm_manager+0xc40>
...
ffffffffc0203ab0:	8fc68693          	addi	a3,a3,-1796 # ffffffffc02063a8 <default_pmm_manager+0x7b0>
ffffffffc0203ab4:	00002617          	auipc	a2,0x2
ffffffffc0203ab8:	dac60613          	addi	a2,a2,-596 # ffffffffc0205860 <commands+0x870>
ffffffffc0203abc:	0cf00593          	li	a1,207
ffffffffc0203ac0:	00003517          	auipc	a0,0x3
ffffffffc0203ac4:	d7850513          	addi	a0,a0,-648 # ffffffffc0206838 <default_pmm_manager+0xc40>
...
ffffffffc0203b84:	ec850513          	addi	a0,a0,-312 # ffffffffc0206a48 <default_pmm_manager+0xe50>
ffffffffc0203b88:	e06fc0ef          	jal	ra,ffffffffc020018e <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203b8c:	00003697          	auipc	a3,0x3
ffffffffc0203b90:	ee468693          	addi	a3,a3,-284 # ffffffffc0206a70 <default_pmm_manager+0xe78>
ffffffffc0203b94:	00002617          	auipc	a2,0x2
ffffffffc0203b98:	ccc60613          	addi	a2,a2,-820 # ffffffffc0205860 <commands+0x870>
ffffffffc0203b9c:	0f100593          	li	a1,241
ffffffffc0203ba0:	00003517          	auipc	a0,0x3
ffffffffc0203ba4:	c9850513          	addi	a0,a0,-872 # ffffffffc0206838 <default_pmm_manager+0xc40>
...
ffffffffc0203bbc:	ed050513          	addi	a0,a0,-304 # ffffffffc0206a88 <default_pmm_manager+0xe90>
...
ffffffffc0203bce:	00012797          	auipc	a5,0x12
ffffffffc0203bd2:	a0a7b923          	sd	a0,-1518(a5) # ffffffffc02155e0 <check_mm_struct>
...
ffffffffc0203bd8:	36050663          	beqz	a0,ffffffffc0203f44 <vmm_init+0x526>
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203bdc:	00012797          	auipc	a5,0x12
ffffffffc0203be0:	8ac78793          	addi	a5,a5,-1876 # ffffffffc0215488 <boot_pgdir>
...
ffffffffc0203c56:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203c5a:	00012a97          	auipc	s5,0x12
ffffffffc0203c5e:	836a8a93          	addi	s5,s5,-1994 # ffffffffc0215490 <npage>
...
ffffffffc0203c72:	33268693          	addi	a3,a3,818 # ffffffffc0206fa0 <nbase>
...
ffffffffc0203c90:	00012797          	auipc	a5,0x12
ffffffffc0203c94:	86078793          	addi	a5,a5,-1952 # ffffffffc02154f0 <va_pa_offset>
...
ffffffffc0203cae:	1ce7f363          	bleu	a4,a5,ffffffffc0203e74 <vmm_init+0x456>
    return &pages[PPN(pa) - nbase];
ffffffffc0203cb2:	00012417          	auipc	s0,0x12
ffffffffc0203cb6:	84e40413          	addi	s0,s0,-1970 # ffffffffc0215500 <pages>
...
ffffffffc0203cfc:	00012797          	auipc	a5,0x12
ffffffffc0203d00:	8e07b223          	sd	zero,-1820(a5) # ffffffffc02155e0 <check_mm_struct>
...
ffffffffc0203d10:	e0c50513          	addi	a0,a0,-500 # ffffffffc0206b18 <default_pmm_manager+0xf20>
...
ffffffffc0203d2a:	e1250513          	addi	a0,a0,-494 # ffffffffc0206b38 <default_pmm_manager+0xf40>
}
...
ffffffffc0203d38:	c2c68693          	addi	a3,a3,-980 # ffffffffc0206960 <default_pmm_manager+0xd68>
ffffffffc0203d3c:	00002617          	auipc	a2,0x2
ffffffffc0203d40:	b2460613          	addi	a2,a2,-1244 # ffffffffc0205860 <commands+0x870>
ffffffffc0203d44:	0d800593          	li	a1,216
ffffffffc0203d48:	00003517          	auipc	a0,0x3
ffffffffc0203d4c:	af050513          	addi	a0,a0,-1296 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc0203d50:	f00fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203d54:	00003697          	auipc	a3,0x3
ffffffffc0203d58:	c9468693          	addi	a3,a3,-876 # ffffffffc02069e8 <default_pmm_manager+0xdf0>
ffffffffc0203d5c:	00002617          	auipc	a2,0x2
ffffffffc0203d60:	b0460613          	addi	a2,a2,-1276 # ffffffffc0205860 <commands+0x870>
ffffffffc0203d64:	0e800593          	li	a1,232
ffffffffc0203d68:	00003517          	auipc	a0,0x3
ffffffffc0203d6c:	ad050513          	addi	a0,a0,-1328 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc0203d70:	ee0fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203d74:	00003697          	auipc	a3,0x3
ffffffffc0203d78:	ca468693          	addi	a3,a3,-860 # ffffffffc0206a18 <default_pmm_manager+0xe20>
ffffffffc0203d7c:	00002617          	auipc	a2,0x2
ffffffffc0203d80:	ae460613          	addi	a2,a2,-1308 # ffffffffc0205860 <commands+0x870>
ffffffffc0203d84:	0e900593          	li	a1,233
ffffffffc0203d88:	00003517          	auipc	a0,0x3
ffffffffc0203d8c:	ab050513          	addi	a0,a0,-1360 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc0203d90:	ec0fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(vma != NULL);
ffffffffc0203d94:	00002697          	auipc	a3,0x2
ffffffffc0203d98:	61468693          	addi	a3,a3,1556 # ffffffffc02063a8 <default_pmm_manager+0x7b0>
ffffffffc0203d9c:	00002617          	auipc	a2,0x2
ffffffffc0203da0:	ac460613          	addi	a2,a2,-1340 # ffffffffc0205860 <commands+0x870>
ffffffffc0203da4:	10800593          	li	a1,264
ffffffffc0203da8:	00003517          	auipc	a0,0x3
ffffffffc0203dac:	a9050513          	addi	a0,a0,-1392 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc0203db0:	ea0fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203db4:	00003697          	auipc	a3,0x3
ffffffffc0203db8:	b9468693          	addi	a3,a3,-1132 # ffffffffc0206948 <default_pmm_manager+0xd50>
ffffffffc0203dbc:	00002617          	auipc	a2,0x2
ffffffffc0203dc0:	aa460613          	addi	a2,a2,-1372 # ffffffffc0205860 <commands+0x870>
ffffffffc0203dc4:	0d600593          	li	a1,214
ffffffffc0203dc8:	00003517          	auipc	a0,0x3
ffffffffc0203dcc:	a7050513          	addi	a0,a0,-1424 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc0203dd0:	e80fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma3 == NULL);
ffffffffc0203dd4:	00003697          	auipc	a3,0x3
ffffffffc0203dd8:	be468693          	addi	a3,a3,-1052 # ffffffffc02069b8 <default_pmm_manager+0xdc0>
ffffffffc0203ddc:	00002617          	auipc	a2,0x2
ffffffffc0203de0:	a8460613          	addi	a2,a2,-1404 # ffffffffc0205860 <commands+0x870>
ffffffffc0203de4:	0e200593          	li	a1,226
ffffffffc0203de8:	00003517          	auipc	a0,0x3
ffffffffc0203dec:	a5050513          	addi	a0,a0,-1456 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc0203df0:	e60fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma2 != NULL);
ffffffffc0203df4:	00003697          	auipc	a3,0x3
ffffffffc0203df8:	bb468693          	addi	a3,a3,-1100 # ffffffffc02069a8 <default_pmm_manager+0xdb0>
ffffffffc0203dfc:	00002617          	auipc	a2,0x2
ffffffffc0203e00:	a6460613          	addi	a2,a2,-1436 # ffffffffc0205860 <commands+0x870>
ffffffffc0203e04:	0e000593          	li	a1,224
ffffffffc0203e08:	00003517          	auipc	a0,0x3
ffffffffc0203e0c:	a3050513          	addi	a0,a0,-1488 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc0203e10:	e40fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e14:	00003697          	auipc	a3,0x3
ffffffffc0203e18:	b8468693          	addi	a3,a3,-1148 # ffffffffc0206998 <default_pmm_manager+0xda0>
ffffffffc0203e1c:	00002617          	auipc	a2,0x2
ffffffffc0203e20:	a4460613          	addi	a2,a2,-1468 # ffffffffc0205860 <commands+0x870>
ffffffffc0203e24:	0de00593          	li	a1,222
ffffffffc0203e28:	00003517          	auipc	a0,0x3
ffffffffc0203e2c:	a1050513          	addi	a0,a0,-1520 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc0203e30:	e20fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma5 == NULL);
ffffffffc0203e34:	00003697          	auipc	a3,0x3
ffffffffc0203e38:	ba468693          	addi	a3,a3,-1116 # ffffffffc02069d8 <default_pmm_manager+0xde0>
ffffffffc0203e3c:	00002617          	auipc	a2,0x2
ffffffffc0203e40:	a2460613          	addi	a2,a2,-1500 # ffffffffc0205860 <commands+0x870>
ffffffffc0203e44:	0e600593          	li	a1,230
ffffffffc0203e48:	00003517          	auipc	a0,0x3
ffffffffc0203e4c:	9f050513          	addi	a0,a0,-1552 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc0203e50:	e00fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma4 == NULL);
ffffffffc0203e54:	00003697          	auipc	a3,0x3
ffffffffc0203e58:	b7468693          	addi	a3,a3,-1164 # ffffffffc02069c8 <default_pmm_manager+0xdd0>
ffffffffc0203e5c:	00002617          	auipc	a2,0x2
ffffffffc0203e60:	a0460613          	addi	a2,a2,-1532 # ffffffffc0205860 <commands+0x870>
ffffffffc0203e64:	0e400593          	li	a1,228
ffffffffc0203e68:	00003517          	auipc	a0,0x3
ffffffffc0203e6c:	9d050513          	addi	a0,a0,-1584 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc0203e70:	de0fc0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203e74:	00002617          	auipc	a2,0x2
ffffffffc0203e78:	e3460613          	addi	a2,a2,-460 # ffffffffc0205ca8 <default_pmm_manager+0xb0>
ffffffffc0203e7c:	06200593          	li	a1,98
ffffffffc0203e80:	00002517          	auipc	a0,0x2
ffffffffc0203e84:	df050513          	addi	a0,a0,-528 # ffffffffc0205c70 <default_pmm_manager+0x78>
ffffffffc0203e88:	dc8fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(mm != NULL);
ffffffffc0203e8c:	00002697          	auipc	a3,0x2
ffffffffc0203e90:	4e468693          	addi	a3,a3,1252 # ffffffffc0206370 <default_pmm_manager+0x778>
ffffffffc0203e94:	00002617          	auipc	a2,0x2
ffffffffc0203e98:	9cc60613          	addi	a2,a2,-1588 # ffffffffc0205860 <commands+0x870>
ffffffffc0203e9c:	0c200593          	li	a1,194
ffffffffc0203ea0:	00003517          	auipc	a0,0x3
ffffffffc0203ea4:	99850513          	addi	a0,a0,-1640 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc0203ea8:	da8fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203eac:	00003697          	auipc	a3,0x3
ffffffffc0203eb0:	c4468693          	addi	a3,a3,-956 # ffffffffc0206af0 <default_pmm_manager+0xef8>
ffffffffc0203eb4:	00002617          	auipc	a2,0x2
ffffffffc0203eb8:	9ac60613          	addi	a2,a2,-1620 # ffffffffc0205860 <commands+0x870>
ffffffffc0203ebc:	12400593          	li	a1,292
ffffffffc0203ec0:	00003517          	auipc	a0,0x3
ffffffffc0203ec4:	97850513          	addi	a0,a0,-1672 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc0203ec8:	d88fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203ecc:	00002697          	auipc	a3,0x2
ffffffffc0203ed0:	4cc68693          	addi	a3,a3,1228 # ffffffffc0206398 <default_pmm_manager+0x7a0>
ffffffffc0203ed4:	00002617          	auipc	a2,0x2
ffffffffc0203ed8:	98c60613          	addi	a2,a2,-1652 # ffffffffc0205860 <commands+0x870>
ffffffffc0203edc:	10500593          	li	a1,261
ffffffffc0203ee0:	00003517          	auipc	a0,0x3
ffffffffc0203ee4:	95850513          	addi	a0,a0,-1704 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc0203ee8:	d68fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203eec:	00003697          	auipc	a3,0x3
ffffffffc0203ef0:	bd468693          	addi	a3,a3,-1068 # ffffffffc0206ac0 <default_pmm_manager+0xec8>
ffffffffc0203ef4:	00002617          	auipc	a2,0x2
ffffffffc0203ef8:	96c60613          	addi	a2,a2,-1684 # ffffffffc0205860 <commands+0x870>
ffffffffc0203efc:	10d00593          	li	a1,269
ffffffffc0203f00:	00003517          	auipc	a0,0x3
ffffffffc0203f04:	93850513          	addi	a0,a0,-1736 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc0203f08:	d48fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f0c:	00002617          	auipc	a2,0x2
ffffffffc0203f10:	d3c60613          	addi	a2,a2,-708 # ffffffffc0205c48 <default_pmm_manager+0x50>
ffffffffc0203f14:	06900593          	li	a1,105
ffffffffc0203f18:	00002517          	auipc	a0,0x2
ffffffffc0203f1c:	d5850513          	addi	a0,a0,-680 # ffffffffc0205c70 <default_pmm_manager+0x78>
ffffffffc0203f20:	d30fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(sum == 0);
ffffffffc0203f24:	00003697          	auipc	a3,0x3
ffffffffc0203f28:	bbc68693          	addi	a3,a3,-1092 # ffffffffc0206ae0 <default_pmm_manager+0xee8>
ffffffffc0203f2c:	00002617          	auipc	a2,0x2
ffffffffc0203f30:	93460613          	addi	a2,a2,-1740 # ffffffffc0205860 <commands+0x870>
ffffffffc0203f34:	11700593          	li	a1,279
ffffffffc0203f38:	00003517          	auipc	a0,0x3
ffffffffc0203f3c:	90050513          	addi	a0,a0,-1792 # ffffffffc0206838 <default_pmm_manager+0xc40>
ffffffffc0203f40:	d10fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203f44:	00003697          	auipc	a3,0x3
ffffffffc0203f48:	b6468693          	addi	a3,a3,-1180 # ffffffffc0206aa8 <default_pmm_manager+0xeb0>
ffffffffc0203f4c:	00002617          	auipc	a2,0x2
ffffffffc0203f50:	91460613          	addi	a2,a2,-1772 # ffffffffc0205860 <commands+0x870>
ffffffffc0203f54:	10100593          	li	a1,257
ffffffffc0203f58:	00003517          	auipc	a0,0x3
ffffffffc0203f5c:	8e050513          	addi	a0,a0,-1824 # ffffffffc0206838 <default_pmm_manager+0xc40>
...
ffffffffc0203f74:	971ff0ef          	jal	ra,ffffffffc02038e4 <find_vma>
    ...
    pgfault_num++;
ffffffffc0203f78:	00011797          	auipc	a5,0x11
ffffffffc0203f7c:	52c78793          	addi	a5,a5,1324 # ffffffffc02154a4 <pgfault_num>
ffffffffc0203f80:	439c                	lw	a5,0(a5)
ffffffffc0203f82:	2785                	addiw	a5,a5,1
ffffffffc0203f84:	00011717          	auipc	a4,0x11
ffffffffc0203f88:	52f72023          	sw	a5,1312(a4) # ffffffffc02154a4 <pgfault_num>
...
ffffffffc0203fae:	c5b1                	beqz	a1,ffffffffc0203ffa <do_pgfault+0x96>
        ...
        */
        if (swap_init_ok) {
ffffffffc0203fb0:	00011797          	auipc	a5,0x11
ffffffffc0203fb4:	4f078793          	addi	a5,a5,1264 # ffffffffc02154a0 <swap_init_ok>
...
ffffffffc020400c:	89050513          	addi	a0,a0,-1904 # ffffffffc0206898 <default_pmm_manager+0xca0>
...
ffffffffc020401e:	82e50513          	addi	a0,a0,-2002 # ffffffffc0206848 <default_pmm_manager+0xc50>
...
ffffffffc020402e:	89650513          	addi	a0,a0,-1898 # ffffffffc02068c0 <default_pmm_manager+0xcc8>
...
ffffffffc020403e:	83e50513          	addi	a0,a0,-1986 # ffffffffc0206878 <default_pmm_manager+0xc80>
...
ffffffffc0204064:	52a7b823          	sd	a0,1328(a5) # ffffffffc0215590 <max_swap_offset>
}
ffffffffc0204068:	0141                	addi	sp,sp,16
ffffffffc020406a:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc020406c:	00003617          	auipc	a2,0x3
ffffffffc0204070:	ae460613          	addi	a2,a2,-1308 # ffffffffc0206b50 <default_pmm_manager+0xf58>
ffffffffc0204074:	45b5                	li	a1,13
ffffffffc0204076:	00003517          	auipc	a0,0x3
ffffffffc020407a:	afa50513          	addi	a0,a0,-1286 # ffffffffc0206b70 <default_pmm_manager+0xf78>
...
ffffffffc0204090:	50470713          	addi	a4,a4,1284 # ffffffffc0215590 <max_swap_offset>
...
ffffffffc020409e:	46670713          	addi	a4,a4,1126 # ffffffffc0215500 <pages>
ffffffffc02040a2:	6310                	ld	a2,0(a4)
ffffffffc02040a4:	00003717          	auipc	a4,0x3
ffffffffc02040a8:	efc70713          	addi	a4,a4,-260 # ffffffffc0206fa0 <nbase>
    return KADDR(page2pa(page));
ffffffffc02040ac:	00011697          	auipc	a3,0x11
ffffffffc02040b0:	3e468693          	addi	a3,a3,996 # ffffffffc0215490 <npage>
    return page - pages + nbase;
...
ffffffffc02040d4:	42078793          	addi	a5,a5,1056 # ffffffffc02154f0 <va_pa_offset>
...
ffffffffc02040ee:	a9e60613          	addi	a2,a2,-1378 # ffffffffc0206b88 <default_pmm_manager+0xf90>
ffffffffc02040f2:	45d1                	li	a1,20
ffffffffc02040f4:	00003517          	auipc	a0,0x3
ffffffffc02040f8:	a7c50513          	addi	a0,a0,-1412 # ffffffffc0206b70 <default_pmm_manager+0xf78>
...
ffffffffc020410a:	b4260613          	addi	a2,a2,-1214 # ffffffffc0205c48 <default_pmm_manager+0x50>
ffffffffc020410e:	00002517          	auipc	a0,0x2
ffffffffc0204112:	b6250513          	addi	a0,a0,-1182 # ffffffffc0205c70 <default_pmm_manager+0x78>
...
ffffffffc0204128:	46c70713          	addi	a4,a4,1132 # ffffffffc0215590 <max_swap_offset>
...
ffffffffc0204136:	3ce70713          	addi	a4,a4,974 # ffffffffc0215500 <pages>
ffffffffc020413a:	6310                	ld	a2,0(a4)
ffffffffc020413c:	00003717          	auipc	a4,0x3
ffffffffc0204140:	e6470713          	addi	a4,a4,-412 # ffffffffc0206fa0 <nbase>
    return KADDR(page2pa(page));
ffffffffc0204144:	00011697          	auipc	a3,0x11
ffffffffc0204148:	34c68693          	addi	a3,a3,844 # ffffffffc0215490 <npage>
    return page - pages + nbase;
...
ffffffffc020416c:	38878793          	addi	a5,a5,904 # ffffffffc02154f0 <va_pa_offset>
...
ffffffffc0204186:	a0660613          	addi	a2,a2,-1530 # ffffffffc0206b88 <default_pmm_manager+0xf90>
ffffffffc020418a:	45e5                	li	a1,25
ffffffffc020418c:	00003517          	auipc	a0,0x3
ffffffffc0204190:	9e450513          	addi	a0,a0,-1564 # ffffffffc0206b70 <default_pmm_manager+0xf78>
...
ffffffffc02041a2:	aaa60613          	addi	a2,a2,-1366 # ffffffffc0205c48 <default_pmm_manager+0x50>
ffffffffc02041a6:	00002517          	auipc	a0,0x2
ffffffffc02041aa:	aca50513          	addi	a0,a0,-1334 # ffffffffc0205c70 <default_pmm_manager+0x78>
...
ffffffffc02041b4:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc02041b6:	49c000ef          	jal	ra,ffffffffc0204652 <do_exit>
...
ffffffffc02041c8:	842a                	mv	s0,a0
    if (proc != NULL) {
ffffffffc02041ca:	cd19                	beqz	a0,ffffffffc02041e8 <alloc_proc+0x2e>
...
ffffffffc02041cc:	0e800613          	li	a2,232
ffffffffc02041d0:	4581                	li	a1,0
ffffffffc02041d2:	491000ef          	jal	ra,ffffffffc0204e62 <memset>
        proc->state = PROC_UNINIT;
ffffffffc02041d6:	57fd                	li	a5,-1
ffffffffc02041d8:	1782                	slli	a5,a5,0x20
ffffffffc02041da:	e01c                	sd	a5,0(s0)
        proc->pid = -1;
        proc->cr3 = boot_cr3;
ffffffffc02041dc:	00011797          	auipc	a5,0x11
ffffffffc02041e0:	31c78793          	addi	a5,a5,796 # ffffffffc02154f8 <boot_cr3>
ffffffffc02041e4:	639c                	ld	a5,0(a5)
ffffffffc02041e6:	f45c                	sd	a5,168(s0)
    }
    return proc;
}
ffffffffc02041e8:	8522                	mv	a0,s0
ffffffffc02041ea:	60a2                	ld	ra,8(sp)
ffffffffc02041ec:	6402                	ld	s0,0(sp)
ffffffffc02041ee:	0141                	addi	sp,sp,16
ffffffffc02041f0:	8082                	ret

ffffffffc02041f2 <forkret>:
...
ffffffffc02041f6:	2b678793          	addi	a5,a5,694 # ffffffffc02154a8 <current>
ffffffffc02041fa:	639c                	ld	a5,0(a5)
ffffffffc02041fc:	73c8                	ld	a0,160(a5)
ffffffffc02041fe:	99bfc06f          	j	ffffffffc0200b98 <forkrets>

ffffffffc0204202 <set_proc_name>:
set_proc_name(struct proc_struct *proc, const char *name) {
ffffffffc0204202:	1101                	addi	sp,sp,-32
ffffffffc0204204:	e822                	sd	s0,16(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204206:	0b450413          	addi	s0,a0,180
set_proc_name(struct proc_struct *proc, const char *name) {
ffffffffc020420a:	e426                	sd	s1,8(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020420c:	4641                	li	a2,16
set_proc_name(struct proc_struct *proc, const char *name) {
ffffffffc020420e:	84ae                	mv	s1,a1
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204210:	8522                	mv	a0,s0
ffffffffc0204212:	4581                	li	a1,0
set_proc_name(struct proc_struct *proc, const char *name) {
ffffffffc0204214:	ec06                	sd	ra,24(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204216:	44d000ef          	jal	ra,ffffffffc0204e62 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020421a:	8522                	mv	a0,s0
}
ffffffffc020421c:	6442                	ld	s0,16(sp)
ffffffffc020421e:	60e2                	ld	ra,24(sp)
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204220:	85a6                	mv	a1,s1
}
ffffffffc0204222:	64a2                	ld	s1,8(sp)
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204224:	463d                	li	a2,15
}
ffffffffc0204226:	6105                	addi	sp,sp,32
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204228:	44d0006f          	j	ffffffffc0204e74 <memcpy>

ffffffffc020422c <get_proc_name>:
get_proc_name(struct proc_struct *proc) {
ffffffffc020422c:	1101                	addi	sp,sp,-32
ffffffffc020422e:	e822                	sd	s0,16(sp)
    memset(name, 0, sizeof(name));
ffffffffc0204230:	00011417          	auipc	s0,0x11
ffffffffc0204234:	23040413          	addi	s0,s0,560 # ffffffffc0215460 <name.1565>
get_proc_name(struct proc_struct *proc) {
ffffffffc0204238:	e426                	sd	s1,8(sp)
    memset(name, 0, sizeof(name));
ffffffffc020423a:	4641                	li	a2,16
get_proc_name(struct proc_struct *proc) {
...
get_proc_name(struct proc_struct *proc) {
ffffffffc0204242:	ec06                	sd	ra,24(sp)
    memset(name, 0, sizeof(name));
ffffffffc0204244:	41f000ef          	jal	ra,ffffffffc0204e62 <memset>
...
ffffffffc020424c:	60e2                	ld	ra,24(sp)
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc020424e:	0b448593          	addi	a1,s1,180
}
ffffffffc0204252:	64a2                	ld	s1,8(sp)
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc0204254:	463d                	li	a2,15
}
ffffffffc0204256:	6105                	addi	sp,sp,32
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc0204258:	41d0006f          	j	ffffffffc0204e74 <memcpy>

ffffffffc020425c <init_main>:
}
...
ffffffffc020425c:	00011797          	auipc	a5,0x11
ffffffffc0204260:	24c78793          	addi	a5,a5,588 # ffffffffc02154a8 <current>
ffffffffc0204264:	639c                	ld	a5,0(a5)
init_main(void *arg) {
ffffffffc0204266:	1101                	addi	sp,sp,-32
ffffffffc0204268:	e426                	sd	s1,8(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc020426a:	43c4                	lw	s1,4(a5)
init_main(void *arg) {
...
ffffffffc0204272:	ec06                	sd	ra,24(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc0204274:	fb9ff0ef          	jal	ra,ffffffffc020422c <get_proc_name>
ffffffffc0204278:	862a                	mv	a2,a0
ffffffffc020427a:	85a6                	mv	a1,s1
ffffffffc020427c:	00003517          	auipc	a0,0x3
ffffffffc0204280:	97450513          	addi	a0,a0,-1676 # ffffffffc0206bf0 <default_pmm_manager+0xff8>
ffffffffc0204284:	f0bfb0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("To U: \"%s\".\n", (const char *)arg);
ffffffffc0204288:	85a2                	mv	a1,s0
ffffffffc020428a:	00003517          	auipc	a0,0x3
ffffffffc020428e:	98e50513          	addi	a0,a0,-1650 # ffffffffc0206c18 <default_pmm_manager+0x1020>
ffffffffc0204292:	efdfb0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc0204296:	00003517          	auipc	a0,0x3
ffffffffc020429a:	99250513          	addi	a0,a0,-1646 # ffffffffc0206c28 <default_pmm_manager+0x1030>
ffffffffc020429e:	ef1fb0ef          	jal	ra,ffffffffc020018e <cprintf>
    return 0;
}
ffffffffc02042a2:	60e2                	ld	ra,24(sp)
ffffffffc02042a4:	6442                	ld	s0,16(sp)
ffffffffc02042a6:	64a2                	ld	s1,8(sp)
ffffffffc02042a8:	4501                	li	a0,0
ffffffffc02042aa:	6105                	addi	sp,sp,32
ffffffffc02042ac:	8082                	ret

ffffffffc02042ae <proc_run>:
proc_run(struct proc_struct *proc) {
ffffffffc02042ae:	1101                	addi	sp,sp,-32
    if (proc != current) {
ffffffffc02042b0:	00011797          	auipc	a5,0x11
ffffffffc02042b4:	1f878793          	addi	a5,a5,504 # ffffffffc02154a8 <current>
proc_run(struct proc_struct *proc) {
ffffffffc02042b8:	e426                	sd	s1,8(sp)
    if (proc != current) {
ffffffffc02042ba:	6384                	ld	s1,0(a5)
proc_run(struct proc_struct *proc) {
ffffffffc02042bc:	ec06                	sd	ra,24(sp)
ffffffffc02042be:	e822                	sd	s0,16(sp)
ffffffffc02042c0:	e04a                	sd	s2,0(sp)
    if (proc != current) {
ffffffffc02042c2:	02a48c63          	beq	s1,a0,ffffffffc02042fa <proc_run+0x4c>
ffffffffc02042c6:	842a                	mv	s0,a0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02042c8:	100027f3          	csrr	a5,sstatus
ffffffffc02042cc:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc02042ce:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02042d0:	e3b1                	bnez	a5,ffffffffc0204314 <proc_run+0x66>
        lcr3(proc->cr3); // 修改页表项，完成进程间的页表切换
ffffffffc02042d2:	745c                	ld	a5,168(s0)
        current = proc; // 修改当前进程为新进程
ffffffffc02042d4:	00011717          	auipc	a4,0x11
ffffffffc02042d8:	1c873a23          	sd	s0,468(a4) # ffffffffc02154a8 <current>
...
ffffffffc02042dc:	80000737          	lui	a4,0x80000
ffffffffc02042e0:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc02042e4:	8fd9                	or	a5,a5,a4
ffffffffc02042e6:	18079073          	csrw	satp,a5
        switch_to(&(prev->context), &(next->context));
ffffffffc02042ea:	03040593          	addi	a1,s0,48
ffffffffc02042ee:	03048513          	addi	a0,s1,48
ffffffffc02042f2:	58c000ef          	jal	ra,ffffffffc020487e <switch_to>
    if (flag) {
ffffffffc02042f6:	00091863          	bnez	s2,ffffffffc0204306 <proc_run+0x58>
}
ffffffffc02042fa:	60e2                	ld	ra,24(sp)
ffffffffc02042fc:	6442                	ld	s0,16(sp)
ffffffffc02042fe:	64a2                	ld	s1,8(sp)
ffffffffc0204300:	6902                	ld	s2,0(sp)
ffffffffc0204302:	6105                	addi	sp,sp,32
ffffffffc0204304:	8082                	ret
ffffffffc0204306:	6442                	ld	s0,16(sp)
ffffffffc0204308:	60e2                	ld	ra,24(sp)
ffffffffc020430a:	64a2                	ld	s1,8(sp)
ffffffffc020430c:	6902                	ld	s2,0(sp)
ffffffffc020430e:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc0204310:	ac2fc06f          	j	ffffffffc02005d2 <intr_enable>
        intr_disable();
ffffffffc0204314:	ac4fc0ef          	jal	ra,ffffffffc02005d8 <intr_disable>
        return 1;
ffffffffc0204318:	4905                	li	s2,1
ffffffffc020431a:	bf65                	j	ffffffffc02042d2 <proc_run+0x24>

ffffffffc020431c <find_proc>:
    if (0 < pid && pid < MAX_PID) {
ffffffffc020431c:	0005071b          	sext.w	a4,a0
ffffffffc0204320:	6789                	lui	a5,0x2
ffffffffc0204322:	fff7069b          	addiw	a3,a4,-1
ffffffffc0204326:	17f9                	addi	a5,a5,-2
ffffffffc0204328:	04d7e063          	bltu	a5,a3,ffffffffc0204368 <find_proc+0x4c>
find_proc(int pid) {
ffffffffc020432c:	1141                	addi	sp,sp,-16
ffffffffc020432e:	e022                	sd	s0,0(sp)
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204330:	45a9                	li	a1,10
ffffffffc0204332:	842a                	mv	s0,a0
ffffffffc0204334:	853a                	mv	a0,a4
find_proc(int pid) {
ffffffffc0204336:	e406                	sd	ra,8(sp)
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204338:	67c000ef          	jal	ra,ffffffffc02049b4 <hash32>
ffffffffc020433c:	02051693          	slli	a3,a0,0x20
ffffffffc0204340:	82f1                	srli	a3,a3,0x1c
ffffffffc0204342:	0000d517          	auipc	a0,0xd
ffffffffc0204346:	11e50513          	addi	a0,a0,286 # ffffffffc0211460 <hash_list>
ffffffffc020434a:	96aa                	add	a3,a3,a0
ffffffffc020434c:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc020434e:	a029                	j	ffffffffc0204358 <find_proc+0x3c>
            if (proc->pid == pid) {
ffffffffc0204350:	f2c7a703          	lw	a4,-212(a5) # 1f2c <BASE_ADDRESS-0xffffffffc01fe0d4>
ffffffffc0204354:	00870c63          	beq	a4,s0,ffffffffc020436c <find_proc+0x50>
ffffffffc0204358:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020435a:	fef69be3          	bne	a3,a5,ffffffffc0204350 <find_proc+0x34>
}
ffffffffc020435e:	60a2                	ld	ra,8(sp)
ffffffffc0204360:	6402                	ld	s0,0(sp)
    return NULL;
ffffffffc0204362:	4501                	li	a0,0
}
...
ffffffffc020436c:	60a2                	ld	ra,8(sp)
ffffffffc020436e:	6402                	ld	s0,0(sp)
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0204370:	f2878513          	addi	a0,a5,-216
}
ffffffffc0204374:	0141                	addi	sp,sp,16
ffffffffc0204376:	8082                	ret

ffffffffc0204378 <do_fork>:
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204378:	7179                	addi	sp,sp,-48
ffffffffc020437a:	e84a                	sd	s2,16(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc020437c:	00011917          	auipc	s2,0x11
ffffffffc0204380:	14490913          	addi	s2,s2,324 # ffffffffc02154c0 <nr_process>
ffffffffc0204384:	00092703          	lw	a4,0(s2)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204388:	f406                	sd	ra,40(sp)
ffffffffc020438a:	f022                	sd	s0,32(sp)
ffffffffc020438c:	ec26                	sd	s1,24(sp)
ffffffffc020438e:	e44e                	sd	s3,8(sp)
ffffffffc0204390:	e052                	sd	s4,0(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204392:	6785                	lui	a5,0x1
ffffffffc0204394:	22f75763          	ble	a5,a4,ffffffffc02045c2 <do_fork+0x24a>
ffffffffc0204398:	89ae                	mv	s3,a1
ffffffffc020439a:	84b2                	mv	s1,a2
    proc = alloc_proc();
ffffffffc020439c:	e1fff0ef          	jal	ra,ffffffffc02041ba <alloc_proc>
ffffffffc02043a0:	842a                	mv	s0,a0
    if (proc == NULL)
ffffffffc02043a2:	22050263          	beqz	a0,ffffffffc02045c6 <do_fork+0x24e>
    proc->parent = current; // 设置子进程的父节点
ffffffffc02043a6:	00011a17          	auipc	s4,0x11
ffffffffc02043aa:	102a0a13          	addi	s4,s4,258 # ffffffffc02154a8 <current>
ffffffffc02043ae:	000a3783          	ld	a5,0(s4)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043b2:	4509                	li	a0,2
    proc->parent = current; // 设置子进程的父节点
ffffffffc02043b4:	f01c                	sd	a5,32(s0)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043b6:	fe0fd0ef          	jal	ra,ffffffffc0201b96 <alloc_pages>
    if (page != NULL) {
ffffffffc02043ba:	1e050f63          	beqz	a0,ffffffffc02045b8 <do_fork+0x240>
    return page - pages + nbase;
ffffffffc02043be:	00011797          	auipc	a5,0x11
ffffffffc02043c2:	14278793          	addi	a5,a5,322 # ffffffffc0215500 <pages>
ffffffffc02043c6:	6394                	ld	a3,0(a5)
ffffffffc02043c8:	00003797          	auipc	a5,0x3
ffffffffc02043cc:	bd878793          	addi	a5,a5,-1064 # ffffffffc0206fa0 <nbase>
    return KADDR(page2pa(page));
ffffffffc02043d0:	00011717          	auipc	a4,0x11
ffffffffc02043d4:	0c070713          	addi	a4,a4,192 # ffffffffc0215490 <npage>
    return page - pages + nbase;
ffffffffc02043d8:	40d506b3          	sub	a3,a0,a3
ffffffffc02043dc:	6388                	ld	a0,0(a5)
ffffffffc02043de:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc02043e0:	57fd                	li	a5,-1
ffffffffc02043e2:	6318                	ld	a4,0(a4)
    return page - pages + nbase;
ffffffffc02043e4:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc02043e6:	83b1                	srli	a5,a5,0xc
ffffffffc02043e8:	8ff5                	and	a5,a5,a3
    return page2ppn(page) << PGSHIFT;
ffffffffc02043ea:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043ec:	1ee7ff63          	bleu	a4,a5,ffffffffc02045ea <do_fork+0x272>
    assert(current->mm == NULL);
ffffffffc02043f0:	000a3783          	ld	a5,0(s4)
ffffffffc02043f4:	00011717          	auipc	a4,0x11
ffffffffc02043f8:	0fc70713          	addi	a4,a4,252 # ffffffffc02154f0 <va_pa_offset>
ffffffffc02043fc:	6318                	ld	a4,0(a4)
ffffffffc02043fe:	779c                	ld	a5,40(a5)
ffffffffc0204400:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc0204402:	e814                	sd	a3,16(s0)
    assert(current->mm == NULL);
ffffffffc0204404:	1c079363          	bnez	a5,ffffffffc02045ca <do_fork+0x252>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204408:	6789                	lui	a5,0x2
ffffffffc020440a:	ee078793          	addi	a5,a5,-288 # 1ee0 <BASE_ADDRESS-0xffffffffc01fe120>
ffffffffc020440e:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc0204410:	8626                	mv	a2,s1
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204412:	f054                	sd	a3,160(s0)
    *(proc->tf) = *tf;
ffffffffc0204414:	87b6                	mv	a5,a3
ffffffffc0204416:	12048893          	addi	a7,s1,288
...
ffffffffc0204436:	ff1612e3          	bne	a2,a7,ffffffffc020441a <do_fork+0xa2>
    proc->tf->gpr.a0 = 0;
ffffffffc020443a:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020443e:	10098e63          	beqz	s3,ffffffffc020455a <do_fork+0x1e2>
ffffffffc0204442:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204446:	00000797          	auipc	a5,0x0
ffffffffc020444a:	dac78793          	addi	a5,a5,-596 # ffffffffc02041f2 <forkret>
ffffffffc020444e:	f81c                	sd	a5,48(s0)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204450:	fc14                	sd	a3,56(s0)
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0204458:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020445a:	10079f63          	bnez	a5,ffffffffc0204578 <do_fork+0x200>
    if (++ last_pid >= MAX_PID) {
ffffffffc020445e:	00006797          	auipc	a5,0x6
ffffffffc0204462:	bfa78793          	addi	a5,a5,-1030 # ffffffffc020a058 <last_pid.1575>
ffffffffc0204466:	439c                	lw	a5,0(a5)
ffffffffc0204468:	6709                	lui	a4,0x2
ffffffffc020446a:	0017851b          	addiw	a0,a5,1
ffffffffc020446e:	00006697          	auipc	a3,0x6
ffffffffc0204472:	bea6a523          	sw	a0,-1046(a3) # ffffffffc020a058 <last_pid.1575>
ffffffffc0204476:	12e55263          	ble	a4,a0,ffffffffc020459a <do_fork+0x222>
    if (last_pid >= next_safe) {
ffffffffc020447a:	00006797          	auipc	a5,0x6
ffffffffc020447e:	be278793          	addi	a5,a5,-1054 # ffffffffc020a05c <next_safe.1574>
ffffffffc0204482:	439c                	lw	a5,0(a5)
ffffffffc0204484:	00011497          	auipc	s1,0x11
ffffffffc0204488:	16448493          	addi	s1,s1,356 # ffffffffc02155e8 <proc_list>
ffffffffc020448c:	06f54063          	blt	a0,a5,ffffffffc02044ec <do_fork+0x174>
        next_safe = MAX_PID;
ffffffffc0204490:	6789                	lui	a5,0x2
ffffffffc0204492:	00006717          	auipc	a4,0x6
ffffffffc0204496:	bcf72523          	sw	a5,-1078(a4) # ffffffffc020a05c <next_safe.1574>
ffffffffc020449a:	4581                	li	a1,0
ffffffffc020449c:	87aa                	mv	a5,a0
ffffffffc020449e:	00011497          	auipc	s1,0x11
ffffffffc02044a2:	14a48493          	addi	s1,s1,330 # ffffffffc02155e8 <proc_list>
    repeat:
ffffffffc02044a6:	6889                	lui	a7,0x2
ffffffffc02044a8:	882e                	mv	a6,a1
ffffffffc02044aa:	6609                	lui	a2,0x2
        le = list;
ffffffffc02044ac:	00011697          	auipc	a3,0x11
ffffffffc02044b0:	13c68693          	addi	a3,a3,316 # ffffffffc02155e8 <proc_list>
ffffffffc02044b4:	6694                	ld	a3,8(a3)
        while ((le = list_next(le)) != list) {
ffffffffc02044b6:	00968f63          	beq	a3,s1,ffffffffc02044d4 <do_fork+0x15c>
            if (proc->pid == last_pid) {
ffffffffc02044ba:	f3c6a703          	lw	a4,-196(a3)
ffffffffc02044be:	08e78963          	beq	a5,a4,ffffffffc0204550 <do_fork+0x1d8>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02044c2:	fee7d9e3          	ble	a4,a5,ffffffffc02044b4 <do_fork+0x13c>
ffffffffc02044c6:	fec757e3          	ble	a2,a4,ffffffffc02044b4 <do_fork+0x13c>
ffffffffc02044ca:	6694                	ld	a3,8(a3)
ffffffffc02044cc:	863a                	mv	a2,a4
ffffffffc02044ce:	4805                	li	a6,1
        while ((le = list_next(le)) != list) {
ffffffffc02044d0:	fe9695e3          	bne	a3,s1,ffffffffc02044ba <do_fork+0x142>
ffffffffc02044d4:	c591                	beqz	a1,ffffffffc02044e0 <do_fork+0x168>
ffffffffc02044d6:	00006717          	auipc	a4,0x6
ffffffffc02044da:	b8f72123          	sw	a5,-1150(a4) # ffffffffc020a058 <last_pid.1575>
ffffffffc02044de:	853e                	mv	a0,a5
ffffffffc02044e0:	00080663          	beqz	a6,ffffffffc02044ec <do_fork+0x174>
ffffffffc02044e4:	00006797          	auipc	a5,0x6
ffffffffc02044e8:	b6c7ac23          	sw	a2,-1160(a5) # ffffffffc020a05c <next_safe.1574>
    proc->pid = get_pid();
ffffffffc02044ec:	c048                	sw	a0,4(s0)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc02044ee:	45a9                	li	a1,10
ffffffffc02044f0:	2501                	sext.w	a0,a0
ffffffffc02044f2:	4c2000ef          	jal	ra,ffffffffc02049b4 <hash32>
ffffffffc02044f6:	1502                	slli	a0,a0,0x20
ffffffffc02044f8:	0000d797          	auipc	a5,0xd
ffffffffc02044fc:	f6878793          	addi	a5,a5,-152 # ffffffffc0211460 <hash_list>
ffffffffc0204500:	8171                	srli	a0,a0,0x1c
ffffffffc0204502:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0204504:	6510                	ld	a2,8(a0)
ffffffffc0204506:	0d840793          	addi	a5,s0,216
ffffffffc020450a:	6494                	ld	a3,8(s1)
    nr_process ++;
ffffffffc020450c:	00092703          	lw	a4,0(s2)
    prev->next = next->prev = elm;
ffffffffc0204510:	e21c                	sd	a5,0(a2)
ffffffffc0204512:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc0204514:	f070                	sd	a2,224(s0)
    list_add(&proc_list, &(proc->list_link));
ffffffffc0204516:	0c840793          	addi	a5,s0,200
    elm->prev = prev;
ffffffffc020451a:	ec68                	sd	a0,216(s0)
    prev->next = next->prev = elm;
ffffffffc020451c:	e29c                	sd	a5,0(a3)
    nr_process ++;
ffffffffc020451e:	2705                	addiw	a4,a4,1
ffffffffc0204520:	00011617          	auipc	a2,0x11
ffffffffc0204524:	0cf63823          	sd	a5,208(a2) # ffffffffc02155f0 <proc_list+0x8>
    elm->next = next;
ffffffffc0204528:	e874                	sd	a3,208(s0)
    elm->prev = prev;
ffffffffc020452a:	e464                	sd	s1,200(s0)
ffffffffc020452c:	00011797          	auipc	a5,0x11
ffffffffc0204530:	f8e7aa23          	sw	a4,-108(a5) # ffffffffc02154c0 <nr_process>
    if (flag) {
ffffffffc0204534:	06099a63          	bnez	s3,ffffffffc02045a8 <do_fork+0x230>
    wakeup_proc(proc);
ffffffffc0204538:	8522                	mv	a0,s0
ffffffffc020453a:	3ae000ef          	jal	ra,ffffffffc02048e8 <wakeup_proc>
    ret = proc->pid;
ffffffffc020453e:	4048                	lw	a0,4(s0)
}
ffffffffc0204540:	70a2                	ld	ra,40(sp)
ffffffffc0204542:	7402                	ld	s0,32(sp)
ffffffffc0204544:	64e2                	ld	s1,24(sp)
ffffffffc0204546:	6942                	ld	s2,16(sp)
ffffffffc0204548:	69a2                	ld	s3,8(sp)
ffffffffc020454a:	6a02                	ld	s4,0(sp)
ffffffffc020454c:	6145                	addi	sp,sp,48
ffffffffc020454e:	8082                	ret
                if (++ last_pid >= next_safe) {
ffffffffc0204550:	2785                	addiw	a5,a5,1
ffffffffc0204552:	04c7de63          	ble	a2,a5,ffffffffc02045ae <do_fork+0x236>
ffffffffc0204556:	4585                	li	a1,1
ffffffffc0204558:	bfb1                	j	ffffffffc02044b4 <do_fork+0x13c>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020455a:	89b6                	mv	s3,a3
ffffffffc020455c:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204560:	00000797          	auipc	a5,0x0
ffffffffc0204564:	c9278793          	addi	a5,a5,-878 # ffffffffc02041f2 <forkret>
ffffffffc0204568:	f81c                	sd	a5,48(s0)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc020456a:	fc14                	sd	a3,56(s0)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020456c:	100027f3          	csrr	a5,sstatus
ffffffffc0204570:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204572:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204574:	ee0785e3          	beqz	a5,ffffffffc020445e <do_fork+0xe6>
        intr_disable();
ffffffffc0204578:	860fc0ef          	jal	ra,ffffffffc02005d8 <intr_disable>
    if (++ last_pid >= MAX_PID) {
ffffffffc020457c:	00006797          	auipc	a5,0x6
ffffffffc0204580:	adc78793          	addi	a5,a5,-1316 # ffffffffc020a058 <last_pid.1575>
ffffffffc0204584:	439c                	lw	a5,0(a5)
ffffffffc0204586:	6709                	lui	a4,0x2
        return 1;
ffffffffc0204588:	4985                	li	s3,1
ffffffffc020458a:	0017851b          	addiw	a0,a5,1
ffffffffc020458e:	00006697          	auipc	a3,0x6
ffffffffc0204592:	aca6a523          	sw	a0,-1334(a3) # ffffffffc020a058 <last_pid.1575>
ffffffffc0204596:	eee542e3          	blt	a0,a4,ffffffffc020447a <do_fork+0x102>
        last_pid = 1;
ffffffffc020459a:	4785                	li	a5,1
ffffffffc020459c:	00006717          	auipc	a4,0x6
ffffffffc02045a0:	aaf72e23          	sw	a5,-1348(a4) # ffffffffc020a058 <last_pid.1575>
ffffffffc02045a4:	4505                	li	a0,1
ffffffffc02045a6:	b5ed                	j	ffffffffc0204490 <do_fork+0x118>
        intr_enable();
ffffffffc02045a8:	82afc0ef          	jal	ra,ffffffffc02005d2 <intr_enable>
ffffffffc02045ac:	b771                	j	ffffffffc0204538 <do_fork+0x1c0>
                    if (last_pid >= MAX_PID) {
ffffffffc02045ae:	0117c363          	blt	a5,a7,ffffffffc02045b4 <do_fork+0x23c>
                        last_pid = 1;
ffffffffc02045b2:	4785                	li	a5,1
                    goto repeat;
ffffffffc02045b4:	4585                	li	a1,1
ffffffffc02045b6:	bdcd                	j	ffffffffc02044a8 <do_fork+0x130>
    kfree(proc);
ffffffffc02045b8:	8522                	mv	a0,s0
ffffffffc02045ba:	c9cfd0ef          	jal	ra,ffffffffc0201a56 <kfree>
    ret = -E_NO_MEM;
ffffffffc02045be:	5571                	li	a0,-4
    goto fork_out;
ffffffffc02045c0:	b741                	j	ffffffffc0204540 <do_fork+0x1c8>
    int ret = -E_NO_FREE_PROC;
ffffffffc02045c2:	556d                	li	a0,-5
ffffffffc02045c4:	bfb5                	j	ffffffffc0204540 <do_fork+0x1c8>
    ret = -E_NO_MEM;
ffffffffc02045c6:	5571                	li	a0,-4
ffffffffc02045c8:	bfa5                	j	ffffffffc0204540 <do_fork+0x1c8>
    assert(current->mm == NULL);
ffffffffc02045ca:	00002697          	auipc	a3,0x2
ffffffffc02045ce:	5f668693          	addi	a3,a3,1526 # ffffffffc0206bc0 <default_pmm_manager+0xfc8>
ffffffffc02045d2:	00001617          	auipc	a2,0x1
ffffffffc02045d6:	28e60613          	addi	a2,a2,654 # ffffffffc0205860 <commands+0x870>
ffffffffc02045da:	0fe00593          	li	a1,254
ffffffffc02045de:	00002517          	auipc	a0,0x2
ffffffffc02045e2:	5fa50513          	addi	a0,a0,1530 # ffffffffc0206bd8 <default_pmm_manager+0xfe0>
ffffffffc02045e6:	e6bfb0ef          	jal	ra,ffffffffc0200450 <__panic>
ffffffffc02045ea:	00001617          	auipc	a2,0x1
ffffffffc02045ee:	65e60613          	addi	a2,a2,1630 # ffffffffc0205c48 <default_pmm_manager+0x50>
ffffffffc02045f2:	06900593          	li	a1,105
ffffffffc02045f6:	00001517          	auipc	a0,0x1
ffffffffc02045fa:	67a50513          	addi	a0,a0,1658 # ffffffffc0205c70 <default_pmm_manager+0x78>
ffffffffc02045fe:	e53fb0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc0204602 <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0204602:	7129                	addi	sp,sp,-320
ffffffffc0204604:	fa22                	sd	s0,304(sp)
ffffffffc0204606:	f626                	sd	s1,296(sp)
ffffffffc0204608:	f24a                	sd	s2,288(sp)
ffffffffc020460a:	84ae                	mv	s1,a1
ffffffffc020460c:	892a                	mv	s2,a0
ffffffffc020460e:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204610:	4581                	li	a1,0
ffffffffc0204612:	12000613          	li	a2,288
ffffffffc0204616:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0204618:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020461a:	049000ef          	jal	ra,ffffffffc0204e62 <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc020461e:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc0204620:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc0204622:	100027f3          	csrr	a5,sstatus
ffffffffc0204626:	edd7f793          	andi	a5,a5,-291
ffffffffc020462a:	1207e793          	ori	a5,a5,288
ffffffffc020462e:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204630:	860a                	mv	a2,sp
ffffffffc0204632:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0204636:	00000797          	auipc	a5,0x0
ffffffffc020463a:	b7c78793          	addi	a5,a5,-1156 # ffffffffc02041b2 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020463e:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0204640:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204642:	d37ff0ef          	jal	ra,ffffffffc0204378 <do_fork>
}
ffffffffc0204646:	70f2                	ld	ra,312(sp)
ffffffffc0204648:	7452                	ld	s0,304(sp)
ffffffffc020464a:	74b2                	ld	s1,296(sp)
ffffffffc020464c:	7912                	ld	s2,288(sp)
ffffffffc020464e:	6131                	addi	sp,sp,320
ffffffffc0204650:	8082                	ret

ffffffffc0204652 <do_exit>:
do_exit(int error_code) {
ffffffffc0204652:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc0204654:	00002617          	auipc	a2,0x2
ffffffffc0204658:	55460613          	addi	a2,a2,1364 # ffffffffc0206ba8 <default_pmm_manager+0xfb0>
ffffffffc020465c:	16300593          	li	a1,355
ffffffffc0204660:	00002517          	auipc	a0,0x2
ffffffffc0204664:	57850513          	addi	a0,a0,1400 # ffffffffc0206bd8 <default_pmm_manager+0xfe0>
do_exit(int error_code) {
ffffffffc0204668:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc020466a:	de7fb0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc020466e <proc_init>:
    elm->prev = elm->next = elm;
ffffffffc020466e:	00011797          	auipc	a5,0x11
ffffffffc0204672:	f7a78793          	addi	a5,a5,-134 # ffffffffc02155e8 <proc_list>

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc0204676:	1101                	addi	sp,sp,-32
ffffffffc0204678:	00011717          	auipc	a4,0x11
ffffffffc020467c:	f6f73c23          	sd	a5,-136(a4) # ffffffffc02155f0 <proc_list+0x8>
ffffffffc0204680:	00011717          	auipc	a4,0x11
ffffffffc0204684:	f6f73423          	sd	a5,-152(a4) # ffffffffc02155e8 <proc_list>
ffffffffc0204688:	ec06                	sd	ra,24(sp)
ffffffffc020468a:	e822                	sd	s0,16(sp)
ffffffffc020468c:	e426                	sd	s1,8(sp)
ffffffffc020468e:	e04a                	sd	s2,0(sp)
ffffffffc0204690:	0000d797          	auipc	a5,0xd
ffffffffc0204694:	dd078793          	addi	a5,a5,-560 # ffffffffc0211460 <hash_list>
ffffffffc0204698:	00011717          	auipc	a4,0x11
ffffffffc020469c:	dc870713          	addi	a4,a4,-568 # ffffffffc0215460 <name.1565>
ffffffffc02046a0:	e79c                	sd	a5,8(a5)
ffffffffc02046a2:	e39c                	sd	a5,0(a5)
ffffffffc02046a4:	07c1                	addi	a5,a5,16
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc02046a6:	fee79de3          	bne	a5,a4,ffffffffc02046a0 <proc_init+0x32>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc02046aa:	b11ff0ef          	jal	ra,ffffffffc02041ba <alloc_proc>
ffffffffc02046ae:	00011797          	auipc	a5,0x11
ffffffffc02046b2:	e0a7b123          	sd	a0,-510(a5) # ffffffffc02154b0 <idleproc>
ffffffffc02046b6:	00011417          	auipc	s0,0x11
ffffffffc02046ba:	dfa40413          	addi	s0,s0,-518 # ffffffffc02154b0 <idleproc>
ffffffffc02046be:	12050a63          	beqz	a0,ffffffffc02047f2 <proc_init+0x184>
        panic("cannot alloc idleproc.\n");
    }

    // check the proc structure
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc02046c2:	07000513          	li	a0,112
ffffffffc02046c6:	ad4fd0ef          	jal	ra,ffffffffc020199a <kmalloc>
...
ffffffffc02046d0:	84aa                	mv	s1,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046d2:	790000ef          	jal	ra,ffffffffc0204e62 <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc02046d6:	6008                	ld	a0,0(s0)
ffffffffc02046d8:	85a6                	mv	a1,s1
ffffffffc02046da:	07000613          	li	a2,112
ffffffffc02046de:	03050513          	addi	a0,a0,48
ffffffffc02046e2:	7aa000ef          	jal	ra,ffffffffc0204e8c <memcmp>
ffffffffc02046e6:	892a                	mv	s2,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc02046e8:	453d                	li	a0,15
ffffffffc02046ea:	ab0fd0ef          	jal	ra,ffffffffc020199a <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02046ee:	463d                	li	a2,15
ffffffffc02046f0:	4581                	li	a1,0
    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc02046f2:	84aa                	mv	s1,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02046f4:	76e000ef          	jal	ra,ffffffffc0204e62 <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc02046f8:	6008                	ld	a0,0(s0)
ffffffffc02046fa:	463d                	li	a2,15
ffffffffc02046fc:	85a6                	mv	a1,s1
ffffffffc02046fe:	0b450513          	addi	a0,a0,180
ffffffffc0204702:	78a000ef          	jal	ra,ffffffffc0204e8c <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204706:	601c                	ld	a5,0(s0)
ffffffffc0204708:	00011717          	auipc	a4,0x11
ffffffffc020470c:	df070713          	addi	a4,a4,-528 # ffffffffc02154f8 <boot_cr3>
ffffffffc0204710:	6318                	ld	a4,0(a4)
ffffffffc0204712:	77d4                	ld	a3,168(a5)
ffffffffc0204714:	08e68e63          	beq	a3,a4,ffffffffc02047b0 <proc_init+0x142>
...
ffffffffc0204718:	4709                	li	a4,2
ffffffffc020471a:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc020471c:	00003717          	auipc	a4,0x3
ffffffffc0204720:	8e470713          	addi	a4,a4,-1820 # ffffffffc0207000 <bootstack>
...
ffffffffc020472e:	54e58593          	addi	a1,a1,1358 # ffffffffc0206c78 <default_pmm_manager+0x1080>
ffffffffc0204732:	853e                	mv	a0,a5
ffffffffc0204734:	acfff0ef          	jal	ra,ffffffffc0204202 <set_proc_name>
    nr_process ++;
ffffffffc0204738:	00011797          	auipc	a5,0x11
ffffffffc020473c:	d8878793          	addi	a5,a5,-632 # ffffffffc02154c0 <nr_process>
ffffffffc0204740:	439c                	lw	a5,0(a5)

    current = idleproc;
ffffffffc0204742:	6018                	ld	a4,0(s0)
...
ffffffffc020474c:	53858593          	addi	a1,a1,1336 # ffffffffc0206c80 <default_pmm_manager+0x1088>
ffffffffc0204750:	00000517          	auipc	a0,0x0
ffffffffc0204754:	b0c50513          	addi	a0,a0,-1268 # ffffffffc020425c <init_main>
    nr_process ++;
ffffffffc0204758:	00011697          	auipc	a3,0x11
ffffffffc020475c:	d6f6a423          	sw	a5,-664(a3) # ffffffffc02154c0 <nr_process>
    current = idleproc;
ffffffffc0204760:	00011797          	auipc	a5,0x11
ffffffffc0204764:	d4e7b423          	sd	a4,-696(a5) # ffffffffc02154a8 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204768:	e9bff0ef          	jal	ra,ffffffffc0204602 <kernel_thread>
    if (pid <= 0) {
ffffffffc020476c:	0ca05f63          	blez	a0,ffffffffc020484a <proc_init+0x1dc>
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0204770:	badff0ef          	jal	ra,ffffffffc020431c <find_proc>
    set_proc_name(initproc, "init");
ffffffffc0204774:	00002597          	auipc	a1,0x2
ffffffffc0204778:	53c58593          	addi	a1,a1,1340 # ffffffffc0206cb0 <default_pmm_manager+0x10b8>
    initproc = find_proc(pid);
ffffffffc020477c:	00011797          	auipc	a5,0x11
ffffffffc0204780:	d2a7be23          	sd	a0,-708(a5) # ffffffffc02154b8 <initproc>
    set_proc_name(initproc, "init");
ffffffffc0204784:	a7fff0ef          	jal	ra,ffffffffc0204202 <set_proc_name>

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204788:	601c                	ld	a5,0(s0)
ffffffffc020478a:	c3c5                	beqz	a5,ffffffffc020482a <proc_init+0x1bc>
ffffffffc020478c:	43dc                	lw	a5,4(a5)
ffffffffc020478e:	efd1                	bnez	a5,ffffffffc020482a <proc_init+0x1bc>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204790:	00011797          	auipc	a5,0x11
ffffffffc0204794:	d2878793          	addi	a5,a5,-728 # ffffffffc02154b8 <initproc>
ffffffffc0204798:	639c                	ld	a5,0(a5)
ffffffffc020479a:	cba5                	beqz	a5,ffffffffc020480a <proc_init+0x19c>
ffffffffc020479c:	43d8                	lw	a4,4(a5)
ffffffffc020479e:	4785                	li	a5,1
ffffffffc02047a0:	06f71563          	bne	a4,a5,ffffffffc020480a <proc_init+0x19c>
}
ffffffffc02047a4:	60e2                	ld	ra,24(sp)
ffffffffc02047a6:	6442                	ld	s0,16(sp)
ffffffffc02047a8:	64a2                	ld	s1,8(sp)
ffffffffc02047aa:	6902                	ld	s2,0(sp)
ffffffffc02047ac:	6105                	addi	sp,sp,32
ffffffffc02047ae:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc02047b0:	73d8                	ld	a4,160(a5)
ffffffffc02047b2:	f33d                	bnez	a4,ffffffffc0204718 <proc_init+0xaa>
ffffffffc02047b4:	f60912e3          	bnez	s2,ffffffffc0204718 <proc_init+0xaa>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc02047b8:	6394                	ld	a3,0(a5)
ffffffffc02047ba:	577d                	li	a4,-1
ffffffffc02047bc:	1702                	slli	a4,a4,0x20
ffffffffc02047be:	f4e69de3          	bne	a3,a4,ffffffffc0204718 <proc_init+0xaa>
ffffffffc02047c2:	4798                	lw	a4,8(a5)
ffffffffc02047c4:	fb31                	bnez	a4,ffffffffc0204718 <proc_init+0xaa>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc02047c6:	6b98                	ld	a4,16(a5)
ffffffffc02047c8:	fb21                	bnez	a4,ffffffffc0204718 <proc_init+0xaa>
ffffffffc02047ca:	4f98                	lw	a4,24(a5)
ffffffffc02047cc:	2701                	sext.w	a4,a4
ffffffffc02047ce:	f729                	bnez	a4,ffffffffc0204718 <proc_init+0xaa>
ffffffffc02047d0:	7398                	ld	a4,32(a5)
ffffffffc02047d2:	f339                	bnez	a4,ffffffffc0204718 <proc_init+0xaa>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc02047d4:	7798                	ld	a4,40(a5)
ffffffffc02047d6:	f329                	bnez	a4,ffffffffc0204718 <proc_init+0xaa>
ffffffffc02047d8:	0b07a703          	lw	a4,176(a5)
ffffffffc02047dc:	8f49                	or	a4,a4,a0
ffffffffc02047de:	2701                	sext.w	a4,a4
ffffffffc02047e0:	ff05                	bnez	a4,ffffffffc0204718 <proc_init+0xaa>
        cprintf("alloc_proc() correct!\n");
ffffffffc02047e2:	00002517          	auipc	a0,0x2
ffffffffc02047e6:	47e50513          	addi	a0,a0,1150 # ffffffffc0206c60 <default_pmm_manager+0x1068>
ffffffffc02047ea:	9a5fb0ef          	jal	ra,ffffffffc020018e <cprintf>
ffffffffc02047ee:	601c                	ld	a5,0(s0)
ffffffffc02047f0:	b725                	j	ffffffffc0204718 <proc_init+0xaa>
        panic("cannot alloc idleproc.\n");
ffffffffc02047f2:	00002617          	auipc	a2,0x2
ffffffffc02047f6:	45660613          	addi	a2,a2,1110 # ffffffffc0206c48 <default_pmm_manager+0x1050>
ffffffffc02047fa:	17b00593          	li	a1,379
ffffffffc02047fe:	00002517          	auipc	a0,0x2
ffffffffc0204802:	3da50513          	addi	a0,a0,986 # ffffffffc0206bd8 <default_pmm_manager+0xfe0>
ffffffffc0204806:	c4bfb0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc020480a:	00002697          	auipc	a3,0x2
ffffffffc020480e:	4d668693          	addi	a3,a3,1238 # ffffffffc0206ce0 <default_pmm_manager+0x10e8>
ffffffffc0204812:	00001617          	auipc	a2,0x1
ffffffffc0204816:	04e60613          	addi	a2,a2,78 # ffffffffc0205860 <commands+0x870>
ffffffffc020481a:	1a200593          	li	a1,418
ffffffffc020481e:	00002517          	auipc	a0,0x2
ffffffffc0204822:	3ba50513          	addi	a0,a0,954 # ffffffffc0206bd8 <default_pmm_manager+0xfe0>
ffffffffc0204826:	c2bfb0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020482a:	00002697          	auipc	a3,0x2
ffffffffc020482e:	48e68693          	addi	a3,a3,1166 # ffffffffc0206cb8 <default_pmm_manager+0x10c0>
ffffffffc0204832:	00001617          	auipc	a2,0x1
ffffffffc0204836:	02e60613          	addi	a2,a2,46 # ffffffffc0205860 <commands+0x870>
ffffffffc020483a:	1a100593          	li	a1,417
ffffffffc020483e:	00002517          	auipc	a0,0x2
ffffffffc0204842:	39a50513          	addi	a0,a0,922 # ffffffffc0206bd8 <default_pmm_manager+0xfe0>
ffffffffc0204846:	c0bfb0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("create init_main failed.\n");
ffffffffc020484a:	00002617          	auipc	a2,0x2
ffffffffc020484e:	44660613          	addi	a2,a2,1094 # ffffffffc0206c90 <default_pmm_manager+0x1098>
ffffffffc0204852:	19b00593          	li	a1,411
ffffffffc0204856:	00002517          	auipc	a0,0x2
ffffffffc020485a:	38250513          	addi	a0,a0,898 # ffffffffc0206bd8 <default_pmm_manager+0xfe0>
ffffffffc020485e:	bf3fb0ef          	jal	ra,ffffffffc0200450 <__panic>
...
ffffffffc020486c:	c4040413          	addi	s0,s0,-960 # ffffffffc02154a8 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0204870:	6018                	ld	a4,0(s0)
ffffffffc0204872:	4f1c                	lw	a5,24(a4)
ffffffffc0204874:	2781                	sext.w	a5,a5
ffffffffc0204876:	dff5                	beqz	a5,ffffffffc0204872 <cpu_idle+0x10>
            schedule();
ffffffffc0204878:	0a2000ef          	jal	ra,ffffffffc020491a <schedule>
ffffffffc020487c:	bfd5                	j	ffffffffc0204870 <cpu_idle+0xe>

ffffffffc020487e <switch_to>:
.text
...
ffffffffc020487e:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0204882:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0204886:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0204888:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc020488a:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc020488e:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0204892:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0204896:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc020489a:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc020489e:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc02048a2:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc02048a6:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc02048aa:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc02048ae:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc02048b2:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc02048b6:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc02048ba:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc02048bc:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc02048be:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc02048c2:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc02048c6:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc02048ca:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc02048ce:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc02048d2:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc02048d6:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc02048da:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc02048de:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc02048e2:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc02048e6:	8082                	ret

ffffffffc02048e8 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc02048e8:	411c                	lw	a5,0(a0)
ffffffffc02048ea:	4705                	li	a4,1
ffffffffc02048ec:	37f9                	addiw	a5,a5,-2
ffffffffc02048ee:	00f77563          	bleu	a5,a4,ffffffffc02048f8 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc02048f2:	4789                	li	a5,2
ffffffffc02048f4:	c11c                	sw	a5,0(a0)
ffffffffc02048f6:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc02048f8:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02048fa:	00002697          	auipc	a3,0x2
ffffffffc02048fe:	40e68693          	addi	a3,a3,1038 # ffffffffc0206d08 <default_pmm_manager+0x1110>
ffffffffc0204902:	00001617          	auipc	a2,0x1
ffffffffc0204906:	f5e60613          	addi	a2,a2,-162 # ffffffffc0205860 <commands+0x870>
ffffffffc020490a:	45a5                	li	a1,9
ffffffffc020490c:	00002517          	auipc	a0,0x2
ffffffffc0204910:	43c50513          	addi	a0,a0,1084 # ffffffffc0206d48 <default_pmm_manager+0x1150>
wakeup_proc(struct proc_struct *proc) {
ffffffffc0204914:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0204916:	b3bfb0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc020491a <schedule>:
}

void
schedule(void) {
ffffffffc020491a:	1141                	addi	sp,sp,-16
ffffffffc020491c:	e406                	sd	ra,8(sp)
ffffffffc020491e:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204920:	100027f3          	csrr	a5,sstatus
ffffffffc0204924:	8b89                	andi	a5,a5,2
ffffffffc0204926:	4401                	li	s0,0
ffffffffc0204928:	e3d1                	bnez	a5,ffffffffc02049ac <schedule+0x92>
    bool intr_flag;
...
ffffffffc020492e:	b7e78793          	addi	a5,a5,-1154 # ffffffffc02154a8 <current>
ffffffffc0204932:	0007b883          	ld	a7,0(a5)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204936:	00011797          	auipc	a5,0x11
ffffffffc020493a:	b7a78793          	addi	a5,a5,-1158 # ffffffffc02154b0 <idleproc>
ffffffffc020493e:	6388                	ld	a0,0(a5)
        current->need_resched = 0;
ffffffffc0204940:	0008ac23          	sw	zero,24(a7) # 2018 <BASE_ADDRESS-0xffffffffc01fdfe8>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204944:	04a88e63          	beq	a7,a0,ffffffffc02049a0 <schedule+0x86>
ffffffffc0204948:	0c888693          	addi	a3,a7,200
ffffffffc020494c:	00011617          	auipc	a2,0x11
ffffffffc0204950:	c9c60613          	addi	a2,a2,-868 # ffffffffc02155e8 <proc_list>
        le = last;
ffffffffc0204954:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc0204958:	4809                	li	a6,2
    return listelm->next;
ffffffffc020495a:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc020495c:	00c78863          	beq	a5,a2,ffffffffc020496c <schedule+0x52>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204960:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0204964:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204968:	01070463          	beq	a4,a6,ffffffffc0204970 <schedule+0x56>
                    break;
                }
            }
        } while (le != last);
ffffffffc020496c:	fef697e3          	bne	a3,a5,ffffffffc020495a <schedule+0x40>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204970:	c589                	beqz	a1,ffffffffc020497a <schedule+0x60>
ffffffffc0204972:	4198                	lw	a4,0(a1)
ffffffffc0204974:	4789                	li	a5,2
ffffffffc0204976:	00f70e63          	beq	a4,a5,ffffffffc0204992 <schedule+0x78>
            next = idleproc;
        }
        next->runs ++;
ffffffffc020497a:	451c                	lw	a5,8(a0)
ffffffffc020497c:	2785                	addiw	a5,a5,1
ffffffffc020497e:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0204980:	00a88463          	beq	a7,a0,ffffffffc0204988 <schedule+0x6e>
            proc_run(next);
ffffffffc0204984:	92bff0ef          	jal	ra,ffffffffc02042ae <proc_run>
    if (flag) {
ffffffffc0204988:	e419                	bnez	s0,ffffffffc0204996 <schedule+0x7c>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc020498a:	60a2                	ld	ra,8(sp)
ffffffffc020498c:	6402                	ld	s0,0(sp)
ffffffffc020498e:	0141                	addi	sp,sp,16
ffffffffc0204990:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204992:	852e                	mv	a0,a1
ffffffffc0204994:	b7dd                	j	ffffffffc020497a <schedule+0x60>
}
ffffffffc0204996:	6402                	ld	s0,0(sp)
ffffffffc0204998:	60a2                	ld	ra,8(sp)
ffffffffc020499a:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc020499c:	c37fb06f          	j	ffffffffc02005d2 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049a0:	00011617          	auipc	a2,0x11
ffffffffc02049a4:	c4860613          	addi	a2,a2,-952 # ffffffffc02155e8 <proc_list>
ffffffffc02049a8:	86b2                	mv	a3,a2
ffffffffc02049aa:	b76d                	j	ffffffffc0204954 <schedule+0x3a>
        intr_disable();
ffffffffc02049ac:	c2dfb0ef          	jal	ra,ffffffffc02005d8 <intr_disable>
        return 1;
ffffffffc02049b0:	4405                	li	s0,1
ffffffffc02049b2:	bfa5                	j	ffffffffc020492a <schedule+0x10>

ffffffffc02049b4 <hash32>:
 *
...
ffffffffc02049b4:	9e3707b7          	lui	a5,0x9e370
ffffffffc02049b8:	2785                	addiw	a5,a5,1
ffffffffc02049ba:	02f5053b          	mulw	a0,a0,a5
    return (hash >> (32 - bits));
ffffffffc02049be:	02000793          	li	a5,32
ffffffffc02049c2:	40b785bb          	subw	a1,a5,a1
}
ffffffffc02049c6:	00b5553b          	srlw	a0,a0,a1
ffffffffc02049ca:	8082                	ret

ffffffffc02049cc <printnum>:
 * */
static void
...
ffffffffc02049cc:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049d0:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc02049d2:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049d6:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc02049d8:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049dc:	f022                	sd	s0,32(sp)
ffffffffc02049de:	ec26                	sd	s1,24(sp)
ffffffffc02049e0:	e84a                	sd	s2,16(sp)
ffffffffc02049e2:	f406                	sd	ra,40(sp)
ffffffffc02049e4:	e44e                	sd	s3,8(sp)
ffffffffc02049e6:	84aa                	mv	s1,a0
ffffffffc02049e8:	892e                	mv	s2,a1
ffffffffc02049ea:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc02049ee:	2a01                	sext.w	s4,s4

    // first recursively print all preceding (more significant) digits
    if (num >= base) {
ffffffffc02049f0:	03067e63          	bleu	a6,a2,ffffffffc0204a2c <printnum+0x60>
ffffffffc02049f4:	89be                	mv	s3,a5
        printnum(putch, putdat, result, base, width - 1, padc);
    } else {
        // print any needed pad characters before first digit
        while (-- width > 0)
ffffffffc02049f6:	00805763          	blez	s0,ffffffffc0204a04 <printnum+0x38>
ffffffffc02049fa:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc02049fc:	85ca                	mv	a1,s2
ffffffffc02049fe:	854e                	mv	a0,s3
ffffffffc0204a00:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204a02:	fc65                	bnez	s0,ffffffffc02049fa <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a04:	1a02                	slli	s4,s4,0x20
ffffffffc0204a06:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204a0a:	00002797          	auipc	a5,0x2
ffffffffc0204a0e:	4e678793          	addi	a5,a5,1254 # ffffffffc0206ef0 <error_string+0x38>
ffffffffc0204a12:	9a3e                	add	s4,s4,a5
}
ffffffffc0204a14:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a16:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204a1a:	70a2                	ld	ra,40(sp)
ffffffffc0204a1c:	69a2                	ld	s3,8(sp)
ffffffffc0204a1e:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a20:	85ca                	mv	a1,s2
ffffffffc0204a22:	8326                	mv	t1,s1
}
ffffffffc0204a24:	6942                	ld	s2,16(sp)
ffffffffc0204a26:	64e2                	ld	s1,24(sp)
ffffffffc0204a28:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a2a:	8302                	jr	t1
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204a2c:	03065633          	divu	a2,a2,a6
ffffffffc0204a30:	8722                	mv	a4,s0
ffffffffc0204a32:	f9bff0ef          	jal	ra,ffffffffc02049cc <printnum>
ffffffffc0204a36:	b7f9                	j	ffffffffc0204a04 <printnum+0x38>

ffffffffc0204a38 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204a38:	7119                	addi	sp,sp,-128
ffffffffc0204a3a:	f4a6                	sd	s1,104(sp)
ffffffffc0204a3c:	f0ca                	sd	s2,96(sp)
ffffffffc0204a3e:	e8d2                	sd	s4,80(sp)
ffffffffc0204a40:	e4d6                	sd	s5,72(sp)
ffffffffc0204a42:	e0da                	sd	s6,64(sp)
ffffffffc0204a44:	fc5e                	sd	s7,56(sp)
ffffffffc0204a46:	f862                	sd	s8,48(sp)
ffffffffc0204a48:	f06a                	sd	s10,32(sp)
ffffffffc0204a4a:	fc86                	sd	ra,120(sp)
ffffffffc0204a4c:	f8a2                	sd	s0,112(sp)
ffffffffc0204a4e:	ecce                	sd	s3,88(sp)
ffffffffc0204a50:	f466                	sd	s9,40(sp)
ffffffffc0204a52:	ec6e                	sd	s11,24(sp)
ffffffffc0204a54:	892a                	mv	s2,a0
ffffffffc0204a56:	84ae                	mv	s1,a1
ffffffffc0204a58:	8d32                	mv	s10,a2
ffffffffc0204a5a:	8ab6                	mv	s5,a3
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204a5c:	5b7d                	li	s6,-1
        lflag = altflag = 0;

    reswitch:
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204a5e:	00002a17          	auipc	s4,0x2
ffffffffc0204a62:	302a0a13          	addi	s4,s4,770 # ffffffffc0206d60 <default_pmm_manager+0x1168>
            ...
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204a66:	05e00b93          	li	s7,94
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204a6a:	00002c17          	auipc	s8,0x2
ffffffffc0204a6e:	44ec0c13          	addi	s8,s8,1102 # ffffffffc0206eb8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a72:	000d4503          	lbu	a0,0(s10) # 1000 <BASE_ADDRESS-0xffffffffc01ff000>
ffffffffc0204a76:	02500793          	li	a5,37
ffffffffc0204a7a:	001d0413          	addi	s0,s10,1
ffffffffc0204a7e:	00f50e63          	beq	a0,a5,ffffffffc0204a9a <vprintfmt+0x62>
            if (ch == '\0') {
ffffffffc0204a82:	c521                	beqz	a0,ffffffffc0204aca <vprintfmt+0x92>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a84:	02500993          	li	s3,37
ffffffffc0204a88:	a011                	j	ffffffffc0204a8c <vprintfmt+0x54>
            if (ch == '\0') {
ffffffffc0204a8a:	c121                	beqz	a0,ffffffffc0204aca <vprintfmt+0x92>
            putch(ch, putdat);
ffffffffc0204a8c:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a8e:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204a90:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a92:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204a96:	ff351ae3          	bne	a0,s3,ffffffffc0204a8a <vprintfmt+0x52>
ffffffffc0204a9a:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204a9e:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204aa2:	4981                	li	s3,0
ffffffffc0204aa4:	4801                	li	a6,0
        width = precision = -1;
ffffffffc0204aa6:	5cfd                	li	s9,-1
ffffffffc0204aa8:	5dfd                	li	s11,-1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204aaa:	05500593          	li	a1,85
                if (ch < '0' || ch > '9') {
ffffffffc0204aae:	4525                	li	a0,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ab0:	fdd6069b          	addiw	a3,a2,-35
ffffffffc0204ab4:	0ff6f693          	andi	a3,a3,255
ffffffffc0204ab8:	00140d13          	addi	s10,s0,1
ffffffffc0204abc:	20d5e563          	bltu	a1,a3,ffffffffc0204cc6 <vprintfmt+0x28e>
ffffffffc0204ac0:	068a                	slli	a3,a3,0x2
ffffffffc0204ac2:	96d2                	add	a3,a3,s4
ffffffffc0204ac4:	4294                	lw	a3,0(a3)
ffffffffc0204ac6:	96d2                	add	a3,a3,s4
ffffffffc0204ac8:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204aca:	70e6                	ld	ra,120(sp)
ffffffffc0204acc:	7446                	ld	s0,112(sp)
ffffffffc0204ace:	74a6                	ld	s1,104(sp)
ffffffffc0204ad0:	7906                	ld	s2,96(sp)
ffffffffc0204ad2:	69e6                	ld	s3,88(sp)
ffffffffc0204ad4:	6a46                	ld	s4,80(sp)
ffffffffc0204ad6:	6aa6                	ld	s5,72(sp)
ffffffffc0204ad8:	6b06                	ld	s6,64(sp)
ffffffffc0204ada:	7be2                	ld	s7,56(sp)
ffffffffc0204adc:	7c42                	ld	s8,48(sp)
ffffffffc0204ade:	7ca2                	ld	s9,40(sp)
ffffffffc0204ae0:	7d02                	ld	s10,32(sp)
ffffffffc0204ae2:	6de2                	ld	s11,24(sp)
ffffffffc0204ae4:	6109                	addi	sp,sp,128
ffffffffc0204ae6:	8082                	ret
    if (lflag >= 2) {
ffffffffc0204ae8:	4705                	li	a4,1
ffffffffc0204aea:	008a8593          	addi	a1,s5,8
ffffffffc0204aee:	01074463          	blt	a4,a6,ffffffffc0204af6 <vprintfmt+0xbe>
    else if (lflag) {
ffffffffc0204af2:	26080363          	beqz	a6,ffffffffc0204d58 <vprintfmt+0x320>
        return va_arg(*ap, unsigned long);
ffffffffc0204af6:	000ab603          	ld	a2,0(s5)
ffffffffc0204afa:	46c1                	li	a3,16
ffffffffc0204afc:	8aae                	mv	s5,a1
ffffffffc0204afe:	a06d                	j	ffffffffc0204ba8 <vprintfmt+0x170>
            goto reswitch;
ffffffffc0204b00:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204b04:	4985                	li	s3,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b06:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204b08:	b765                	j	ffffffffc0204ab0 <vprintfmt+0x78>
            putch(va_arg(ap, int), putdat);
ffffffffc0204b0a:	000aa503          	lw	a0,0(s5)
ffffffffc0204b0e:	85a6                	mv	a1,s1
ffffffffc0204b10:	0aa1                	addi	s5,s5,8
ffffffffc0204b12:	9902                	jalr	s2
            break;
ffffffffc0204b14:	bfb9                	j	ffffffffc0204a72 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204b16:	4705                	li	a4,1
ffffffffc0204b18:	008a8993          	addi	s3,s5,8
ffffffffc0204b1c:	01074463          	blt	a4,a6,ffffffffc0204b24 <vprintfmt+0xec>
    else if (lflag) {
ffffffffc0204b20:	22080463          	beqz	a6,ffffffffc0204d48 <vprintfmt+0x310>
        return va_arg(*ap, long);
ffffffffc0204b24:	000ab403          	ld	s0,0(s5)
            if ((long long)num < 0) {
ffffffffc0204b28:	24044463          	bltz	s0,ffffffffc0204d70 <vprintfmt+0x338>
            num = getint(&ap, lflag);
ffffffffc0204b2c:	8622                	mv	a2,s0
ffffffffc0204b2e:	8ace                	mv	s5,s3
ffffffffc0204b30:	46a9                	li	a3,10
ffffffffc0204b32:	a89d                	j	ffffffffc0204ba8 <vprintfmt+0x170>
            err = va_arg(ap, int);
ffffffffc0204b34:	000aa783          	lw	a5,0(s5)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204b38:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204b3a:	0aa1                	addi	s5,s5,8
            if (err < 0) {
ffffffffc0204b3c:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204b40:	8fb5                	xor	a5,a5,a3
ffffffffc0204b42:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204b46:	1ad74363          	blt	a4,a3,ffffffffc0204cec <vprintfmt+0x2b4>
ffffffffc0204b4a:	00369793          	slli	a5,a3,0x3
ffffffffc0204b4e:	97e2                	add	a5,a5,s8
ffffffffc0204b50:	639c                	ld	a5,0(a5)
ffffffffc0204b52:	18078d63          	beqz	a5,ffffffffc0204cec <vprintfmt+0x2b4>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204b56:	86be                	mv	a3,a5
ffffffffc0204b58:	00000617          	auipc	a2,0x0
ffffffffc0204b5c:	39060613          	addi	a2,a2,912 # ffffffffc0204ee8 <etext+0x2c>
ffffffffc0204b60:	85a6                	mv	a1,s1
ffffffffc0204b62:	854a                	mv	a0,s2
ffffffffc0204b64:	240000ef          	jal	ra,ffffffffc0204da4 <printfmt>
ffffffffc0204b68:	b729                	j	ffffffffc0204a72 <vprintfmt+0x3a>
            lflag ++;
ffffffffc0204b6a:	00144603          	lbu	a2,1(s0)
ffffffffc0204b6e:	2805                	addiw	a6,a6,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b70:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204b72:	bf3d                	j	ffffffffc0204ab0 <vprintfmt+0x78>
    if (lflag >= 2) {
ffffffffc0204b74:	4705                	li	a4,1
ffffffffc0204b76:	008a8593          	addi	a1,s5,8
ffffffffc0204b7a:	01074463          	blt	a4,a6,ffffffffc0204b82 <vprintfmt+0x14a>
    else if (lflag) {
ffffffffc0204b7e:	1e080263          	beqz	a6,ffffffffc0204d62 <vprintfmt+0x32a>
        return va_arg(*ap, unsigned long);
ffffffffc0204b82:	000ab603          	ld	a2,0(s5)
ffffffffc0204b86:	46a1                	li	a3,8
ffffffffc0204b88:	8aae                	mv	s5,a1
ffffffffc0204b8a:	a839                	j	ffffffffc0204ba8 <vprintfmt+0x170>
            putch('0', putdat);
ffffffffc0204b8c:	03000513          	li	a0,48
ffffffffc0204b90:	85a6                	mv	a1,s1
ffffffffc0204b92:	e03e                	sd	a5,0(sp)
ffffffffc0204b94:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204b96:	85a6                	mv	a1,s1
ffffffffc0204b98:	07800513          	li	a0,120
ffffffffc0204b9c:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204b9e:	0aa1                	addi	s5,s5,8
ffffffffc0204ba0:	ff8ab603          	ld	a2,-8(s5)
            goto number;
ffffffffc0204ba4:	6782                	ld	a5,0(sp)
ffffffffc0204ba6:	46c1                	li	a3,16
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204ba8:	876e                	mv	a4,s11
ffffffffc0204baa:	85a6                	mv	a1,s1
ffffffffc0204bac:	854a                	mv	a0,s2
ffffffffc0204bae:	e1fff0ef          	jal	ra,ffffffffc02049cc <printnum>
            break;
ffffffffc0204bb2:	b5c1                	j	ffffffffc0204a72 <vprintfmt+0x3a>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204bb4:	000ab603          	ld	a2,0(s5)
ffffffffc0204bb8:	0aa1                	addi	s5,s5,8
ffffffffc0204bba:	1c060663          	beqz	a2,ffffffffc0204d86 <vprintfmt+0x34e>
            if (width > 0 && padc != '-') {
ffffffffc0204bbe:	00160413          	addi	s0,a2,1
ffffffffc0204bc2:	17b05c63          	blez	s11,ffffffffc0204d3a <vprintfmt+0x302>
ffffffffc0204bc6:	02d00593          	li	a1,45
ffffffffc0204bca:	14b79263          	bne	a5,a1,ffffffffc0204d0e <vprintfmt+0x2d6>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204bce:	00064783          	lbu	a5,0(a2)
ffffffffc0204bd2:	0007851b          	sext.w	a0,a5
ffffffffc0204bd6:	c905                	beqz	a0,ffffffffc0204c06 <vprintfmt+0x1ce>
ffffffffc0204bd8:	000cc563          	bltz	s9,ffffffffc0204be2 <vprintfmt+0x1aa>
ffffffffc0204bdc:	3cfd                	addiw	s9,s9,-1
ffffffffc0204bde:	036c8263          	beq	s9,s6,ffffffffc0204c02 <vprintfmt+0x1ca>
                    putch('?', putdat);
ffffffffc0204be2:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204be4:	18098463          	beqz	s3,ffffffffc0204d6c <vprintfmt+0x334>
ffffffffc0204be8:	3781                	addiw	a5,a5,-32
ffffffffc0204bea:	18fbf163          	bleu	a5,s7,ffffffffc0204d6c <vprintfmt+0x334>
                    putch('?', putdat);
ffffffffc0204bee:	03f00513          	li	a0,63
ffffffffc0204bf2:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204bf4:	0405                	addi	s0,s0,1
ffffffffc0204bf6:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204bfa:	3dfd                	addiw	s11,s11,-1
ffffffffc0204bfc:	0007851b          	sext.w	a0,a5
ffffffffc0204c00:	fd61                	bnez	a0,ffffffffc0204bd8 <vprintfmt+0x1a0>
            for (; width > 0; width --) {
ffffffffc0204c02:	e7b058e3          	blez	s11,ffffffffc0204a72 <vprintfmt+0x3a>
ffffffffc0204c06:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204c08:	85a6                	mv	a1,s1
ffffffffc0204c0a:	02000513          	li	a0,32
ffffffffc0204c0e:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204c10:	e60d81e3          	beqz	s11,ffffffffc0204a72 <vprintfmt+0x3a>
...
ffffffffc0204c1c:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204c1e:	fe0d94e3          	bnez	s11,ffffffffc0204c06 <vprintfmt+0x1ce>
ffffffffc0204c22:	bd81                	j	ffffffffc0204a72 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c24:	4705                	li	a4,1
ffffffffc0204c26:	008a8593          	addi	a1,s5,8
ffffffffc0204c2a:	01074463          	blt	a4,a6,ffffffffc0204c32 <vprintfmt+0x1fa>
    else if (lflag) {
ffffffffc0204c2e:	12080063          	beqz	a6,ffffffffc0204d4e <vprintfmt+0x316>
        return va_arg(*ap, unsigned long);
ffffffffc0204c32:	000ab603          	ld	a2,0(s5)
ffffffffc0204c36:	46a9                	li	a3,10
ffffffffc0204c38:	8aae                	mv	s5,a1
ffffffffc0204c3a:	b7bd                	j	ffffffffc0204ba8 <vprintfmt+0x170>
ffffffffc0204c3c:	00144603          	lbu	a2,1(s0)
            padc = '-';
ffffffffc0204c40:	02d00793          	li	a5,45
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c44:	846a                	mv	s0,s10
ffffffffc0204c46:	b5ad                	j	ffffffffc0204ab0 <vprintfmt+0x78>
            putch(ch, putdat);
ffffffffc0204c48:	85a6                	mv	a1,s1
ffffffffc0204c4a:	02500513          	li	a0,37
ffffffffc0204c4e:	9902                	jalr	s2
            break;
ffffffffc0204c50:	b50d                	j	ffffffffc0204a72 <vprintfmt+0x3a>
            precision = va_arg(ap, int);
ffffffffc0204c52:	000aac83          	lw	s9,0(s5)
            goto process_precision;
ffffffffc0204c56:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204c5a:	0aa1                	addi	s5,s5,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c5c:	846a                	mv	s0,s10
            if (width < 0)
ffffffffc0204c5e:	e40dd9e3          	bgez	s11,ffffffffc0204ab0 <vprintfmt+0x78>
                width = precision, precision = -1;
ffffffffc0204c62:	8de6                	mv	s11,s9
ffffffffc0204c64:	5cfd                	li	s9,-1
ffffffffc0204c66:	b5a9                	j	ffffffffc0204ab0 <vprintfmt+0x78>
            goto reswitch;
ffffffffc0204c68:	00144603          	lbu	a2,1(s0)
            padc = '0';
ffffffffc0204c6c:	03000793          	li	a5,48
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c70:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c72:	bd3d                	j	ffffffffc0204ab0 <vprintfmt+0x78>
                precision = precision * 10 + ch - '0';
ffffffffc0204c74:	fd060c9b          	addiw	s9,a2,-48
                ch = *fmt;
ffffffffc0204c78:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c7c:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204c7e:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204c82:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204c86:	fcd56ce3          	bltu	a0,a3,ffffffffc0204c5e <vprintfmt+0x226>
            for (precision = 0; ; ++ fmt) {
ffffffffc0204c8a:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204c8c:	002c969b          	slliw	a3,s9,0x2
                ch = *fmt;
ffffffffc0204c90:	00044603          	lbu	a2,0(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204c94:	0196873b          	addw	a4,a3,s9
ffffffffc0204c98:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204c9c:	0117073b          	addw	a4,a4,a7
                if (ch < '0' || ch > '9') {
ffffffffc0204ca0:	fd06069b          	addiw	a3,a2,-48
                precision = precision * 10 + ch - '0';
ffffffffc0204ca4:	fd070c9b          	addiw	s9,a4,-48
                ch = *fmt;
ffffffffc0204ca8:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204cac:	fcd57fe3          	bleu	a3,a0,ffffffffc0204c8a <vprintfmt+0x252>
ffffffffc0204cb0:	b77d                	j	ffffffffc0204c5e <vprintfmt+0x226>
            if (width < 0)
ffffffffc0204cb2:	fffdc693          	not	a3,s11
ffffffffc0204cb6:	96fd                	srai	a3,a3,0x3f
ffffffffc0204cb8:	00ddfdb3          	and	s11,s11,a3
ffffffffc0204cbc:	00144603          	lbu	a2,1(s0)
ffffffffc0204cc0:	2d81                	sext.w	s11,s11
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204cc2:	846a                	mv	s0,s10
ffffffffc0204cc4:	b3f5                	j	ffffffffc0204ab0 <vprintfmt+0x78>
            putch('%', putdat);
ffffffffc0204cc6:	85a6                	mv	a1,s1
ffffffffc0204cc8:	02500513          	li	a0,37
ffffffffc0204ccc:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204cce:	fff44703          	lbu	a4,-1(s0)
ffffffffc0204cd2:	02500793          	li	a5,37
ffffffffc0204cd6:	8d22                	mv	s10,s0
ffffffffc0204cd8:	d8f70de3          	beq	a4,a5,ffffffffc0204a72 <vprintfmt+0x3a>
ffffffffc0204cdc:	02500713          	li	a4,37
ffffffffc0204ce0:	1d7d                	addi	s10,s10,-1
ffffffffc0204ce2:	fffd4783          	lbu	a5,-1(s10)
ffffffffc0204ce6:	fee79de3          	bne	a5,a4,ffffffffc0204ce0 <vprintfmt+0x2a8>
ffffffffc0204cea:	b361                	j	ffffffffc0204a72 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204cec:	00002617          	auipc	a2,0x2
ffffffffc0204cf0:	2a460613          	addi	a2,a2,676 # ffffffffc0206f90 <error_string+0xd8>
ffffffffc0204cf4:	85a6                	mv	a1,s1
ffffffffc0204cf6:	854a                	mv	a0,s2
ffffffffc0204cf8:	0ac000ef          	jal	ra,ffffffffc0204da4 <printfmt>
ffffffffc0204cfc:	bb9d                	j	ffffffffc0204a72 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204cfe:	00002617          	auipc	a2,0x2
ffffffffc0204d02:	28a60613          	addi	a2,a2,650 # ffffffffc0206f88 <error_string+0xd0>
            if (width > 0 && padc != '-') {
ffffffffc0204d06:	00002417          	auipc	s0,0x2
ffffffffc0204d0a:	28340413          	addi	s0,s0,643 # ffffffffc0206f89 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d0e:	8532                	mv	a0,a2
ffffffffc0204d10:	85e6                	mv	a1,s9
ffffffffc0204d12:	e032                	sd	a2,0(sp)
ffffffffc0204d14:	e43e                	sd	a5,8(sp)
ffffffffc0204d16:	0cc000ef          	jal	ra,ffffffffc0204de2 <strnlen>
ffffffffc0204d1a:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d1e:	6602                	ld	a2,0(sp)
ffffffffc0204d20:	01b05d63          	blez	s11,ffffffffc0204d3a <vprintfmt+0x302>
ffffffffc0204d24:	67a2                	ld	a5,8(sp)
ffffffffc0204d26:	2781                	sext.w	a5,a5
ffffffffc0204d28:	e43e                	sd	a5,8(sp)
                    putch(padc, putdat);
ffffffffc0204d2a:	6522                	ld	a0,8(sp)
ffffffffc0204d2c:	85a6                	mv	a1,s1
ffffffffc0204d2e:	e032                	sd	a2,0(sp)
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d30:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d32:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d34:	6602                	ld	a2,0(sp)
ffffffffc0204d36:	fe0d9ae3          	bnez	s11,ffffffffc0204d2a <vprintfmt+0x2f2>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d3a:	00064783          	lbu	a5,0(a2)
ffffffffc0204d3e:	0007851b          	sext.w	a0,a5
ffffffffc0204d42:	e8051be3          	bnez	a0,ffffffffc0204bd8 <vprintfmt+0x1a0>
ffffffffc0204d46:	b335                	j	ffffffffc0204a72 <vprintfmt+0x3a>
        return va_arg(*ap, int);
ffffffffc0204d48:	000aa403          	lw	s0,0(s5)
ffffffffc0204d4c:	bbf1                	j	ffffffffc0204b28 <vprintfmt+0xf0>
        return va_arg(*ap, unsigned int);
ffffffffc0204d4e:	000ae603          	lwu	a2,0(s5)
ffffffffc0204d52:	46a9                	li	a3,10
ffffffffc0204d54:	8aae                	mv	s5,a1
ffffffffc0204d56:	bd89                	j	ffffffffc0204ba8 <vprintfmt+0x170>
ffffffffc0204d58:	000ae603          	lwu	a2,0(s5)
ffffffffc0204d5c:	46c1                	li	a3,16
ffffffffc0204d5e:	8aae                	mv	s5,a1
ffffffffc0204d60:	b5a1                	j	ffffffffc0204ba8 <vprintfmt+0x170>
ffffffffc0204d62:	000ae603          	lwu	a2,0(s5)
ffffffffc0204d66:	46a1                	li	a3,8
ffffffffc0204d68:	8aae                	mv	s5,a1
ffffffffc0204d6a:	bd3d                	j	ffffffffc0204ba8 <vprintfmt+0x170>
                    putch(ch, putdat);
ffffffffc0204d6c:	9902                	jalr	s2
ffffffffc0204d6e:	b559                	j	ffffffffc0204bf4 <vprintfmt+0x1bc>
                putch('-', putdat);
ffffffffc0204d70:	85a6                	mv	a1,s1
ffffffffc0204d72:	02d00513          	li	a0,45
ffffffffc0204d76:	e03e                	sd	a5,0(sp)
ffffffffc0204d78:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204d7a:	8ace                	mv	s5,s3
ffffffffc0204d7c:	40800633          	neg	a2,s0
ffffffffc0204d80:	46a9                	li	a3,10
ffffffffc0204d82:	6782                	ld	a5,0(sp)
ffffffffc0204d84:	b515                	j	ffffffffc0204ba8 <vprintfmt+0x170>
            if (width > 0 && padc != '-') {
ffffffffc0204d86:	01b05663          	blez	s11,ffffffffc0204d92 <vprintfmt+0x35a>
ffffffffc0204d8a:	02d00693          	li	a3,45
ffffffffc0204d8e:	f6d798e3          	bne	a5,a3,ffffffffc0204cfe <vprintfmt+0x2c6>
ffffffffc0204d92:	00002417          	auipc	s0,0x2
ffffffffc0204d96:	1f740413          	addi	s0,s0,503 # ffffffffc0206f89 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d9a:	02800513          	li	a0,40
ffffffffc0204d9e:	02800793          	li	a5,40
ffffffffc0204da2:	bd1d                	j	ffffffffc0204bd8 <vprintfmt+0x1a0>

ffffffffc0204da4 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204da4:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204da6:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204daa:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204dac:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204dae:	ec06                	sd	ra,24(sp)
ffffffffc0204db0:	f83a                	sd	a4,48(sp)
ffffffffc0204db2:	fc3e                	sd	a5,56(sp)
ffffffffc0204db4:	e0c2                	sd	a6,64(sp)
ffffffffc0204db6:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204db8:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204dba:	c7fff0ef          	jal	ra,ffffffffc0204a38 <vprintfmt>
}
ffffffffc0204dbe:	60e2                	ld	ra,24(sp)
ffffffffc0204dc0:	6161                	addi	sp,sp,80
ffffffffc0204dc2:	8082                	ret

ffffffffc0204dc4 <strlen>:
...
ffffffffc0204dc8:	cb91                	beqz	a5,ffffffffc0204ddc <strlen+0x18>
    size_t cnt = 0;
ffffffffc0204dca:	4781                	li	a5,0
        cnt ++;
ffffffffc0204dcc:	0785                	addi	a5,a5,1
    while (*s ++ != '\0') {
ffffffffc0204dce:	00f50733          	add	a4,a0,a5
ffffffffc0204dd2:	00074703          	lbu	a4,0(a4)
ffffffffc0204dd6:	fb7d                	bnez	a4,ffffffffc0204dcc <strlen+0x8>
    }
    return cnt;
}
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204de2:	c185                	beqz	a1,ffffffffc0204e02 <strnlen+0x20>
ffffffffc0204de4:	00054783          	lbu	a5,0(a0)
ffffffffc0204de8:	cf89                	beqz	a5,ffffffffc0204e02 <strnlen+0x20>
    size_t cnt = 0;
ffffffffc0204dea:	4781                	li	a5,0
ffffffffc0204dec:	a021                	j	ffffffffc0204df4 <strnlen+0x12>
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204dee:	00074703          	lbu	a4,0(a4)
ffffffffc0204df2:	c711                	beqz	a4,ffffffffc0204dfe <strnlen+0x1c>
        cnt ++;
ffffffffc0204df4:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204df6:	00f50733          	add	a4,a0,a5
ffffffffc0204dfa:	fef59ae3          	bne	a1,a5,ffffffffc0204dee <strnlen+0xc>
    }
    return cnt;
}
ffffffffc0204dfe:	853e                	mv	a0,a5
ffffffffc0204e00:	8082                	ret
    size_t cnt = 0;
ffffffffc0204e02:	4781                	li	a5,0
}
ffffffffc0204e04:	853e                	mv	a0,a5
ffffffffc0204e06:	8082                	ret

ffffffffc0204e08 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204e08:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204e0a:	0585                	addi	a1,a1,1
ffffffffc0204e0c:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0204e10:	0785                	addi	a5,a5,1
ffffffffc0204e12:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204e16:	fb75                	bnez	a4,ffffffffc0204e0a <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e1a:	00054783          	lbu	a5,0(a0)
ffffffffc0204e1e:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e22:	cb91                	beqz	a5,ffffffffc0204e36 <strcmp+0x1c>
ffffffffc0204e24:	00e79c63          	bne	a5,a4,ffffffffc0204e3c <strcmp+0x22>
        s1 ++, s2 ++;
ffffffffc0204e28:	0505                	addi	a0,a0,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e2a:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
ffffffffc0204e2e:	0585                	addi	a1,a1,1
ffffffffc0204e30:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e34:	fbe5                	bnez	a5,ffffffffc0204e24 <strcmp+0xa>
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e36:	4501                	li	a0,0
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204e38:	9d19                	subw	a0,a0,a4
ffffffffc0204e3a:	8082                	ret
ffffffffc0204e3c:	0007851b          	sext.w	a0,a5
ffffffffc0204e40:	9d19                	subw	a0,a0,a4
ffffffffc0204e42:	8082                	ret

ffffffffc0204e44 <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc0204e44:	00054783          	lbu	a5,0(a0)
ffffffffc0204e48:	cb91                	beqz	a5,ffffffffc0204e5c <strchr+0x18>
        if (*s == c) {
ffffffffc0204e4a:	00b79563          	bne	a5,a1,ffffffffc0204e54 <strchr+0x10>
ffffffffc0204e4e:	a809                	j	ffffffffc0204e60 <strchr+0x1c>
ffffffffc0204e50:	00b78763          	beq	a5,a1,ffffffffc0204e5e <strchr+0x1a>
            return (char *)s;
        }
        s ++;
...
ffffffffc0204e5a:	fbfd                	bnez	a5,ffffffffc0204e50 <strchr+0xc>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204e62:	ca01                	beqz	a2,ffffffffc0204e72 <memset+0x10>
ffffffffc0204e64:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204e66:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204e68:	0785                	addi	a5,a5,1
ffffffffc0204e6a:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204e6e:	fec79de3          	bne	a5,a2,ffffffffc0204e68 <memset+0x6>
    }
    return s;
...
ffffffffc0204e74 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204e74:	ca19                	beqz	a2,ffffffffc0204e8a <memcpy+0x16>
ffffffffc0204e76:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204e78:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204e7a:	0585                	addi	a1,a1,1
ffffffffc0204e7c:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0204e80:	0785                	addi	a5,a5,1
ffffffffc0204e82:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204e86:	fec59ae3          	bne	a1,a2,ffffffffc0204e7a <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204e8c:	c21d                	beqz	a2,ffffffffc0204eb2 <memcmp+0x26>
        if (*s1 != *s2) {
ffffffffc0204e8e:	00054783          	lbu	a5,0(a0)
ffffffffc0204e92:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e96:	962a                	add	a2,a2,a0
ffffffffc0204e98:	00f70963          	beq	a4,a5,ffffffffc0204eaa <memcmp+0x1e>
ffffffffc0204e9c:	a829                	j	ffffffffc0204eb6 <memcmp+0x2a>
ffffffffc0204e9e:	00054783          	lbu	a5,0(a0)
ffffffffc0204ea2:	0005c703          	lbu	a4,0(a1)
ffffffffc0204ea6:	00e79863          	bne	a5,a4,ffffffffc0204eb6 <memcmp+0x2a>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
...
ffffffffc0204eac:	0585                	addi	a1,a1,1
    while (n -- > 0) {
ffffffffc0204eae:	fea618e3          	bne	a2,a0,ffffffffc0204e9e <memcmp+0x12>
    }
    return 0;
...
ffffffffc0204eb4:	8082                	ret
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204eb6:	40e7853b          	subw	a0,a5,a4
